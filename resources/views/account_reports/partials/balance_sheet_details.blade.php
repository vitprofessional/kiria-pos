        ...
        <table class="table table-border table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th class="amount-text">{{@num_format(($assets_accounts->sum('balance') +  $assets_accounts_main_balances_total))}}
                    </th>
                </tr>
                @endif
            </tbody>
        ...
        <table class="table table-border table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th class="amount-text">{{@num_format(($fixed_assets_accounts->sum('balance') + $fixed_assets_accounts_main_balances_total))}}
                    </th>
                </tr>
    ...
    <div class="col-md-6">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                @endforeach
                <tr>
                    <td>@lang('account.total_longterm_liabilities')</td>
            ...
            <tfoot>
                <tr>
                    ...
                    <th class="amount-text">{{@num_format(($lt_liabilities_accounts->sum('balance') +  $lt_liabilities_accounts_main_balances_total) + ($liabilities_accounts->sum('balance') + $liabilities_accounts_main_balances_total))}}
                    </th>
                </tr>
            </tfoot>
        </table>
        ...
        <table class="table table-border table-striped">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="amount-text"><b>{{@num_format(($fixed_assets_accounts->sum('balance') + $fixed_assets_accounts_main_balances_total+$assets_accounts->sum('balance') +  $assets_accounts_main_balances_total))}}</b></td>
                </tr>
                @endif
            </tbody>
