...
@page { size: A4 landscape; margin: 5px; } body { margin: 5px; padding: 15px; }
@media print {
    ...
    <div class="row">
        <div class="col-xs-4 text-center">
                ...
                @if(!empty($receipt_details->sub_heading_line1))
                    <span class="logo"><i>
            			{{ strtoupper(str_replace("Quotations", 'Quotation', $receipt_details->sub_heading_line1)) }}
            		</i></span><br>
    			@endif
                ...
                @if(!empty($receipt_details->sub_heading_line2))
                    <h5 class="logo-tag">
            			{{ strtoupper(str_replace("Quotations", 'Quotation', $receipt_details->sub_heading_line2)) }}
            		</h5>
    			@endif
        ...
        <div class="col-xs-8">
            <div class="col-xs-12">
                    ...
                    <div class="col-xs-4">
                        @if($receipt_details->tax_amount > 0)
                            <span class="vat-box" style="width: 100% !important;">{{ __('sale.vat_invoice') }}</span><br>
                            <span class="vat-box" style="width: 100% !important;">{{ __('sale.vat_no') }}: {{ $receipt_details->tax_info1 }}</span><br>
                        @endif
                    </div>
            ...
            <div class="col-xs-8 text-right">
                <span class="invoice-box" style="width: 100% !important;">{!! strtoupper($receipt_details->invoice_no_prefix) !!}<span class="spacer" style="padding-left: 50px !important"></span>{{$receipt_details->invoice_no}}</span>
            </div>
        </div>
    </div>
