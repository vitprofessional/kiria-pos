                                ...
                                <div class="form-group" style="width: 100% !important">
                                    <div class="input-group">
                                       ...
                                       <!--  <input class="form-control" id="customer_id" name="customer_id" type="hidden"
                                            value="{{ $job_sheet && $job_sheet->customer ? $job_sheet->customer->id : '' }}"
                                            readonly />

                                        <input class="form-control" id="customer_name" name="customer_name" type="text"
                                            value="{{ $job_sheet && $job_sheet->customer ? $job_sheet->customer->name : '' }}"
                                            readonly /> -->
                                        ...
                                        @if (!empty($parts))
                                            @foreach ($parts as $part)
                                                <tr>
                                                    ...
                                                    @endphp
                                                    <th class="text-center col-md-2">
                                                        {{ $part['quantity'] *DB::table('variations')->where('product_id', $part['variation_id'])->value('default_sell_price') }}
