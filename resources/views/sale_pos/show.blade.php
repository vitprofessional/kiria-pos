<div class="modal-dialog modal-lg no-print" role="document" style="
  ...
  <div class="modal-content">
    ...
    <h4 class="modal-title" id="modalTitle"> 
        @lang('sale.sell_details') (<b>
          @if($sell->is_quotation == 1)
            @lang('lang_v1.quotation_no'):
          @else
            @lang('lang_v1.invoice_no'):
          @endif
        </b> {{ $sell->invoice_no }})
    </h4>
</div>
<div class="modal-body">
  ...
  <div class="col-sm-6">
      ...
      <div class="col-sm-6">
        @if($sell->is_quotation == 1)
          <b>@lang('lang_v1.quotation_no')</b> :
        @else
          <b>@lang('lang_v1.invoice_no')</b> :
        @endif
        {{ $sell->invoice_no }} <br>
              ...
              <tr>
                ...
                <td>
                    <button type="button" class="btn btn-info btn-xs edit_payments"
                            ...
                            data-href="{{action('TransactionPaymentController@edit', [$payment_line->id])}}"><i
