...
<tr class="product_row" data-row_index="{{$row_count}}">
	...
	<td class="{{$hide_tax}}">
		...
		<input type="text" name="products[{{$row_count}}][unit_price_inc_tax]"
		 ...
		 readonly  @if(!empty($pos_settings['enable_msp']))
			...
			<input type="hidden" name="products[{{$row_count}}][discount_value]" class="form-control pos_discount_value input_number" value="0">
			<input type="hidden" name="products[{{$row_count}}][original_pos_unit_price_inc_tax]" class="form-control original_pos_unit_price_inc_tax input_number" value="{{@num_format($unit_price_inc_tax)}}">
	...
	<td>
		...
		<input type="text" name="products[{{$row_count}}][default_sell_price]" @if(isset($price_later) && $price_later=='1' ) disabled @endif
