...
<div class="A5" style="width: 100% !important;">
    <div class="row">
        ...
        <div class="col-xs-12 text-center">
            <div class="col-xs-12 text-center">
               <span class="logo"><i>
        			{{ strtoupper(__('tpos.dispatch_note')) }}
        		</i></span><br>
            </div>
            <div class="col-xs-12">
    ...
    <div class="row" style="margin-top: 10px;">
        ...
        <div class="col-xs-12 header-section">
    			<div class="col-xs-6 text-left">
    			    <b>@lang('tpos.cashier') : </b>{{$receipt_details['sale_details']->username}}
    			</div>
    			<div class="col-xs-6 text-left">
    			    <div class="pull-right">
    			        <b>@lang('tpos.payment_terms') : </b> @lang('tpos.credit')
    			    </div>
    	...
    	<div class="col-xs-12 header-section">
    			...
    			<div class="col-xs-6 text-left">
    			    <div class="pull-right">
    			        <small><span class="">{{@format_datetime($receipt_details['sale_details']->date)}}</span><br>
    			    </div>
...
<div class="row">
	<div class="col-xs-12">
		<table class="table table-responsive">
			...
			<tbody>
			    @php $total_quantity = 0; $total_items = 0; @endphp
			    @foreach($receipt_details['sale_products'] as $line)
			    @php $total_items += $line->product_count; $total_quantity += $line->total_qty; @endphp
			    <tr>
					...
					<td style="font-size: {{$font_size}}px !important;padding-top: 0px !important;padding-bottom: 0px !important">{{@num_format($line->total_qty)}}</td>
				</tr>
    			@endforeach
