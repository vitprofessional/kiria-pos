<div class="pos-tab-content active">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('font_style',__('business.font_style') ) !!}
                {!! Form::number('font_style', !empty($business->font_style) ? $business->font_style : null, ['class' => 'form-control',
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('font_size',__('business.font_size') ) !!}
                {!! Form::number('font_size', !empty($business->font_size) ? $business->font_size : null, ['class' => 'form-control',
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <br>
                    <label>
                        {!! Form::checkbox('duplicate_orders_allowed', 1, $business->duplicate_orders_allowed ,
                        [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.duplicate_orders_allowed' ) }}  </label> @if(!empty($help_explanations['duplicate_orders_allowed'])) @show_tooltip($help_explanations['duplicate_orders_allowed']) @endif
