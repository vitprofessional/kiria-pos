    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                {!! Form::select('type',null, !empty($type) ? $type : null, ['class' => 'form-control']); !!}
            </div>
            <div class="form-group">
            ...
            <div class="form-group hide-supplier">
                ...
                {!! Form::number('maximum_discount', null, ['class' => 'form-control ','placeholder' => __( 'lang_v1.maximum_discount_to_give' ), 'step' => '0.00001']); !!}
            </div>
            @endif
