...
<div class="col-md-12" style="">
    ...
    <div class="col-md-12">
        <div class="form-group">
            {!! Form::label('v_name', __('business.business_name') . ':' ) !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-suitcase"></i>
                </span>
                {!! Form::text('name', null, ['class' => 'form-control','placeholder' => __('business.business_name'),
                'required', 'id' => 'v_name', 'autocomplete' => 'on']); !!}
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('r_f_v_mobile', __('lang_v1.business_telephone') . ':') !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-phone"></i>
                </span>
                {!! Form::text('mobile', null, ['class' => 'form-control','placeholder' =>
                __('lang_v1.business_telephone'), 'id' => "r_f_v_mobile"]); !!}
            </div>
        </div>
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                __('business.first_name'), 'required', 'autocomplete' => 'on']); !!}
            </div>
        </div>
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('visitor_username', __('business.username') . ':') !!}
            <div class="input-group">
                <span class="input-group-addon">
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('visitor_email', __('business.email') . ':') !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-envelope"></i>
                </span>
                {!! Form::text('email', null, ['class' => 'form-control', 'id' => 'visitor_email', 'placeholder' =>
                __('business.email'), 'autocomplete' => 'on']); !!}
            </div>
        </div>
    </div>
    <div class="clearfix"></div>
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('visitor_password', __('business.password') . ':') !!}
            <div class="input-group">
                <span class="input-group-addon">
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('visitor_confirm_password', __('business.confirm_password') . ':') !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-lock"></i>
                </span>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('give_away_gifts[]', $key, false, ['class' => '', 'id'=>'give_away_gifts']);
                    !!} {{$give_away_gift}}
                </label>
            </div>
            @endforeach
