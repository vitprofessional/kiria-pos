...
<fieldset>
    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            {!! Form::label('b_name', __('business.business_name') . ':', ['class' => 'label_register'] ) !!}
            @elseif($business_or_entity == 'entity')
            {!! Form::label('b_name', __('lang_v1.entity_name') . ':' , ['class' => 'label_register']) !!}
            @else
            {!! Form::label('b_name', __('business.business_name') . ':' , ['class' => 'label_register']) !!}
            @endif
    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            {!! Form::file('business_logo', ['accept' => 'image/*', 'id' => 'business_logo']); !!}
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('b_mobile', __('lang_v1.business_telephone') . ':*', ['class' => 'label_register']) !!}
            <div class="input-group">
                <span class="input-group-addon">
    ...
    <div class="row">
        <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('business_alternate_number', __('business.alternate_number') . ':', ['class' => 'label_register']) !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-phone"></i>
                </span>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('business_country', __('business.country') . ':', ['class' => 'label_register']) !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-globe"></i>
                </span>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('b_state',__('business.state') . ':', ['class' => 'label_register']) !!}
            <div class="input-group">
                <span class="input-group-addon">
    ...
    <div class="row">
        <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('business_city',__('business.city'). ':', ['class' => 'label_register']) !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-map-marker"></i>
                </span>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('b_zip_code', __('business.zip_code') . ':', ['class' => 'label_register']) !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-map-marker"></i>
                </span>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('b_landmark', __('business.landmark') . ':', ['class' => 'label_register']) !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-map-marker"></i>
                </span>
...
<fieldset>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('r3_give_away_gifts', __('superadmin::lang.give_away_gifts') . ':', ['class' => 'label_register']) !!}
            @foreach ($give_away_gifts as $key => $give_away_gift)
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('give_away_gifts[]', $key, false, ['class' => '', 'id' => 'r3_give_away_gifts']);
                    !!} {{$give_away_gift}}
                </label>
            </div>
            @endforeach
...
<fieldset>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                {!! Form::label('b_first_name', __('business.first_name') . ':', ['class' => 'label_register']) !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-info"></i>
                    </span>
        ...
        <div class="col-md-4">
            <div class="form-group">
                {!! Form::label('b_last_name', __('business.last_name') . ':', ['class' => 'label_register']) !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-info"></i>
                    </span>
    ...
    <div class="row">
        <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('b_username', __('business.username') . ':', ['class' => 'label_register']) !!}
            <div class="input-group">
                <span class="input-group-addon">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('b_email', __('business.email') . ':', ['class' => 'label_register']) !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-envelope"></i>
                    </span>
                    {!! Form::text('email', null, ['class' => 'form-control','placeholder' => __('business.email'), 'id' => 'b_email', 'autocomplete' => 'on']); !!}
                </div>
            </div>
        </div>
        <div class="clearfix"></div>
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('b_password', __('business.password') . ':', ['class' => 'label_register']) !!}
                <div class="input-group">
                    <span class="input-group-addon">
    ...
    <div class="row">
        <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('b_confirm_password', __('business.confirm_password') . ':', ['class' => 'label_register']) !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-lock"></i>
                </span>
