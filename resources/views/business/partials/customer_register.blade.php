            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('c_first_name', __('customer.first_name') . ':*') !!}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('c_last_name', __('customer.last_name') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-user"></i>
                            </span>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('c_username', __('customer.username') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-user"></i>
                            </span>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('c_email', __('business.email') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('c_password', __('business.password') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-key"></i>
                            </span>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('c_confirm_password', __('business.confirm_password') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-key"></i>,
                            </span>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('c_mobile', __('contact.mobile') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('customer_alternate_number', __('contact.alternate_contact_number') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('customer_address', __('business.address') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-map-marker"></i>
                            </span>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('r2_give_away_gifts', __('superadmin::lang.give_away_gifts') . ':') !!}
                        @foreach ($give_away_gifts as $key => $give_away_gift)
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('give_away_gifts[]', $key, false, ['class' => '', 'id' => 'r2_give_away_gifts']);
                                !!} {{$give_away_gift}}
                            </label>
                        </div>
                        @endforeach
