...
<fieldset>
    ...
    <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('date_of_birth', __('business.date_of_birth') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i ></i>
                            </span>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('m_r_give_away_gifts', __('superadmin::lang.give_away_gifts') . ':') !!}
                        @foreach ($give_away_gifts as $key => $give_away_gift)
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('give_away_gifts[]', $key, false, ['class' => '', 'id' => 'm_r_give_away_gifts']);
                                !!} {{$give_away_gift}}
                            </label>
                        </div>
                        @endforeach
