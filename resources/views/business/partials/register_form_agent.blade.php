    ...
    <div class="row">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_date', __('superadmin::lang.date') . ':*', ['class' => 'label_register']) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_name', __('superadmin::lang.name') . ':*', ['class' => 'label_register']) !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_address', __('superadmin::lang.address') . ':*', ['class' => 'label_register'])
                        !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_mobile_number', __('superadmin::lang.mobile_number') . ':*', ['class' =>
                        'label_register']) !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_land_number', __('superadmin::lang.land_number') . ':', ['class' =>
                        'label_register']) !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_email', __('superadmin::lang.email') . ':*', ['class' => 'label_register']) !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_nic_number', __('superadmin::lang.nic_number') . ':*', ['class' =>
                        'label_register']) !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_referral_code', __('superadmin::lang.referral_code') . ':', ['class' =>
                        'label_register']) !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_nic_copy', __('superadmin::lang.upload_nic_image') . ':*', ['class' =>
                        'label_register']) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_agent_photo', __('superadmin::lang.upload_your_photo') . ':', ['class' =>
                        'label_register']) !!}
        ...
        <div class="box  box-primary collapsed-box">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_bank_name', __('superadmin::lang.bank_name') . ':*', ['class' =>
                        'label_register']) !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_account_number', __('superadmin::lang.account_number') . ':*', ['class' =>
                        'label_register']) !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_branch', __('superadmin::lang.branch') . ':*', ['class' => 'label_register'])
                        !!}
                        <div class="input-group">
                            <span class="input-group-addon">
        ...
        <div class="box  box-primary collapsed-box">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_username', __('superadmin::lang.username') . ':*', ['class' => 'label_register']) !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-user"></i>
                            </span>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_password', __('superadmin::lang.password') . ':*', ['class' =>
                        'label_register']) !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-key"></i>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('a_confirm_password', __('superadmin::lang.confirm_password') . ':*', ['class' =>
                        'label_register']) !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-key"></i>
