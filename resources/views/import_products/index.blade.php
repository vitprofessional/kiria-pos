            ...
            @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.instructions')])
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><strong>@lang('product.date_format')</strong>: 05/18/2024 </br> @lang('product.if_empty_td')<br>
                        </td>
                    </tr>
                    
                    <tr>
                        <td>38</td>
                        <td>@lang('product.vat_input_claimed')</td>
                        <td>@lang('messages.yes') or @lang('messages.no')</td>
                    </tr>
