  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            {!! Form::select('location_id', $business_locations, $account->location_id, ['style' => 'width: 100%', 'class' => 'form-control select2']) !!}
        </div>
      ...
      <div class="form-group @if($account_access==0) hide @endif">
        ...
        => __( 'account.account_number' ), 'readonly' ]); !!}
      </div>
      ...
      <div class="form-group">
       ...
       <div class="form-group is_property @if($account->is_property == 0) hide @endif">
            {!! Form::label('is_property', __( 'lang_v1.is_property' ) .":") !!}
            {!! Form::select('is_property', ['1'=>'Yes','0'=>'No'], $account->is_property, ['placeholder' => 
      ...
      <div class="form-group asset_type">
        ...
        <select name="asset_type" class="form-control select2" id="asset_type">
          <option>@lang('messages.please_select')</option>
  ...
  $('#is_main_account').change(function(){
    ...
    $('#account_type_id').change(function(){
        ...
        if(account_type_id == "{{$fixed_acc_id}}"){
            ...
            $('#is_property').prop('required', false);
        }
