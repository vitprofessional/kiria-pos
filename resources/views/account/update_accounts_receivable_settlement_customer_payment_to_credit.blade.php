@extends('layouts.app')
@section('title', "Update Accounts Receivable, settlement customer payment, to credit")
...
<section class="content main-content-inner">
    ...
    <h2>Update Accounts Receivable, settlement customer payment, to credit</h2>
    <hr>
    @if(session('msg'))
    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table table-striped table-bordered" style="width: 100%;">
                <thead>
                    <tr>
                        <th>Debit Entries to update to credit</th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>
                    @if ($account_transactions > 0)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('accounts.updateAccountsReceivableSettlementCustomerPaymentToCredit', 0) }}" 
                    ...
                    @if ($account_transactions == 0)
                        <tr>
                            <td><h4>No Accounts Receivable debit entries for settlement customer payments</h4></td>
                            <td></td>
                        </tr>
                    @endif
                </tbody>
