@extends('layouts.app')
@section('title', "Update Finished Goods Account Pos Sales Tax")
...
<section class="content main-content-inner">
    ...
    <h2>Update Finished Goods Account Pos Sales Tax</h2>
    <hr>
    @if(session('msg'))
                ...
                <tbody>
                    @if ($account_transactions > 0)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('accounts.updateFinishedGoodsAccountPosSaleTax', 0) }}" 
                    ...
                    @if ($account_transactions == 0)
                        <tr>
                            <td><h4>No Finished Goods Account Pos Sales Tax to update</h4></td>
                            <td></td>
                        </tr>
                    @endif
                </tbody>
