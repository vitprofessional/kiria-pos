@extends('layouts.app')
@section('title', "Correct Transaction Sell Lines Tax")
...
<section class="content main-content-inner">
    ...
    <h2>Correct Transaction Sell Lines Tax</h2>
                ...
                <tbody>
                    @if ($transaction_sell_lines > 0)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('accounts.updateSellLinesTax') }}" 
                    ...
                    @if ($transaction_sell_lines == 0)
                        <tr>
                            <td><h2>No Affected Transaction Sell Lines Tax for current product prices</h2></td>
                            <td></td>
                        </tr>
                    @endif
                </tbody>
