                ...
                if(typeof profit_by_customers_table == 'undefined') {
                    ...
                    profit_by_customers_table = $('#profit_by_customer_table').DataTable({
                        ...
                        fnDrawCallback: function(oSettings) {
                            ...
                            $('#profit_by_customer_table .footer_total_sales').text(total_sales);
                ...
                $.ajax({
                        ...
                        success: function(result) {
                           ...
                           $('#profit_by_day').html(result); 
                            ...
                            var total_sales = sum_table_col($('#profit_by_day_table'), 'total-sales');
                            
                            $('#profit_by_day_table .footer_total_sales').text(total_sales);
