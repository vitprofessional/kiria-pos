@extends('layouts.app')
@section('title', "Correct Sale Income Accounts Tax")
...
<section class="content main-content-inner">
    ...
    <h1>Correct Sale Income Accounts Tax</h1>
    @if(session('msg'))
                ...
                <tbody>
                    ...
                    @foreach ($accounts as $account)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('accounts.updateSaleIncomeAccountsTax', $account->id) }}" 
                    ...
                    @if ($count == 0)
                        <tr>
                            <td></td>
                            <td><h2>All Sale Income Accounts Tax Updated</h2></td>
                            <td></td>
                        </tr>
                    @endif
                </tbody>
    ...
    @if ($count != 0)
        <a href="{{ route('accounts.updateSaleIncomeAccountsTax', 'All') }}" 
            class="btn btn-success" 
