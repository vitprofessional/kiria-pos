				...
				<div class="box-header with-border">
					<h3 class="box-title">
						...
						@elseif($transaction->status == 'final') 
							Invoice 
						@endif 
					<span class="text-success">#{{$transaction->invoice_no}}</span> <i class="fa fa-keyboard-o hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="@include('tpos_sale.partials.keyboard_shortcuts_details')" data-html="true" data-trigger="hover" data-original-title="" title=""></i></h3>
...
@endforeach
					...
					@include('tpos_sale.partials.pos_details', ['edit' => true])

					@include('tpos_sale.partials.payment_modal')

					@if(empty($pos_settings['disable_suspend']))
						@include('tpos_sale.partials.suspend_note_modal')
					@endif

					@if(empty($pos_settings['disable_recurring_invoice']))
						@include('tpos_sale.partials.recurring_invoice_modal')
					@endif
				</div>
				<!-- /.box-body -->
				{!! Form::close() !!}
