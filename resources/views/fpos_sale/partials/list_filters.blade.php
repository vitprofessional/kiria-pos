...
<div class="col-md-3">
    <div class="form-group">
        {!! Form::label('list_filter_product_id', __('tpos.product') . ':') !!}

        {!! Form::select('list_filter_product_id', $products, null, ['class' => 'form-control select2',
        'style' => 'width:100%', 'placeholder' => __('lang_v1.all') ]); !!}
    </div>
</div>
<div class="col-md-3">
...
<div class="col-md-3">
    <div class="form-group">
        {!! Form::label('price_gain', __('tpos.price_gain') . ':') !!}
        {!! Form::select('price_gain', ['gain' => __('tpos.gain'), 'loss' => __('tpos.loss')], null, ['class' => 'form-control
