						...
						<div class="row">
							<div id="payment_rows_div">
								...
								@foreach($payment_lines as $payment_line)
									...
									@include('sale_pos.partials.payment_row', ['removable' => !$loop->first, 'row_index' => !empty($loop->index) ? $loop->index : 0, 'payment_line' => $payment_line, 'payment' => !empty($temp_data->payment)?$temp_data->payment[$loop->index]:[]])
								@endforeach
