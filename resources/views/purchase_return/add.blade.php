    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('lang_v1.purchase_return')</h4>
                <ul class="breadcrumbs pull-left" style="margin-top: 15px">
                    <li><a href="#">Purchases</a></li>
                    <li><span>@lang('lang_v1.purchase_return')</span></li>
                </ul>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
	...
	function update_purchase_return_total(){
		...
		var tax_percent_return = tax_percent / ( 1 + (tax_percent / 100));
		var total_tax = __calculate_amount('percentage', tax_percent_return, net_return);
