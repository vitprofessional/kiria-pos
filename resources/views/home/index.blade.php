...
<section class="content main-content-inner no-print">
    <div class="row">
      ...
      <div class="col-md-3 pull-right">
        <div class="form-group">
            <select class="form-control" style="background-color: #5C2AAE;color: #ffffff;width: 100%;" id="location_id">
    ...
    function loadData(option){
        ...
        var loading = "<span>Loading...</span>";
            ...
            $.ajax({
              ...
              type: 'GET', 
              data: {filter: option, 'type' : $("#type").val(),'location_id' : $("#location_id").val()},
            ...
            $(document).on('change', '#type,#period_1,#location_id', function() {
