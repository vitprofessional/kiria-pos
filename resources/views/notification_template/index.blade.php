                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="customer_notifications">
                        @component('components.widget', ['class' => 'box-primary','title' => " "])
                            @if($type == 'sms')
                                @include('notification_template.partials.sms', ['templates' => $customer_notifications, 'is_general' => 0])
                            @else
                                @include('notification_template.partials.email', ['templates' => $customer_notifications, 'is_general' => 0])
                            @endif
                        @endcomponent
                    </div>
                    ...
                    <div class="tab-pane" id="supplier_notifications">
                        @component('components.widget', ['class' => 'box-primary','title' => " "])
                            @if($type == 'sms')
                                @include('notification_template.partials.sms', ['templates' => $supplier_notifications, 'is_general' => 0])
                            @else
                                @include('notification_template.partials.email', ['templates' => $supplier_notifications, 'is_general' => 0])
                            @endif
                        @endcomponent
                    </div>
