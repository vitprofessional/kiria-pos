@extends('layouts.app')
@section('title', __('deposits.deposits'))
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('deposits.deposits')</h4>
...
<script>
    $(document).ready(function(){
        ...
        other_account_table = $('#other_account_table').DataTable({
            ...
            'serverSide': false,
            'ajax': {
                url: '/deposits-module/account?account_type=other',
                data: function(d){
        ...
        account_groups_table = $('#account_groups_table').DataTable({
            ...
            columns: [
                ...
                
                {
                    ...
                    if (row.default_account_group_id === 0) { return  row.action;}
                    else { return ""; }
                }
                }
            ],
        ...
        function loadNamesOtion(){
            ...
            $.ajax({
                method: "post",
                url: '/deposits-module/check_account_names',
                dataType: "json",
                data: postData,
                success:function(result){
    ...
    $(document).on('change', '#account_number', function(){
        $.ajax({
            method: 'get',
            url: '/deposits-module/check_account_number',
    ...
    function get_cheques_list(){
        if($('#transaction_date_range_cheque_deposit').val()){
            ...
            $.ajax({
                method: 'get',
                url: '{{action("DepositsController@getChequeList")}}',
    ...
    function get_realize_cheques_list(){
        ...
        if($('#realize_cheque_date').val()){
            ...
            $.ajax({
                ...
                data: { start_date, end_date, cheque_no,amount,start_date_created,end_date_created,realize_cheque_bank },
                contentType: 'html',
                success: function(result) {
    ...
    $(document).ready(function () {
        list_deposit_transfer_table = $('#list_deposit_transfer_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url: '/deposits-module/list-deposit-transfer',
                data: function(d){
        ...
        cheques_ob_details_table = $('#cheques_ob_details_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url: "/deposits-module/cheques-ob-details",
                data: function(d){
