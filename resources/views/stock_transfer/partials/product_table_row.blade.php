<tr class="product_row">
    ...
    <td>
        ...
        <!--data-rule-required="true" data-msg-required="@lang('validation.custom-messages.this_field_is_required')" @if($product->enable_stock) data-rule-max-value="{{$product->current_stock}}" data-msg-max-value="@lang('validation.custom-messages.quantity_not_available', ['qty'=> $product->formatted_qty_available, 'unit' => $product->unit  ])" @endif >-->
       ...
       @if($product->enable_stock) 
           data-rule-max-value="{{$product->current_stock}}" 
