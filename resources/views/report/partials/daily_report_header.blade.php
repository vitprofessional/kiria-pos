...
<div class="col-md-12">
    ...
    <div class="modal fade" id="daily_report_customDateRangeModal" tabindex="-1" aria-labelledby="daily_report_customDateRangeModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="daily_report_customDateRangeModalLabel">Select Custom Date Range</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" id="daily_report_start_date" class="form-control custom_start_end_date_range" placeholder="yyyy-mm-dd">
                        </div>
                        <div class="col-md-6">
                            
                            <label for="daily_report_end_date" class="mt-2">To:</label>
                            <input type="date" id="daily_report_end_date" class="form-control custom_start_end_date_range" placeholder="yyyy-mm-dd">
                        </div>
                    </div>
                </div>
    ...
    <div class="col-md-4">
        <div class="box-tools pull-right" style="margin-top: 25px">
            ...
            <button class="btn btn-primary print_report" onclick="prepareToPrint()"> <i class="fa fa-print"></i> @lang('messages.print')</button>
        </div>
    </div>
    @endcomponent
</div>
