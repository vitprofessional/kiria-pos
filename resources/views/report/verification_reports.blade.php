      ...
      $('#monthly_report_date_rage').daterangepicker(dateRangeSettings, function(start, end) {
        ...
        $('#custom_date_apply_button').on('click', function() {
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                ...
                $('#monthly_report_date_rage').data('daterangepicker').setStartDate(moment(startDate));
                $('#monthly_report_date_rage').data('daterangepicker').setEndDate(moment(endDate));
        ...
        $('#monthly_report_date_rage').on('apply.daterangepicker', function(ev, picker) {
    ...
    if ($('#comparison_date_range_one').length == 1) {
        ...
        $('#custom_date_apply_button').on('click', function() {
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                ...
                $('#comparison_date_range_one').data('daterangepicker').setStartDate(moment(startDate));
                $('#comparison_date_range_one').data('daterangepicker').setEndDate(moment(endDate));
        ...
        $('#comparison_date_range_one').on('apply.daterangepicker', function(ev, picker) {
            if (picker.chosenLabel === 'Custom Date Range') {
                $('.custom_date_typing_modal').modal('show');
            }
        });
    ...
    if ($('#comparison_date_range_two').length == 1) {
        ...
        $('#custom_date_apply_button').on('click', function() {
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                ...
                $('#comparison_date_range_two').data('daterangepicker').setStartDate(moment(startDate));
                $('#comparison_date_range_two').data('daterangepicker').setEndDate(moment(endDate));
        ...
        $('#comparison_date_range_two').on('apply.daterangepicker', function(ev, picker) {
            if (picker.chosenLabel === 'Custom Date Range') {
                $('.custom_date_typing_modal').modal('show');
            }
        });
