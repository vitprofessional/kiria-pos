                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="date" id="start_date" class="form-control custom_start_end_date_range" placeholder="yyyy-mm-dd">
                                </div>
                                <div class="col-md-6">
                                
                                <label for="end_date" class="mt-2">To:</label>
                                <input type="date" id="end_date" class="form-control custom_start_end_date_range" placeholder="yyyy-mm-dd">
                                </div>
                            </div>
                            </div>
                ...
                <table class="table table-bordered table-striped" id="supplier_report_tbl" style="width: 100%;">  
                    <thead>
                        <tr>
                            ...
                            <th>@lang('lang_v1.payments')</th>
                            <th>@lang('lang_v1.cheque_returns')</th>
                    ...
                    <tfoot>
                        <tr class="bg-gray font-17 footer-total text-center">
                            ...
                            <td><span class="display_currency" id="footer_total_payments" data-currency_symbol ="true"></span></td>
                            <td><span class="display_currency" id="footer_total_cheque_return" data-currency_symbol ="true"></span></td>
