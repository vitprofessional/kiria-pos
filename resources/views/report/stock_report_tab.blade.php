        ...
        {!! Form::open(['url' => action('ReportController@getStockReport'), 'method' => 'get', 'id' => 'stock_report_filter_form' ]) !!}
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            'form-control', 'id' => 'stock_report_date_range', 'readonly']); !!}
                        </div>
                    </div>
                    <!-- Modal for Custom Date Range -->
                    <div class="modal fade" id="stock_report_customDateRangeModal" tabindex="-1" aria-labelledby="stock_report_customDateRangeModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="stock_report_customDateRangeModalLabel">Select Custom Date Range</h5>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                <div class="col-md-6">
                                    <label for="stock_report_start_date">From:</label>
                                    <input type="date" id="stock_report_start_date" class="form-control custom_start_end_date_range" placeholder="yyyy-mm-dd">
                                    </div>
                                <div class="col-md-6">
                                    
                                    <label for="stock_report_end_date" class="mt-2">To:</label>
                                    <input type="date" id="stock_report_end_date" class="form-control custom_start_end_date_range" placeholder="yyyy-mm-dd">
                                    </div>
                            </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                    <button type="button" class="btn btn-primary" id="stock_report_applyCustomRange">Apply</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3" id="location_filter">
                        <div class="form-group">
                            ...
                            'style' => 'width:100%', 'id' => 'location_id','placeholder' => __('lang_v1.all')]); !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="store_id" id="store_id" class="form-control select2" required style="width:100%">
