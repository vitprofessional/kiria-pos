        ...
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => action('ReportController@getStockReport'), 'method' => 'get', 'id' => 'product_sell_report_form' ]) !!}
                ...
                <div class="modal fade" id="product_sr_customDateRangeModal" tabindex="-1" aria-labelledby="product_sr_customDateRangeModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="product_sr_customDateRangeModalLabel">Select Custom Date Range</h5>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                <div class="col-md-6">
                                <label for="product_sr_start_date">From:</label>
                                <input type="date" id="product_sr_start_date" class="form-control custom_start_end_date_range" placeholder="yyyy-mm-dd">
                                </div>
                                <div class="col-md-6">
                                
                                <label for="product_sr_end_date" class="mt-2">To:</label>
                                <input type="date" id="product_sr_end_date" class="form-control custom_start_end_date_range" placeholder="yyyy-mm-dd">
                                </div>
                            </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                <button type="button" class="btn btn-primary" id="product_sr_applyCustomRange">Apply</button>
                            </div>
                        </div>
                    </div>
                </div>
