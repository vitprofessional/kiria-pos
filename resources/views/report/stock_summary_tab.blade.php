        ...
        {!! Form::open(['url' => action('ReportController@getStockSummaryReport'), 'method' => 'get', 'id' => 'stock_summary_filter_form' ]) !!}
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('stock_summary_date_range', __('report.date_range') . ':') !!}
                            {!! Form::text('date_range', @format_date('first day of this month') . ' ~ ' . @format_date('last
                            day of this month') , ['placeholder' => __('lang_v1.select_a_date_range'), 'class' =>
                            'form-control', 'id' => 'stock_summary_date_range', 'readonly']); !!}
                        </div>
                    </div>
                    <!-- Modal for Custom Date Range -->
                    <div class="modal fade" id="stock_summary_customDateRangeModal" tabindex="-1" aria-labelledby="stock_summary_customDateRangeModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="stock_summary_customDateRangeModalLabel">Select Custom Date Range</h5>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                <div class="col-md-6">
                                    <label for="stock_summary_start_date">From:</label>
                                    <input type="date" id="stock_summary_start_date" class="form-control custom_start_end_date_range" placeholder="yyyy-mm-dd">
                                    </div>
                                <div class="col-md-6">
                                    
                                    <label for="stock_summary_end_date" class="mt-2">To:</label>
                                    <input type="date" id="stock_summary_end_date" class="form-control custom_start_end_date_range" placeholder="yyyy-mm-dd">
                                    </div>
                            </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                    <button type="button" class="btn btn-primary" id="stock_summary_applyCustomRange">Apply</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="store_id" id="summary_store_id" class="form-control select2" required style="width:100%">
