  ...
  <div class="modal-content">
    ...
    <!-- Update payee field -->
      <div class="form-group">
        ...
        {!! Form::select('payee_id', $payees, $expense_category->payee_id, ['class' => 'form-control select2',
        'style' => 'width: 100%', 'required']) !!}
      </div>
      
      <div class="form-group">
          <label>
              {!! Form::checkbox('vat_claimed', 1,  $expense_category->vat_claimed, ['class' => 'input-icheck', 'id' => 'vat_claimed']); !!} <strong>@lang('product.vat_input_claimed')</strong>
          </label>
        </div>
      ...
      <div class="form-group">
        <label for="is_employee">
            {!! Form::checkbox('is_employee', 1, $expense_category->is_employee, ['class' => 'input-icheck', 'id' => 'is_employee']) !!} @lang('expense.is_employee')
        </label>
      </div>
      <div class="form-group @if($expense_category->is_employee == 0) hide @endif employee_list">
        ...
        {!! Form::select('employee_id', $employees, $expense_category->employee_id, ['class' => 'form-control select2', 'placeholder'
        =>
        __('lang_v1.please_select'), 'style' => 'width: 100%']) !!}
      </div>
      <!-- Added By Ram End -->
