...
<tr class="product_row">
    ...
    <td class=" @if($purchase_pos) hide @endif">
        ...
        number_format((rtrim(rtrim($variation->default_purchase_price, '0'), '.')), 6, ".",
                            ''), ['class' => 'form-control input-sm
        purchase_unit_cost_without_discount input_number', 'required', $readonly]); !!}
    </td>
    <td class="">
    ...
    <td class=" @if($purchase_pos) hide @endif">
        ...
        number_format($variation->sell_price_inc_tax, 6), ['class' => 'form-control input-sm input_number default_sell_price',
        'required', $readonly]); !!}
        @else
        {{ number_format($variation->sell_price_inc_tax, 6)}}
        @endif
    </td>
