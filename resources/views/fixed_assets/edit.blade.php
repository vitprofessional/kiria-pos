...
<div class="modal-dialog modal-lg" role="document" style="width: 60%">
    <div class="modal-content">
        ...
        <div class="modal-body">
            {!! Form::open(['url' => action('FixedAssetController@update', $fixed_asset->id), 'method' => 'put' ]) !!}
           
               <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('date', __('account.date')) !!}
                            <input type="datetime-local" class="form-control" name="date_of_operation" value="{{$fixed_asset->date_of_operation}}" required >
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('account_id', $accounts, $fixed_asset->account_id, ['class' => 'form-control select2',
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('asset_name', $fixed_asset->asset_name, ['class' => 'form-control',
                            'required'])
                            !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('asset_location', $fixed_asset->asset_location, ['class' => 'form-control',
                            'required'])
                            !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('amount', $fixed_asset->amount, ['class' => 'form-control',
                            'required'])
                            !!}
                        </div>
                    </div>
