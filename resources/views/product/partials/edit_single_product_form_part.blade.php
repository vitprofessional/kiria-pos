                ...
                <tr>
                    <td>
                        ...
                        <div class="col-sm-6">
                          ...
                          {!! Form::text('single_dpp', $variation->default_purchase_price, ['class' => 'form-control input-sm dpp input_number', 'placeholder' => __('product.exc_of_tax'), 'required']); !!}
                        </div>

                        <div class="col-sm-6">
                          {!! Form::label('single_dpp_inc_tax', trans('product.inc_of_tax') . ':*') !!}
                        
                          {!! Form::text('single_dpp_inc_tax', $variation->dpp_inc_tax, ['class' => 'form-control input-sm dpp_inc_tax input_number', 'placeholder' => __('product.inc_of_tax'), 'required']); !!}
                        </div>
                    </td>

                    <td>
                        <br/>
                        {!! Form::text('profit_percent', $variation->profit_percent, ['class' => 'form-control input-sm input_number', 'id' => 'profit_percent', 'required']); !!}
                    </td>

                    <td>
                        <div class="col-sm-6">
                          <label><span class="dsp_label2">@lang('product.exc_of_sales_tax')</span></label>
                          {!! Form::text('single_dsp', $variation->default_sell_price, ['class' => 'form-control input-sm dsp input_number', 'placeholder' => __('product.exc_of_sales_tax'), 'id' => 'single_dsp', 'required']); !!}
                      </div>
                      <div class="col-sm-6">
                          <label><span class="dsp_inc_label2">@lang('product.inc_of_sales_tax')</span></label>
                        {!! Form::text('single_dsp_inc_tax', $variation->sell_price_inc_tax, ['class' => 'form-control input-sm input_number', 'placeholder' => __('product.inc_of_sales_tax'), 'id' => 'single_dsp_inc_tax', 'required']); !!}
                      </div>
