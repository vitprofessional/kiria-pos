...
<div class="table-responsive">
    <table class="table table-bordered add-product-price-table table-condensed {{$class}}">
        ...
        <tr>
          ...
          <td>
            <br/>
            {!! Form::text('profit_percent', number_format($profit_percent, 2), ['class' => 'form-control input-sm input_number', 'id' => 'profit_percent', 'required']); !!}
          </td>

          <td>
              <div class="col-sm-6">
                  <label><span class="dsp_label2">@lang('product.exc_of_sales_tax')</span></label>
                  {!! Form::text('single_dsp', $default, ['class' => 'form-control input-sm dsp input_number', 'placeholder' => __('product.exc_of_sales_tax'), 'id' => 'single_dsp', 'required']); !!}
              </div>
              <div class="col-sm-6">
                  <label><span class="dsp_inc_label2">@lang('product.inc_of_sales_tax')</span></label>
                {!! Form::text('single_dsp_inc_tax', $default, ['class' => 'form-control input-sm input_number', 'placeholder' => __('product.inc_of_sales_tax'), 'id' => 'single_dsp_inc_tax', 'required']); !!}
              </div>
