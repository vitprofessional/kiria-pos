	...
	<div class="col-md-4 col-xs-4">
		...
		<table class="table table-condensed">
			...
			<tr>
				...
				<td>
					<span class="display_currency" data-is_quantity="true">{{$stock_details['manufactured']}}</span> {{$stock_details['unit']}}
				</td>
			</tr>
		</table>
	</div>
	<div class="col-md-4 col-xs-4">
		...
		<table class="table table-condensed">
			...
			<tr>
				...
				<td>
					<span class="display_currency" data-is_quantity="true">{{$stock_details['input']}}</span> {{$stock_details['unit']}}
				</td>
			</tr>
		...
		<table class="table table-condensed">
			...
			@foreach($storedetails as $store)
			    ...
			    <tr>
    				<th>{{$store->name}}</th>
    				<td>
    					<span class="display_currency" data-is_quantity="true">{{@num_format($store->qty_available)}}</span> {{$stock_details['unit']}}
    				</td>
    			</tr>
