<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('StoreController@storeUserPermission'), 'method' => 'post', 'id' => 'store_add_form' ]) !!}
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="checkbox">
                      <label>
                        {!! Form::checkbox('stores_transfer', 1, false, 
                ...
                <div class="col-md-6">
                    <div class="checkbox">
                      <label>
                        {!! Form::checkbox('stock_adjustment', 1, false, 
                ...
                <div class="col-md-6">
                    <div class="checkbox">
                      <label>
                        {!! Form::checkbox('sell_return', 1, false, 
