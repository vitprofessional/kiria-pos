        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::text('printed_list_customer_statement_date_range', @format_date('first day of this month') . ' ~ ' .
                    @format_date('last
                    day of this month') , ['placeholder' => __('lang_v1.select_a_date_range'), 'class' =>
                    'form-control', 'id' => 'printed_list_customer_statement_date_range', 'readonly']); !!}
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <table class="table table-bordered table-striped" id="customer_statement_list_table" style="width: 100%;">
                        ...
                        <tfoot>
                            <tr>
                                <th colspan="7"></th>
                                <th><span id="grand_total" class="display_currency">0.00</span></th>
                                <th></th>
                            </tr>
                        </tfoot>
                    </table>
