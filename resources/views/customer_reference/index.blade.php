    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('lang_v1.customer_reference')</h4>
                <ul class="breadcrumbs pull-left" style="margin-top: 15px">
                    <li><a href="#">Contact</a></li>
                    <li><span>@lang('lang_v1.customer_reference')</span></li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content main-content-inner">
    ...
    <div class="box-tools pull-right">
        &nbsp;<button type="button" class="btn btn-primary btn-modal" data-href="{{action('CustomerReferenceController@create')}}"
...
<script>
    var columns = [
            { data: 'date', name: 'date' },
            { data: 'contact_name', name: 'cg.name' },
