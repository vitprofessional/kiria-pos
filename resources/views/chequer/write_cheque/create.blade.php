...
<div class="col-md-2">
    ...
    <select id="bankacount" class="form-control" onchange="getBankNextChequedNO();">
        ...
        <option value="{{$bank_account->account->account_number}}">{{$bank_account->account->account_number}}</option>
        @endforeach
    </select>
</div>
    ...
    <select id="chequeTemplate" class="form-control">
        <option>Select Bank account first to select Cheque Template</option>
            ...
            <div class="col-md-2" id="paydive">
                ...
                <input type="text" id="mynumber" class="form-control get_num" value="" onchange="validateDecimalInput(this)">
            </div>
            <div class="col-md-2">
