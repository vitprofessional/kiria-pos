            ...
            <table class="table table-slim">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td data-amount="{{$dnm}}">{!! Form::number("denominations[$dnm]", null, ['class' => 'form-control cash_denomination input-sm', 'min' => 0, 'data-denomination' => $dnm, 'style' => 'width: 100px; margin:auto;' ]); !!}</td>
                  <td class="text-center">=</td>
                  <td class="text-left">
                    <span class="denomination_subtotal" data-total="0"><span class="display_currency" data-currency_symbol="true"></span></span>
                  </td>
                </tr>
                @endforeach
              </tbody>
              <tfoot>
                <tr>
                  ...
                  <td><span class="denomination_total" data-total="0"><span class="display_currency" data-currency_symbol="true"></span></span></td>
                </tr>
              </tfoot>
            </table>
          @else
