                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    Title<br /><br />
                                    <input type="checkbox" name="login_vehicle_registration"
                                        class="show_messages input-icheck" value="1"
                                        @if(!empty($settings->login_vehicle_registration) == 1) {{'checked'}} @endif />Login page  show vehicle Registration Button<br /><br />
                                    ...
                                    <input type="checkbox" id="show_captcha" name="show_messages[lp_captcha]" 
                                    class="show_messages input-icheck" value="1"
                                    @if(!empty($messages_show->lp_captcha)==1) {{ 'checked'}} @endif /> Show reCAPTCHA<br /><br />
...
<script type="text/javascript">
    document.addEventListener("DOMContentLoaded", function() {
        var captchaCheckbox = document.getElementById("show_captcha");
        var recaptchaContainer = document.getElementById("recaptcha-container");

        // Load checkbox state from local storage
        var captchaState = localStorage.getItem('show_captcha');
        ...
        // Add event listener to toggle reCAPTCHA visibility and store state
        captchaCheckbox.addEventListener("change", function() {
            if (this.checked) {
                recaptchaContainer.style.display = "block";
                localStorage.setItem('show_captcha', 'true');
            } else {
                recaptchaContainer.style.display = "none";
                localStorage.setItem('show_captcha', 'false');
            }
        });
    });
</script>
