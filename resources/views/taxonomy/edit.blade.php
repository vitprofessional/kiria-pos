<div class="modal-dialog" role="document">
  <div class="modal-content">
	 ...
	 {!! Form::open(['url' => url('taxonomies/'.$category->id), 'method' => 'PUT', 'id' => 'category_edit_form' ]) !!}
    ...
    <div class="modal-body">
      ...
      @if(!empty($parent_categories) && $enable_sub_category)
          ...
          <div class="form-group @if($is_parent && $category_type != "hrm_designation") {{'hide' }} @endif" id="parent_cat_div">
