<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('CustomerSmsSettingController@store'), 'method' => 'post', 'id' => 'customer_sms_settings_form' ]) !!}
    ...
    <div class="modal-body">
      ...
      <div class="form-group col-md-6">
        {!! Form::label('location_id', __( 'lang_v1.location' ) . ':*') !!}
          {!! Form::select('location_id', $business_locations, null, ['class' => 'form-control select2', 'placeholder' => __( 'lang_v1.please_select' ) ]); !!}
      </div>
      
      <div class="form-group col-md-6">
        {!! Form::label('show_customer', __( 'contact.show_customer' ) . ':*') !!}
          {!! Form::select('show_customer', ['0' => 'No', '1' => 'Yes'], null, ['class' => 'form-control select2', 'placeholder' => __( 'lang_v1.please_select' ) ]); !!}
      </div>
      
      <div class="form-group col-md-6">
        {!! Form::label('show_supplier', __( 'contact.show_supplier' ) . ':*') !!}
          {!! Form::select('show_supplier', ['0' => 'No', '1' => 'Yes'], null, ['class' => 'form-control select2', 'placeholder' => __( 'lang_v1.please_select' ) ]); !!}
      </div>
