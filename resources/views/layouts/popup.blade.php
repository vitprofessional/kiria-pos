...
@if((($request->segment(1) == 'pos' || $request->segment(1) == 'tpos' || $request->segment(1) == 'fpos') && ($request->segment(2) == 'create' || $request->segment(3) == 'edit') || ($request->segment(1) == 'purchase-pos') && ($request->segment(2) == 'create' || $request->segment(3) == 'edit')))
    @php
...
<head>
    ...
    <title>@yield('title') - {{ Session::get('business.name') }}</title>
     ...
     @if(!empty($settings_icon->favicon))
    
     <link rel="shortcut icon" type="image/png" href="{{ asset('public'. $settings_icon->favicon) }}" />
    ...
    <style>
        ...
        .bg-green {
            background-color: #4CAF50; /* or any shade of green you prefer */
            color: #fff; /* Text color on the green background */
        }
        
        .bg-yellow {
            background-color: #FFC107; /* or any shade of yellow you prefer */
            color: #000; /* Text color on the yellow background */
        }
        
        .bg-orange {
            background-color: #FF9800; /* or any shade of orange you prefer */
            color: #fff; /* Text color on the orange background */
        }
        
        .bg-red {
            background-color: #FF0000; /* or any shade of red you prefer */
            color: #fff; /* Text color on the red background */
        }
        
        .bg-light-blue {
            background-color: #87CEFA; /* or any shade of light blue you prefer */
            color: #000; /* Text color on the light blue background */
        }
...
<body style="font-family: @if(!empty($business_details->font_style)) {{$business_details->font_style}} @else Calibri, sans-serif @endif !important;@if(!empty($business_details->font_size)) font-size : {{$business_details->font_size}}px !important; @endif"
    class="@if($pos_layout) hold-transition lockscreen @else hold-transition skin-@if(!empty(session('business.theme_color'))){{session('business.theme_color')}}@else{{'blue'}}@endif @endif">
    ...
    <div class="modal fade view_modal" role="dialog" aria-labelledby="gridSystemModalLabel"  aria-hidden="true" data-backdrop="static" data-keyboard="false"></div> <!-- point 1 done updated by dushyant -->
