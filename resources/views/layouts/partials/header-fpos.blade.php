...
<div class="col-md-12 no-print pos-header">
    <input type="hidden" id="pos_redirect_url" value="{{action('TposController@createFpos')}}" />
    <div class="row">
        <div class="col-md-10">
            <a href="{{ action('TposController@indexFpos')}}" title="{{ __('lang_v1.go_back') }}" data-toggle="tooltip" data-placement="bottom" class="btn btn-info btn-flat m-6 btn-xs m-5 pull-right">
