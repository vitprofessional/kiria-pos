  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-12" id="vid_div">
          <div class="form-group">
            {!! Form::label('vendor_id', __('printer.vendor_id') . ':*') !!}
            {!! Form::text('vendor_id', $printer->vendor_id, ['class' => 'form-control']); !!}
          </div>
        </div>

        <div class="col-sm-12" id="pid_div">
          <div class="form-group">
            {!! Form::label('product_id', __('printer.product_id') . ':*') !!}
            {!! Form::text('product_id', $printer->product_id, ['class' => 'form-control']); !!}
          </div>
        </div>
