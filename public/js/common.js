$(document).ready(function () {
    ...
    jQuery.extend($.fn.dataTable.defaults, {
        fixedHeader: true,
        dom: '<"row margin-bottom-20 text-center"<"col-sm-12"B><"col-sm-7 text-align-start"l><"col-sm-5 pr-50"f> r>tip',
...
$(document).on('input', 'input.cust_input_number', function (event) {
