$(document).ready(function () {
    ...
    if ($('#contact_date_range').length == 1) {
        ...
        $('#custom_date_apply_button').on('click', function() {
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                ...
                $('#contact_date_range').val(formattedStartDate + ' ~ ' + formattedEndDate);

                $('#contact_date_range').data('daterangepicker').setStartDate(moment(startDate));
                $('#contact_date_range').data('daterangepicker').setEndDate(moment(endDate));
    ...
    supplier_report_tbl = $('#supplier_report_tbl').DataTable({
        ...
        columns: [
            ...
            { data: 'total_cheque_return', name: 'total_cheque_return' },
        ...
        fnDrawCallback: function (oSettings) {
            ...
            var total_payments = sum_table_col($('#supplier_report_tbl'), 'total_payments');
            $('#footer_total_payments').text(total_payments);
            
            var total_cheque_return = sum_table_col($('#supplier_report_tbl'), 'total_cheque_return');
            $('#footer_total_cheque_return').text(total_cheque_return);
    ...
    if ($('#product_loss_excess_date_range').length == 1) {
        ...
        $('#custom_date_apply_button').on('click', function() {
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                ...
                $('#product_loss_excess_date_range').val(formattedStartDate + ' ~ ' + formattedEndDate);

                $('#product_loss_excess_date_range').data('daterangepicker').setStartDate(moment(startDate));
                $('#product_loss_excess_date_range').data('daterangepicker').setEndDate(moment(endDate));
        ...
        $('#product_loss_excess_date_range').on('apply.daterangepicker', function(ev, picker) {
            if (picker.chosenLabel === 'Custom Date Range') {
                $('.custom_date_typing_modal').modal('show');
            }
        });
    ...
    if ($('#product_transaction_date_range').length == 1) {
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                    ...
                    $('#product_transaction_date_range').val(formattedStartDate + ' ~ ' + formattedEndDate);
    
                    $('#product_transaction_date_range').data('daterangepicker').setStartDate(moment(startDate));
                    $('#product_transaction_date_range').data('daterangepicker').setEndDate(moment(endDate));
    ...
    if ($('#stock_report_date_range').length == 1) {
            $('#stock_report_date_range').daterangepicker(dateRangeSettings, function(start, end) {
                $('#stock_report_date_range span').html(
                    start.format(moment_date_format) + ' ~ ' + end.format(moment_date_format)
                );
                get_stock_value();
            });
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                    ...
                    $('#stock_report_date_range').val(formattedStartDate + ' ~ ' + formattedEndDate);

                    $('#stock_report_date_range').data('daterangepicker').setStartDate(moment(startDate));
                    $('#stock_report_date_range').data('daterangepicker').setEndDate(moment(endDate));
            ...
            $('#stock_report_date_range').on('apply.daterangepicker', function(ev, picker) {
                if (picker.chosenLabel === 'Custom Date Range') {
                    $('.custom_date_typing_modal').modal('show');
                }
            });
            $('#stock_report_date_range').on('cancel.daterangepicker', function(ev, picker) {
                $('#stock_report_date_range').html(
                    '<i class="fa fa-calendar"></i> ' + LANG.filter_by_date
                );
            });
        }
        
        $('#stock_report_date_range').change(function() {
            get_stock_value();
        });
    
    if ($('#stock_summary_date_range').length == 1) {
        $('#stock_summary_date_range').daterangepicker(dateRangeSettings, function (start, end) {
            $('#stock_summary_date_range').val(
                start.format(moment_date_format) + ' ~ ' + end.format(moment_date_format)
            );
        });
        $('#custom_date_apply_button').on('click', function() {
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                ...
                $('#stock_summary_date_range').val(formattedStartDate + ' ~ ' + formattedEndDate);

                $('#stock_summary_date_range').data('daterangepicker').setStartDate(moment(startDate));
                $('#stock_summary_date_range').data('daterangepicker').setEndDate(moment(endDate));
        ...
        $('#stock_summary_date_range').on('apply.daterangepicker', function(ev, picker) {
            if (picker.chosenLabel === 'Custom Date Range') {
                $('.custom_date_typing_modal').modal('show');
            }
        });
        $('#stock_summary_date_range').on('cancel.daterangepicker', function (ev, picker) {
            $('#stock_summary_date_range').val('');
        });
        $('#stock_summary_date_range')
            .data('daterangepicker')
            .setStartDate(moment().startOf('month'));
        $('#stock_summary_date_range').data('daterangepicker').setEndDate(moment().endOf('month'));
    }
    ...
    var stock_summary_cols = [
        { data: 'product', name: 'p.name' },
        { data: 'prod_sku', name: 'p.sku' },
        { data: 'category_name', name: 'c.name' },
        { data: 'location_name', name: 'l.name' },
        { data: 'opening_stock', name: 'opening_stock', searchable: false },
        { data: 'total_purchased', name: 'total_purchased', searchable: false },
        { data: 'total_sold', name: 'total_sold', searchable: false },
        { data: 'stock', name: 'stock', searchable: false },
        { data: 'store_wise', name: 'store_wise', searchable: false },
        { data: 'total_adjusted', name: 'total_adjusted', searchable: false },
        { data: 'remarks', name: 'remarks', searchable: true },
    ];
    
    // stock_summary_cols.push({ data: 'total_purchased', name: 'total_purchased', searchable: false });
    // stock_summary_cols.push({ data: 'total_sold', name: 'total_sold', searchable: false });
    // stock_summary_cols.push({ data: 'remarks', name: 'remarks', searchable: true });
    ...
    stock_report_table = $('#stock_report_table').DataTable({
        ...
        ajax: {
            ...
            data: function(d) {
                ...
                var dateRange = $('#stock_report_date_range').val();
    ...
    //Stock summary table
    stock_summary_table = $('#stock_summary_table').DataTable({
        processing: true,
        serverSide: true,
        scrollY: "75vh",
        scrollX: true,
        ...
        ajax: {
            ...
            data: function(d) {
                d.type = $('#summary_product_list_filter_type').val();
                d.product_id = $('#summary_product_list_filter_product_id').val();
                d.location_id = $('#summary_location_id').val();
                d.category_id = $('#summary_product_list_filter_category_id').val();
                d.sub_category_id = $('#summary_product_list_filter_sub_category_id').val();
                d.brand_id = $('#summary_product_list_filter_brand_id').val();
                d.unit_id = $('#summary_product_list_filter_unit_id').val();
                d.tax_id = $('#summary_product_list_filter_tax_id').val();
                d.store_id = $('#summary_store_id').val();
                d.active_state = $('#summary_active_state').val();
                d.only_mfg_products = $('#summary_only_mfg_products').length && $('#summary_only_mfg_products').is(':checked') ? 1 : 0;
                
                var dateRange = $('#stock_summary_date_range').val();
    ...
    if ($('#vat_report_date_filter').length == 1) {
        $('#vat_report_date_filter').daterangepicker(dateRangeSettings, function (start, end) {
            $('#vat_report_date_filter span').html(
                start.format(moment_date_format) + ' ~ ' + end.format(moment_date_format)
            );
            updateTaxReport();
        });
        $('#vat_report_date_filter').on('cancel.daterangepicker', function (ev, picker) {
            $('#vat_report_date_filter').html(
                '<i class="fa fa-calendar"></i> ' + LANG.filter_by_date
            );
        });
        $('#vat_report_date_filter').data('daterangepicker').setStartDate(moment().startOf('month'));
        $('#vat_report_date_filter').data('daterangepicker').setEndDate(moment().endOf('month'));
        updateVatReport();
    }
    ...
    if ($('#trending_product_date_range').length == 1) {
        ...
        $('#custom_date_apply_button').on('click', function() {
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                ...
                $('#trending_product_date_range').val(formattedStartDate + ' ~ ' + formattedEndDate);

                $('#trending_product_date_range').data('daterangepicker').setStartDate(moment(startDate));
                $('#trending_product_date_range').data('daterangepicker').setEndDate(moment(endDate));
    ...
    $(
        '#stock_report_date_range ,#product_list_filter_only_manufactured_products, #product_list_filter_product_id, #product_list_filter_sub_category_id, #stock_report_filter_form #location_id, #stock_report_filter_form #product_list_filter_category_id, #stock_report_filter_form #product_list_filter_sub_category_id, #stock_report_filter_form #product_list_filter_brand_id, #stock_report_filter_form #product_list_filter_unit_id,#stock_report_filter_form #view_stock_filter,#stock_report_filter_form #store_id,#stock_report_filter_form #active_state '
    ).change(function () {
    ...
    $(
        '#stock_summary_date_range ,#summary_product_list_filter_only_manufactured_products, #summary_product_list_filter_product_id, #summary_product_list_filter_sub_category_id, #stock_summary_filter_form #summary_location_id, #stock_summary_filter_form #summary_product_list_filter_category_id, #stock_summary_filter_form #summary_product_list_filter_sub_category_id, #stock_summary_filter_form #summary_product_list_filter_brand_id, #stock_summary_filter_form #summary_product_list_filter_unit_id,#stock_summary_filter_form #view_stock_filter,#stock_summary_filter_form #summary_store_id,#stock_summary_filter_form #summary_active_state '
    ).change(function () {
        // stock_report_table.ajax.reload();
        ...
        if (
            $('#summary_product_list_filter_product_id').val() !== '' &&
            $('#summary_product_list_filter_product_id').val() !== undefined
        ) {
            $('.product').text($('#summary_product_list_filter_product_id :selected').text());
        } else {
            $('.product').text('All');
        }
        if ($('#summary_product_list_filter_category_id').val() !== '' && $('#summary_product_list_filter_category_id').val() !== undefined) {
            $('.category').text($('#summary_product_list_filter_category_id :selected').text());
        } else {
            $('.category').text('All');
        }
        if (
            $('#summary_product_list_filter_sub_category_id').val() !== '' &&
            $('#summary_product_list_filter_sub_category_id').val() !== undefined
        ) {
            $('.sub_category').text($('#summary_product_list_filter_sub_category_id :selected').text());
        } else {
            $('.sub_category').text('All');
        }
        get_summary_value();
    ...
    $('#summary_only_mfg_products').on('ifChanged', function (event) {
        stock_summary_table.ajax.reload();
        lot_report.ajax.reload();
        stock_expiry_report_table.ajax.reload();
        items_report_table.ajax.reload();
    ...
    $(document).on('change','#tax_report_location_filter,#vat_report_location_filter,#contact_id,#reference_type',function () { 
        updateTaxReport();
    });
    ...
    if ($('#close_date').length == 1) {
        ...
        $('#custom_date_apply_button').on('click', function() {
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                ...
                $('input#close_date').val(formattedStartDate + ' ~ ' + formattedEndDate);

                $('input#close_date').data('daterangepicker').setStartDate(moment(startDate));
                $('input#close_date').data('daterangepicker').setEndDate(moment(endDate));
    ...
    if ($('#product_pr_date_filter').length == 1) {
        ...
        $('#custom_date_apply_button').on('click', function() {
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                ...
                $('#product_pr_date_filter').val(formattedStartDate + ' ~ ' + formattedEndDate);

                $('#product_pr_date_filter').data('daterangepicker').setStartDate(moment(startDate));
                $('#product_pr_date_filter').data('daterangepicker').setEndDate(moment(endDate));
        ...
        $('#product_pr_date_filter').on('apply.daterangepicker', function(ev, picker) {
            if (picker.chosenLabel === 'Custom Date Range') {
                $('.custom_date_typing_modal').modal('show');
            }
        });
    ...
    product_purchase_report = $('table#product_purchase_report_table').DataTable({
        ...
        fnDrawCallback: function (oSettings) {
            ...
            $('#footer_total_unit_price').html(
                sum_table_col($('#product_purchase_report_table'), 'span_purchase_price')
            );
    ...
    if ($('#product_sr_date_filter').length == 1) {
        ...
        $('#custom_date_apply_button').on('click', function() {
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                ...
                $('#product_sr_date_filter').val(formattedStartDate + ' ~ ' + formattedEndDate);

                $('#product_sr_date_filter').data('daterangepicker').setStartDate(moment(startDate));
                $('#product_sr_date_filter').data('daterangepicker').setEndDate(moment(endDate));
    ...
    if ($('#ppr_date_filter').length == 1) {
        ...
        $('#custom_date_apply_button').on('click', function() {
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                ...
                $('#ppr_date_filter').val(formattedStartDate + ' ~ ' + formattedEndDate);

                $('#ppr_date_filter').data('daterangepicker').setStartDate(moment(startDate));
                $('#ppr_date_filter').data('daterangepicker').setEndDate(moment(endDate));
        ...
        $('#ppr_date_filter').on('apply.daterangepicker', function(ev, picker) {
            if (picker.chosenLabel === 'Custom Date Range') {
                $('.custom_date_typing_modal').modal('show');
            }
        });
    ...
    sell_payment_report = $('table#sell_payment_report_table').DataTable({
        ...
        columns: [
            ...
            { data: 'ref_no', name: 'transaction_payments.payment_ref_no' },
            { data: 'paid_on', name: 'paid_on' },
            { data: 'amount', name: 'transaction_payments.amount' },
    ...
    if ($('#spr_date_filter').length == 1) {
        ...
        $('#custom_date_apply_button').on('click', function() {
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                ...
                $('#spr_date_filter').val(formattedStartDate + ' ~ ' + formattedEndDate);

                $('#spr_date_filter').data('daterangepicker').setStartDate(moment(startDate));
                $('#spr_date_filter').data('daterangepicker').setEndDate(moment(endDate));
        ...
        $('#spr_date_filter').on('apply.daterangepicker', function(ev, picker) {
            if (picker.chosenLabel === 'Custom Date Range') {
                $('.custom_date_typing_modal').modal('show');
            }
        });
    ...
    if ($('#ir_purchase_date_filter').length == 1) {
        ...
        $('#custom_date_apply_button').on('click', function() {
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                ...
                $('#ir_purchase_date_filter').val(formattedStartDate + ' ~ ' + formattedEndDate);

                $('#ir_purchase_date_filter').data('daterangepicker').setStartDate(moment(startDate));
                $('#ir_purchase_date_filter').data('daterangepicker').setEndDate(moment(endDate));
        ...
        $('#ir_purchase_date_filter').on('apply.daterangepicker', function(ev, picker) {
            if (picker.chosenLabel === 'Custom Date Range') {
                $('.custom_date_typing_modal').modal('show');
            }
        });
    ...
    if ($('#ir_sale_date_filter').length == 1) {
        ...
        $('#custom_date_apply_button').on('click', function() {
            ...
            if (startDate.length === 10 && endDate.length === 10) {
                ...
                $('#ir_sale_date_filter').val(formattedStartDate + ' ~ ' + formattedEndDate);

                $('#ir_sale_date_filter').data('daterangepicker').setStartDate(moment(startDate));
                $('#ir_sale_date_filter').data('daterangepicker').setEndDate(moment(endDate));
        ...
        $('#ir_sale_date_filter').on('apply.daterangepicker', function(ev, picker) {
            if (picker.chosenLabel === 'Custom Date Range') {
                $('.custom_date_typing_modal').modal('show');
            }
        });
...
function updateTaxReport() {
    ...
    var data = { start_date: start, end_date: end, location_id: location_id, contact_id: contact_id, reference_type: reference_type };
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            // Clear existing DataTable data and add new data
            if ($.fn.DataTable.isDataTable('#taxes_details_table')) {
                taxes_details_table.ajax.reload();
            } else {
                // Initialize DataTable if not already defined
                taxes_details_table = $('#taxes_details_table').DataTable({
                    ...
                    fnDrawCallback: function (oSettings) {
                        ...
                        $('#footer_vat_total').text(total_tax);
...
function updateVatReport() {
    var start = $('#vat_report_date_filter').data('daterangepicker').startDate.format('YYYY-MM-DD');
    var end = $('#vat_report_date_filter').data('daterangepicker').endDate.format('YYYY-MM-DD');
    var location_id = $('#vat_report_location_filter').val();
    var data = { start_date: start, end_date: end, location_id: location_id };
    ...
    $.ajax({
        method: 'GET',
        url: '/vat-module/vat-reports-data',
        dataType: 'json',
        data: data,
        success: function (data) {
...
function updateStockAdjustmentReport() {
    ...
    $.ajax({
        ...
        if (stock_adjustment_table instanceof $.fn.dataTable.Api) {
...
function get_stock_value() {
    ...
    // var dateRange = $('#stock_report_date_range').val();
    var start = $('#stock_report_date_range')
                .data('daterangepicker')
                .startDate.format('YYYY-MM-DD');
            var end = $('#stock_report_date_range')
                .data('daterangepicker')
                .endDate.format('YYYY-MM-DD');
    var data = {
        ...
        product_id : $('#product_list_filter_product_id').val(),
        location_id : $('#location_id').val(),
...
function get_summary_value() {
    var loader = __fa_awesome();
    $('#summary_closing_stock_by_pp').html(loader);
    $('#summary_closing_stock_by_sp').html(loader);
    $('#summary_potential_profit').html(loader);
    $('#summary_profit_margin').html(loader);
    var data = {
        location_id: $('#location_id').val(),
        category_id: $('#category_id').val(),
        sub_category_id: $('#sub_category_id').val(),
        brand_id: $('#brand').val(),
        unit_id: $('#unit').val(),
        type : $('#summary_product_list_filter_type').val(),
        product_id : $('#summary_product_list_filter_product_id').val(),
        location_id : $('#summary_location_id').val(),
        category_id : $('#summary_product_list_filter_category_id').val(),
        sub_category_id : $('#summary_product_list_filter_sub_category_id').val(),
        brand_id : $('#summary_product_list_filter_brand_id').val(),
        unit_id : $('#summary_product_list_filter_unit_id').val(),
        tax_id : $('#summary_product_list_filter_tax_id').val(),
        store_id : $('#summary_store_id').val(),
        active_state : $('#summary_active_state').val(),
        only_mfg_products : $('#summary_only_mfg_products').length && $('#summary_only_mfg_products').is(':checked') ? 1 : 0,
    }
    
    var dateRange = $('#stock_summary_date_range').val();
    data.start_date = dateRange.split(' - ')[0];
    data.end_date = dateRange.split(' - ')[1];
    
    $.ajax({
        url: '/reports/get-stock-value',
        data: data,
        success: function(data) {
            $('#summary_closing_stock_by_pp').text(__currency_trans_from_en(data.closing_stock_by_pp));
            $('#summary_closing_stock_by_sp').text(__currency_trans_from_en(data.closing_stock_by_sp));
            $('#summary_potential_profit').text(__currency_trans_from_en(data.potential_profit));
            $('#summary_profit_margin').text(__currency_trans_from_en(data.profit_margin, false));
        },
    });
}
