...
function pos_discount(total_amount) {
    ...
    $('table#pos_table tbody tr').each(function() {
        row_discount += __read_number($(this).find('input.pos_discount_value')) * __read_number($(this).find('input.pos_quantity'));
    });
...
function pos_order_tax(price_total, discount) {
    ...
    var row_tax = 0;
    $('table#pos_table tbody tr').each(function() {
        row_tax += __read_number($(this).find('input.item_tax')) * __read_number($(this).find('input.pos_quantity'));
    });
