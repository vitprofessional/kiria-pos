...
Route::group(['middleware' => ['web'], 'prefix' => 'mpcs', 'namespace' => 'Modules\MPCS\Http\Controllers'], function () {
    ...
    Route::post('/store-form-9c-settings', [Form9CSettingsController::class, 'store'])->name('mpcs.forms.form_9c');
    Route::get('/edit-form-settings-9c/{id}', [Form9CSettingsController::class, 'edit'])->name('mpcs.forms.partials.edit_9c_form_settings');
    Route::post('/update-form-settings-9c/{id}', [Form9CSettingsController::class, 'update'])->name('mpcs.forms.form_9c');
});
