                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered" id="sub_member_table" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>@lang( 'messages.date' )</th>
                                                <th>@lang( 'member::lang.member_code' )</th>
                                                <th>@lang( 'member::lang.name' )</th>
                                                <th>@lang( 'member::lang.relation' )</th>
...
<script>
     sub_member_table = $('#sub_member_table').DataTable({
            processing: true,
            serverSide: false,
            ajax: {
                url : "{{action('\Modules\Member\Http\Controllers\MemberController@all_sub_member')}}",
                data: function(d){
