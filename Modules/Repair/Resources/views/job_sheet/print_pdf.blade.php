	...
	<tr>
		<td style="vertical-align: top;">
			<table class="width-100">
				<tr>
					<th style="padding-left: 0;">@lang('role.customer'): {{$job_sheet->customer->name}}</th>
				</tr>
				<tr>
...
<div class="width-100 content-div">
	...
	@endphp
	@if(!empty($product_configuration) && is_array($product_configuration))
...
<div class="width-100 content-div">
	...
	@endphp
	@if(!empty($product_condition) && is_array($product_condition))
