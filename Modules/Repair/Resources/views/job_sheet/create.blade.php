                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="hidden" id="reportStatus" name="reportStatus" value="{{$status}}">
                        ...
                        <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        ...
                                        data-href="{{action('\Modules\Repair\Http\Controllers\DeviceModelController@create')}}" id="add_device_model"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
                                    </span>
                            </div>
                        </div>
                    </div>
