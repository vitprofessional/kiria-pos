<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\Repair\Http\Controllers\RepairBrandController@store'), 'method' => 'post', 'id' => $quick_add ? 'quick_add_brand_form' : 'repair_brand_add_form' ]) !!}
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        {!! Form::label('description', __( 'brand.short_description' ) . ':') !!}
         ...
         <div class="form-group">
             <label>
                {!!Form::checkbox('use_for_repair', 1, true, ['class' => 'input-icheck','disabled' => true]) !!}
                Use Repair?
            </label>
