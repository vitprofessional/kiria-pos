...
Route::group(['middleware' => ['web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone','tenant.context'], 'prefix' => 'repair', 'namespace' => 'Modules\Repair\Http\Controllers'], function () {
    ...
    Route::resource('brands', 'RepairBrandController');

    Route::get('autosheet/create','JobSheetController@autocreate');
});
