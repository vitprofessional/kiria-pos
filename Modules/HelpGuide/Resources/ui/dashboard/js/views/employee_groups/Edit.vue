...
export default {
  ...
  async mounted() {
    await axios.post(this.$myaccount_url+"employee-groups/view", {id: this.category}).then((response) => {
  ...
  methods: {
      save(){
          ...
          axios
          .post(this.$myaccount_url+'employee-groups/'+this.category, fields)
          .then(response => {
