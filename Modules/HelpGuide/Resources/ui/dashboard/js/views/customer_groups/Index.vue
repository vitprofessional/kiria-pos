        ...
        <div class="card sticky-section-item">
          <div class="card-body p-3">
            ...
            <div class="form-floating mb-3">
              ...
              />
              <label for="category_name">{{ $t("Customer Group name") }}</label>
            </div>                    
      ...
      <div class="col-sm-12 col-md-9">
        ...
        <div v-else class="p-3 bg-white rounded shadow-sm">
          <div v-if="categories().length">
            <h4 class="h4 pb-2 mb-2">{{ $t("Customer Groups") }}</h4>
            <ul class="list-group">
              <li
          ...
          <empty-state v-else text="No customer groups yet" />
        </div>
      </div>
    </div>
    <v-dialog />
...
export default {
  ...
  methods: {
    ...
    addCategory: function () {
      ...
      axios
        .post(this.$myaccount_url + "customer-groups", fields)
        .then((response) => {
    ...
    doDelete: function (category_id) {
      ...
      this.$toastClear();
      axios
        .post(this.$myaccount_url + "customer-groups/" + category_id, {
          _method: "delete",
        })
        .then((response) => {
          if (response.data.data) {
