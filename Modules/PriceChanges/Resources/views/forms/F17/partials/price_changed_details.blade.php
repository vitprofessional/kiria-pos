        ...
        <table class="table table-bordered table-striped" id="price_changed_details_table" style="width:100%;">
            <thead>
                <tr>
                    ...
                    <th>@lang('pricechanges::lang.product_category')</th>
                    <th>@lang('pricechanges::lang.product_subcategory')</th>
                    <th>@lang('pricechanges::lang.current_price')</th>
                    <th>@lang('pricechanges::lang.new_price')</th>
                    <th>@lang('pricechanges::lang.quantity')</th>
                    <th>@lang('pricechanges::lang.total_gain')</th>
                    <th>@lang('pricechanges::lang.total_loss')</th>
