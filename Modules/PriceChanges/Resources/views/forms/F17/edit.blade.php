            ...
            <div class="settlement_tabs">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="f17_from_tab">
                        @include('pricechanges::forms.F17.partials.f17_from_edit')
                    </div>
...
<!--<script>
    ...
    $('#f17_save').click(function(e){
        ...
        $.ajax({
            method: 'put',
            url: "{{action('\Modules\PriceChanges\Http\Controllers\F17FormController@update', [$id])}}",
            data: { 
            ...
            success: function(result) {
                ...
                if(result.success == 0){
                    ...
                    window.location.href = '{{URL::to('/')}}/pricechanges/F17';
                }
