@extends('layouts.app')
@section('title', __('myhealth::patient.pharmacy'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
  <h1>@lang('myhealth::patient.pharmacy')</h1>
</section>
<style>
  label {
...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      @include('myhealth::pharmacy.partials.add_pharmacy_form')
      @endcomponent
    ...
    <div class="modal-dialog" role="document" style="width: 70%;">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <h3 class="form-header">@lang('myhealth::patient.pharmacy_register')</h3>
