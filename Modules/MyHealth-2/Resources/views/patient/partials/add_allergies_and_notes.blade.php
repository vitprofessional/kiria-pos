<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('\Modules\MyHealth\Http\Controllers\AllergiesController@store'), 'method' => 'post', 'id' => 'add_allergie_form' ]) !!}

        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">@lang( 'myhealth::patient.add_allergie_&_notes' )</h4>
        </div>
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="form-group col-sm-12">
                    {!! Form::label('allergy_name', __('myhealth::patient.allergie_&_notes'), []) !!}
...
<script>
    ...
    $('#add_allergie_btn').click(function(e){
        e.preventDefault();
        url = "{{action('\Modules\MyHealth\Http\Controllers\AllergiesController@store')}}";
