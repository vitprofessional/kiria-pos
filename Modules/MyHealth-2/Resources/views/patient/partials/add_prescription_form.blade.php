...
{!! Form::open(['url' => action('\Modules\MyHealth\Http\Controllers\PrescriptionController@upload'), 'method' => 'post', 'id' =>
'prescription_form', 'enctype' => 'multipart/form-data']) !!}
@else
{!! Form::open(['url' => action('\Modules\MyHealth\Http\Controllers\PrescriptionController@store'), 'method' => 'post','id' => 'prescription_form']) !!}
@endif
@else
{!! Form::open(['url' => action('\Modules\MyHealth\Http\Controllers\PrescriptionController@update', [$prescription->id]), 'method' => 'PUT','id' =>
'prescription_form']) !!}
@endif

<div class="modal-header">
    @if (empty($prescription))
    <h4 class="modal-title">@lang('myhealth::patient.add_new_prescription')</h4>
    @else
    <h4 class="modal-title">@lang('myhealth::patient.editprescription')</h4>
    @endif
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 ">
            <div class="form-group">
                {!! Form::label('hospital', __('myhealth::patient.hospital') . ':' ) !!}
                {!! Form::text('hospital_name', !empty($prescription)?$prescription->hospital_name:null , ['class' => 'form-control', 'id' => 'hospital_name', 'placeholder' => __('myhealth::patient.hospital'), 'style' => 'width:100%;']); !!}
            </div>
        </div>

        <div class="col-md-6 ">
            <div class="form-group">
                {!! Form::label('doctor', __('myhealth::patient.doctor') . ':' ) !!}
                <div class="input-group">
                    ...
                    mousetrap', 'id' => 'doctor_id', 'placeholder' => __('myhealth::patient.doctor')]); !!}
        ...
        <div class="col-md-6">
            <div class="form-group">
                {!! Form::label('date', __('myhealth::patient.date') . ':' ) !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-calendar-check-o"></i>
                    </span>
                   {!! Form::text('date', null, ['class' => 'form-control', 'required', 'placeholder' =>  __('myhealth::patient.date'), 'id' => 'prescription_date']) !!}
                </div>
            </div>
        </div>
        @if (request()->session()->get('business.is_patient'))
        <div class="col-md-6">
            <div class="form-group">
                {!! Form::label('amount', __('myhealth::patient.amount') . ':') !!}
                {!! Form::text('amount', null, ['class' => 'form-control',  'placeholder' =>  __('myhealth::patient.amount'), 'id' => 'prescription_amount']) !!}

            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
                {!! Form::label('prescription_file', __('myhealth::patient.file') . ':*' ) !!}
        ...
        <div class="col-md-12">
            <div class="form-group">
                {!! Form::label('symptoms', __('myhealth::patient.symptoms') . ':*' ) !!}
        ...
        <div class="col-md-12">
            <div class="form-group">
                {!! Form::label('diagnosis', __('myhealth::patient.diagnosis') . ':*' ) !!}
        ...
        <div class="col-md-6 ">
            <div class="form-group">
                {!! Form::label('allergies', __('myhealth::patient.allergies') . ':*' ) !!}
                <div class="input-group">
                    {!! Form::select('allergies_id',
                    $allergies, !empty($prescription)?$prescription->allergies_id:null , ['class' => 'form-control
                    mousetrap', 'id' => 'allergies_id', 'placeholder' => __('myhealth::patient.allergies'), 'required']); !!}
                    <span class="input-group-btn">
        ...
        <div class="col-md-12" style="padding-left: 30px;">
            <div class="row">
                {!! Form::label('medicine', __('myhealth::patient.medicine') . ':*' ) !!}
            </div>
            <div class="row" id="medicine_rows">
                ...
                <div class="medicine_row">
                    <div class="col-md-5" style="padding-left: 0px;">
                        ...
                        __('myhealth::patient.medicine_name')]) !!}
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                'placeholder'
                                =>
                                __('myhealth::patient.medicine_notes')]) !!}
                            </div>
                        </div>
                    </div>
        ...
        <div class="row" style="padding-left: 30px;">
            <button class="btn btn-primary btn-sm" id="add_medicine_row">@lang('myhealth::patient.add_medicine')</button>
        </div>
        <div class="clearfix"></div>
        <div class="col-md-12" style="padding-left: 30px;" id="medicine_row">
            <div class="row">
                {!! Form::label('test', __('myhealth::patient.test') . ':*' ) !!}
            </div>
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                'placeholder'
                                =>
                                __('myhealth::patient.test_notes')]) !!}
                            </div>
                        </div>
                    </div>
        ...
        <div class="row" style="padding-left: 30px;">
            <button class="btn btn-primary btn-sm" id="add_test_row">@lang('myhealth::patient.add_test')</button>
        </div>
        @endif
        <br>
        <br>
        ...
        <div class="row" style="margin: 20px;">
            <a href="{{action('\Modules\MyHealth\Http\Controllers\PatientController@show', $this_patient_id)}}" class="btn btn-danger pull-left active" role="button" aria-pressed="true">@lang('myhealth::patient.back')</a>
