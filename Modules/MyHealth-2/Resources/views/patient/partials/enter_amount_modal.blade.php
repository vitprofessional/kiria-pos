<div class="modal-dialog" role="document" style="width: 40%" >
    <div class="modal-content print">
        <div class="modal-header">
            <h5 class="modal-title">@lang('myhealth::patient.enter_amount')</h5>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="form-group">
                    {!! Form::label('enter_amount', __('myhealth::patient.amount') . ':') !!}
                    {!! Form::text('enter_amount', !empty($amount)? $amount : null, ['class' => 'form-control',  'placeholder' =>  __('myhealth::patient.amount'), 'id' => 'prescription_amount']) !!}
