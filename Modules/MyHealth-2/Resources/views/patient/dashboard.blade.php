...
<section class="content no-print">
    ...
    <div class="row">
        ...
        $rand = rand(0,5);
        @endphp
        <a href="{{action('\Modules\MyHealth\Http\Controllers\PatientController@show', $patient->id)}}">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-text" style="font-size: 20px; color: black;">{{ $patient->name }}</span>
