@extends('layouts.app')
@section('title', __('myhealth::patient.test'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
  <h1>@lang('myhealth::patient.test')</h1>
</section>
<style>
  label {
...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      @include('myhealth::laboratory.partials.add_test_form')
      @endcomponent
    ...
    <div class="modal-dialog" role="document" style="width: 70%;">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <h3 class="form-header">@lang('myhealth::patient.laboratory_register')</h3>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            {!! Form::text('medicine[`+row_index+`][amount]', null, ['class' => 'form-control', 'placeholder' =>  __('myhealth::patient.amount'), 'id' => 'pharmacy_amount']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            {!! Form::text('medicine[`+row_index+`][qty]', null, ['class' => 'form-control', 'placeholder' =>  __('myhealth::patient.qty'), 'id' => 'pharmacy_amount']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            {!! Form::text('test[`+row_index+`][amount]', null, ['class' => 'form-control', 'placeholder' =>  __('myhealth::patient.amount'), 'id' => 'pharmacy_amount']) !!}
                        </div>
                    </div>
                </div>
