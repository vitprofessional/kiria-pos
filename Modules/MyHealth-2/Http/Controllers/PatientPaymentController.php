...
use Modules\MyHealth\Entities\PatientPayment;
        ...
        if (request()->ajax()) {
            ...
            ->addColumn('action', function ($row) {
                ...
                if (!empty($row->invoice)) {
                    $html .= '<li><a href="#" data-href="' . action('\Modules\MyHealth\Http\Controllers\PrescriptionController@imageModal', ['title' => 'Test', 'url' => url($row->invoice)]) . '" class="btn-modal" data-container=".view_modal"><i class="fa fa-eye" aria-hidden="true"></i>' . __("messages.view") . '</a></li>';
                } 
                else {
