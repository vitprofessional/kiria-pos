...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\Shipping\Http\Controllers\ShippingController@storePartnerCommission', $shipment->id), 'method' =>
    'post']) !!}
    ...
    @if(!empty($shipment->shipping_partner))
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="form-group col-sm-6">
              ...
              <input type="hidden" name="partner_id" id="shipment" value="{{$shipment->shipping_partner}}" required>
        ...
        @endif
    @else
        <div class="alert alert-warning">@lang('shipping::lang.assign_partner_first')</div>
    @endif
