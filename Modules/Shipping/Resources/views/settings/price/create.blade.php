<div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
        ...
        {!! Form::open([
            ...
            'url' => action('\Modules\Shipping\Http\Controllers\PriceController@store'),
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang('shipping::lang.prices')</h4>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::select('shipping_package', $shipping_packages, null, ['class' => 'form-control select2', 'required', 'placeholder' =>
                ...
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::select('fixed_price', [__('shipping::lang.per_kg'),__('shipping::lang.fixed_price')], null, ['class' => 'form-control select2 add_per_kg', 'required', 'placeholder' =>
                ...
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::text('per_kg', null, [

                        'class' => 'form-control',

                        'placeholder' => __('shipping::lang.price_only'),
