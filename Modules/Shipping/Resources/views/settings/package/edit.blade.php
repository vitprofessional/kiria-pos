<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action('\Modules\Shipping\Http\Controllers\PackageController@update', $type->id),
            'method' => 'put',
            'id' => 'types_add_form',
        ]) !!}
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::text('package_name', $type->package_name, [
                        'class' => 'form-control',
                ...
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::text('package_details', $type->package_details, [
                        'class' => 'form-control',
                        'placeholder' => __('shipping::lang.package_details'),
                        'id' => 'add_package_details',
                    ]) !!}
                </div>
