...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\Shipping\Http\Controllers\DriverController@store'), 'method' =>
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="form-group col-sm-12 employee_select" hidden>
          {!! Form::label('employee_select', __( 'shipping::lang.driver_name' ) .":") !!}
        ...
        @if($enable_hrm)
            ...
            <div class="form-group col-sm-12 driver_name">
              {!! Form::label('driver_name', __( 'shipping::lang.driver_name' ) . ':*') !!}
              {!! Form::text('driver_name', null, ['class' => 'form-control', 'placeholder' => __( 'shipping::lang.driver_name'), 'id'
              => 'add_driver_name']); !!}
            </div>
        @else
            <div class="form-group col-sm-12">
        ...
        @if($enable_hrm)
            <div class="form-group col-sm-12">
              ...
              {!! Form::text('nic_number', null, ['class' => 'form-control', 'placeholder' => __( 'shipping::lang.nic_number'), 'id'
              => 'driver_nic_number']); !!}
            </div>
        @else
            <div class="form-group col-sm-12">
        ...
        <div class="form-group col-sm-12">
          ...
          {!! Form::text('dl_number', null, ['class' => 'form-control', 'placeholder' => __( 'shipping::lang.dl_number'), 'id'
          => 'dl_number']); !!}
        </div> 
      </div>
...
<script>
  ...
  $('#hrm_enabled').change(function() {
    if ($(this).is(':checked')) {
        ...
        $('#driver_nic_number').prop('readonly', true);
        $('#driver_employee_no').prop('readonly', true);
        $('#add_driver_name').val("").prop('readonly', true);
        
    } else {
       $('#driver_nic_number').prop('readonly', false);
       $('#driver_employee_no').prop('readonly', false);
       $('#add_driver_name').val("").prop('readonly', false);
