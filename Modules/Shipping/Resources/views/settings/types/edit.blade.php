<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action('\Modules\Shipping\Http\Controllers\TypeController@update', $type->id),
            'method' => 'put',
            'id' => 'types_add_form',
        ]) !!}
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang('shipping::lang.shipping_types')</h4>
        </div>
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::text('shipping_types', $type->shipping_types, [
                        'class' => 'form-control',
                        'placeholder' => __('shipping::lang.shipping_types'),
                        'id' => 'add_shipping_types',
                    ]) !!}
                </div>
            </div>
