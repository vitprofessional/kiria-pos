    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="form-group col-sm-12">
          ...
          {!! Form::text('prefix', $starting_invoice_number->prefix, ['class' => 'form-control', 'placeholder' => __( 'shipping::lang.prefix'), 'id'
          => 'prefix']); !!}
        </div>
        <div class="form-group col-sm-12">
          {!! Form::label('starting_number', __( 'shipping::lang.starting_number' ) . ':*') !!}
          {!! Form::text('starting_number', $starting_invoice_number->starting_number, ['class' => 'form-control', 'placeholder' => __( 'shipping::lang.starting_number'), 'id'
          => 'starting_number']); !!}
        </div>
