...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\Shipping\Http\Controllers\PartnerController@store'), 'method' =>
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="form-group col-sm-12">
          ...
          {!! Form::number('opening_balance', null, ['class' => 'form-control', 'placeholder' => __( 'shipping::lang.opening_balance'), 'id'
          => 'add_opening_balance']); !!}
        </div>
      </div>
