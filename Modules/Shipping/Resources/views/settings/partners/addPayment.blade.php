...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\Shipping\Http\Controllers\PartnerController@postPayment', $agent->id), 'method' =>
    'post']) !!}

    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
          aria-hidden="true">&times;</span></button>
      <h4 class="modal-title">@lang( 'shipping::lang.shipping_partner' )</h4> 
    </div>
    ...
    <div class="modal-body">
        ...
        <div class="clearfix"></div>
        @include('shipping::settings.partners.partials.payment_type_details')
        <div class="col-md-12">
          <div class="form-group">
