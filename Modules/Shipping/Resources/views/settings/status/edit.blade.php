<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action('\Modules\Shipping\Http\Controllers\StatusController@update', $type->id),
            'method' => 'put',
            'id' => 'types_add_form',
        ]) !!}
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang('shipping::lang.shipping_status')</h4>
        </div>
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::text('shipping_status', $type->shipping_status, [
                        'class' => 'form-control',
                        'placeholder' => __('shipping::lang.shipping_status'),
                        'id' => 'add_shipping_status',
                    ]) !!}
                </div>
