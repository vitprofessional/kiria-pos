...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="col-md-3">
        <div class="form-group">
          {!! Form::label('helper_employee_no', __( 'shipping::lang.employee_no' )) !!}
          {!! Form::select('helper_employee_no', $helper_employee_nos, null, ['class' => 'form-control select2',
          'required',
          'placeholder' => __(
          'shipping::lang.please_select' ), 'id' => 'helper_employee_no']);
          !!}
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
          ...
          'required',
          'placeholder' => __(
          'shipping::lang.please_select' ), 'id' => 'helper_name']);
          !!}
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
          {!! Form::label('helper_nic_number', __( 'shipping::lang.nic_number' )) !!}
          {!! Form::select('helper_nic_number', $helper_nic_numbers, null, ['class' => 'form-control select2',
          'required',
          'placeholder' => __(
          'shipping::lang.please_select' ), 'id' => 'helper_nic_number']);
          !!}
        </div>
      </div>
      @endcomponent
  ...
  @component('components.widget', ['class' => 'box-primary', 'title' => __('shipping::lang.all_your_helpers')])
  @slot('tool')
  <div class="box-tools ">
    <button type="button" class="btn  btn-primary btn-modal pull-right"
      data-href="{{action('\Modules\Shipping\Http\Controllers\CollectionOfficerController@create')}}" data-container=".view_modal">
    ...
    <table class="table table-bordered table-striped" id="helper_table" style="width: 100%;">
      <thead>
        <tr>
          ...
          <th>@lang('shipping::lang.helper_name')</th>
