...
class AddShipmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shipping::add_shipment.index')->with(
            compact(
                'payment_types',
                'shipping_types',
                'shipping_status',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach($request->new_package_name as $key => $pkg_name){
                $package_data = array('shipment_id' => $shipment->id,'package_name' => $pkg_name,'package_description' => $request->new_package_description[$key],
