<div class="modal-dialog modal-lg" role="document" >
  <div class="modal-content">
    ...
    {!! Form::open(['url' =>
    action('\Modules\Subscription\Http\Controllers\SubscriptionListController@store'), 'method' =>
      ...
      <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {!! Form::select('contact_id',$customers,null, ['class' => 'form-control select2', 'required', 'placeholder' => __(
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {!! Form::select('subscription_cycle',$cycles,null, ['class' => 'form-control select2 subscription_cycle', 'required', 'placeholder' => __(
              'subscription::lang.select_one' ), 'required']); !!}
            </div>
          </div>
          ...
          <div class="clearfix"></div>
           ...
           <div class="col-md-12">
            <div class="form-group">
              ...
              {!! Form::select('product_id[]',[],null, ['class' => 'form-control select2 product_id', 'required','multiple', 'required']); !!}
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              {!! Form::text('subscription_amount',null, ['class' => 'form-control subscription_amount', 'required','readonly', 'placeholder' => __(
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              {!! Form::date('expiry_date',null, ['class' => 'form-control expiry_date', 'required','readonly', 'placeholder' => __(
           ...
           <div class="col-md-3">
            <div class="form-group">
              ...
              {!! Form::select('send_sms',[1 => __('lang_v1.yes'),0 => __('lang_v1.no')],null, ['class' => 'form-control select2', 'required', 'placeholder' => __(
              'subscription::lang.select_one' ), 'required']); !!}
            </div>
           </div>
