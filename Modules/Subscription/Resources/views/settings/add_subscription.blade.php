...
<script>
    ...
    $(document).ready(function(){
        ...
        $(document).submit('#save_subscription_form', function(event) {
            // Prevent the default form submission
            event.preventDefault();

            // Serialize the form data
            var formData = $('#save_subscription_form').serialize();
            
            var url = $('#save_subscription_form').attr('action');
           
            // Send an AJAX request
            $.ajax({
                url: $('#save_subscription_form').attr('action'),
                method: $('#save_subscription_form').attr('method'),
                data: formData,
                success: function(response) {
                    ...
                    $("#new_amount").val("");
                    subscription_prices_table.ajax.reload();
