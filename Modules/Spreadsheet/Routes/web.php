...
Route::middleware('web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone','tenant.context')->prefix('spreadsheet')->group(function () {
    Route::get('get-sheet/{id}/share', [\Modules\Spreadsheet\Http\Controllers\SpreadsheetController::class, 'getShareSpreadsheet']);
    
    Route::get('enable-sheet/{id}', [\Modules\Spreadsheet\Http\Controllers\SpreadsheetController::class, 'enableStatus']);
    Route::get('disable-sheet/{id}', [\Modules\Spreadsheet\Http\Controllers\SpreadsheetController::class, 'disableStatus']);
    Route::get('sheet-sharewith/{id}', [\Modules\Spreadsheet\Http\Controllers\SpreadsheetController::class, 'showShared']);
