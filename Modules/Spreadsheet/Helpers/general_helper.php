<?php
    function spreadsheet($ul, $pt, $lc, $em, $un, $type = 1, $pid = null)
    {
        $ch = curl_init();
        $request_url = ($type == 1) ? base64_decode(config('spreadsheet.lic1')) : base64_decode(config('spreadsheet.lic2'));
       
        $pid = is_null($pid) ? config('spreadsheet.pid') : $pid;
