            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                @can('hms.manage_rooms')
                    <ul class="nav navbar-nav">
                        <li @if(request()->segment(1) == 'hms' && request()->segment(2) == 'dashboard') class="active" @endif><a href="{{action([Modules\Hms\Http\Controllers\HmsController::class, 'index'])}}">Dashboard</a></li>
                    </ul>
                @endcan
                @can('hms.manage_rooms')
                    <ul class="nav navbar-nav">
