                   ...
                   <div class="row">
                    <div class="col-md-3 text-red" style="margin-top: 1px;">
                         Form No: <span id="form-number">{{ $form_f16a['form_no'] }}</span>
                           <span id="form-index" style="display:none;">{{ $form_f16a['transaction_id'] }}</span>
...
$('#f16_print').click(function(e){
    e.preventDefault();
    console.log("printing");
 e.preventDefault();
      
    var formId = $('#form-number').text();
      var formIndex = $('#form-index').text();
    $.ajax({
        url: '/mpcs/print-form-f16',
        data: { formId: formId },
        success: function(data) {
            var content = data;
                ...
                window.print();
                window.close();
                window.location.href = "{{URL::to('/')}}/mpcs/view-form-16/" + formIndex;
