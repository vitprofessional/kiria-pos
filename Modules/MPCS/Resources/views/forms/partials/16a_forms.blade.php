                ...
                @endif
                   ...
                   <div class="row">
                    <div class="col-md-3 text-red" style="margin-top: 1px;">
                           @if (!empty($form_f16a))
                            @if (!empty($edit) )
                            <span id="form-id">{{ $form_f16a['id']}}</span>
                            @endif
                        ...
                        @else
                              Form No: <span id="form-number">{{ $F16a_from_no }}</span>
                              ...
                              @if (!empty($form_f16a))
                                 @if (!empty($edit) )
                                  <div class="col-md-3 pull-right mb-12">
                                     ...
                                     <button type="submit" name="submit_type" id="f16_update" value="Update" class="btn btn-primary pull-right"
                                    style="margin-left: 20px">@lang('mpcs::lang.update')</button>
                                </div>
                                @else
                                   <button type="submit" name="submit_type" id="f16_print" value="print" class="btn btn-primary pull-right"
                    style="margin-left: 20px">@lang('mpcs::lang.print')</button>
                                 @endif 
                        
                  
                        @else
                               <div class="col-md-3 pull-right mb-12">
                    <button type="submit" name="submit_type" id="f16_save" value="save" class="btn btn-primary pull-right"
                     ...
                     <tfoot class="bg-gray">
                                ...
                                <tr>
                                    ...
                                    <td class="text-red text-bold" id="pre_F16A_total_purchase_price">
                                     ...
                                     <td id="pre_F16A_total_sale_price_decimal"></td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-red text-bold" id="grand_F16A_total_purchase_price">  
                                        @if (!empty($form_f16a))
                                        <span>{{ $form_f16a['grand_total']}}</span>
                                        @endif
                                    </td>
                                    <td id="grand_total_decimal"></td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                            ...
                            @if (!empty($form_f16a))
                                   ...
                                   <input type="hidden" name="this_form_grand" id="this_form_grand" value="">
                                    <input type="hidden" name="this_form_prevs" id="this_form_prevs" value="">
                                   <input type="hidden" name="this_form_grands" id="this_form_grands" value="">      
