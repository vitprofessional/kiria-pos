        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3" id="location_filter">
                <div class="form-group">
                    {!! Form::label('16a_location_id', __('purchase.supplier') . ':') !!}
                    {!! Form::select('16a_location_id', $suppliers, null, ['class' => 'form-control select2',
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    'form-control', 'id' => 'form_16a_date_range_list', 'readonly']); !!}
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('type', __('mpcs::lang.F16a_from_no') . ':') !!}
                       {!! Form::select('F16a_from_no', $all_form_no, null, ['class' => 'form-control select2',
                    'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
                </div>
            </div>
                <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('type', __('mpcs::lang.invoice_no') . ':') !!}
                    {!! Form::select('F16a_from_no', $invoiceno, null, ['class' => 'form-control select2',
                    'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
            ...
            <div class="col-md-12">
                ...
                <div class="row" style="margin-top: 20px;">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="form_16a_table_list" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('mpcs::lang.total_purchase_price_with_vat')</th>
                            ...
                            <tfoot class="bg-gray">
                                <tr>
                                    ...
                                    <td class="text-red text-bold" id="footer_F16A_total_purchase_price_list"></td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-red text-bold" id="pre_F16A_total_purchase_price_list">0.00</td>
                                    <td>&nbsp;</td>
                                    <td class="text-red text-bold" colspan="3" id="pre_F16A_total_sale_price_list">0.00</td>
                                </tr>
                                <tr>
                                    <td class="text-red text-bold" colspan="5">@lang('mpcs::lang.grand_total')</td>
                                    <td class="text-red text-bold" id="grand_F16A_total_purchase_price_list"></td>
                                    <td>&nbsp;</td>
                                    <td class="text-red text-bold" colspan="3" id="grand_F16A_total_sale_price_list"></td>
                                </tr>
                                <input type="hidden" name="total_this_p" id="total_this_p_list" value="0">
                                <input type="hidden" name="total_this_s" id="total_this_s_list" value="0">
                            </tfoot>
                        </table>
                    </div>
                </div>
