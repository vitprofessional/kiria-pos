    ...
    <div id="patient_register" style="border-radius: 5px;">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('s_r_address', __('business.address') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('s_r_district_id', __('business.district')) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('s_r_gender', __('business.gender') . ':') !!}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('self_email', __('business.email') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('self_username', __('business.username') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-user-o"></i>
                            </span>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('self_password', __('business.password') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-key"></i>
                            </span>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('self_confirm_password', __('business.confirm_password') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-key"></i>,
                            </span>
