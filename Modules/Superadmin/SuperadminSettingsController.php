...
class SuperadminSettingsController extends BaseController
{
    ...
    public function edit()
    {
     ...
     public function editAd(Request $request, $id)
     {
         ...
         if ($ad_detail == null) {
             ...
             return view('superadmin::superadmin_settings.edit-ad', compact('ad_detail', 'settings', 'ad_pages', 'ad_page_slots'));
         }
     }
    ...
    public function saveAd(Request $request)
    {
        ...
        //$content = $this->saveFile($uploadedFile, $imageCode,$adPageSlot->width,$adPageSlot->height);
    ...
    private function saveFile($uploadedFile, $code, $maxWidth, $maxHeight){        
