                        ...
                        <div class="box box-widget widget-user-2">
                            ...
                            <div class="widget-user-header ">
                              ...
                              @if ($business->is_patient)
                                ...
                                <h5 class="widget-user-desc"><i class="fa fa-id-card" title="Owner"></i> {{ $patient_code->username}}</h5>
                              @endif
                              <h5 class="widget-user-desc"><i class="fa fa-envelope" title="Owner Email"></i> {{ $business->owner->email}}</h5>
                                ...
                                @php $numbers = $address ? array_filter([$address->mobile, $address->alternate_number]) : [];@endphp
                                <h5 class="widget-user-desc"><i class="fa fa-phone" title="Business Contact"></i> {{ implode(", ", $numbers) }}</h5>
                            ...
                            <h5 class="widget-user-desc">
                                ...
                                <h5 class="widget-user-desc">
                                    <i class="fa fa-shield"></i> 
                                        @lang('business.opt'): @if($business->owner->setting && $business->owner->setting->opt_verification_enabled) @lang('business.enable') @else  @lang('business.disable') @endif
                                </h5>
                                <h5 class="widget-user-desc">
                                    <i class="fa fa-hand-paper-o"></i> 
                                        @lang('business.reCAPTCHA'): @if($business->owner->setting && $business->owner->setting->re_captcha_enabled) @lang('business.enable') @else  @lang('business.disable') @endif
                                </h5>
                            </div>
