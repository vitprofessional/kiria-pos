...
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      {!! Form::open(['url' => action('\Modules\Superadmin\Http\Controllers\RefillBusinessController@store'), 'method' => 'post', 'id' => 'sms_packages_form' ]) !!}
      ...
      <div class="modal-body">
          <div class="row">
              ...
              <div class="form-group col-md-4">
                  ...
                  {!! Form::text('type', null, ['class' => 'form-control', 'readonly','placeholder' => __( 'superadmin::lang.business_type' ), 'id' => 'add_business_type' ]); !!}
              </div>
              ...
              <div class="form-group col-md-4">
                  ...
                  {!! Form::date('expiry_date', date('Y-m-d'), ['class' => 'form-control', 'placeholder' => __( 'lang_v1.date' ) ]); !!}
              </div>
              
              <div class="form-group col-md-4">
                {!! Form::label('payment_method', __('superadmin::lang.payment_method') . ':') !!}
                {!! Form::select('payment_method', $payment_methods, null, ['class' => 'form-control
                select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.please_select')]); !!}
              </div>
