...
@component('components.filters', ['title' => __('report.filters')])
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('history_business_id', __('superadmin::lang.business') . ':') !!}
                
                <select class="form-control select2"  id="history_business_id" style = 'width:100%'>
        ...
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('history_type', __('superadmin::lang.type') . ':') !!}
                {!! Form::select('history_type', $business_type, null, ['class' => 'form-control
                select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
            </div>
        </div>
