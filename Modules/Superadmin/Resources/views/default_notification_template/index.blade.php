...
<section class="content">
    {!! Form::open(['url' => action('\Modules\Superadmin\Http\Controllers\DefaultNotificationTemplateController@store'), 'method' => 'post' ]) !!}
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="customer_notifications">
                        @component('components.widget', ['class' => 'box-primary','title' => " "])
                            @if($type == 'sms')
                                @include('superadmin::default_notification_template.partials.sms', ['templates' => $customer_notifications])
                            @else
                                @include('superadmin::default_notification_template.partials.email', ['templates' => $customer_notifications])
                            @endif
                        @endcomponent
                    </div>
                    ...
                    <div class="tab-pane" id="supplier_notifications">
                        @component('components.widget', ['class' => 'box-primary','title' => " "])
                            @if($type == 'sms')
                                @include('superadmin::default_notification_template.partials.sms', ['templates' => $supplier_notifications])
                            @else
                                @include('superadmin::default_notification_template.partials.email', ['templates' => $supplier_notifications])
                            @endif
                        @endcomponent
                    </div>
                    ...
                    <div class="tab-pane" id="company_staff_notifications">
                        @component('components.widget', ['class' => 'box-primary','title' => " "])
                            @if($type == 'sms')
                                    @include('superadmin::default_notification_template.partials.sms', ['templates' => $general_notifications])
                            @else
                                @include('superadmin::default_notification_template.partials.email', ['templates' => $general_notifications])
                            @endif
                        @endcomponent
                    </div>
