...
<section class="content-header">
            ...
            <div class="settlement_tabs">
                <ul class="nav nav-tabs">
                    <li class="@if(empty(session('status.tab'))) active @endif" style="margin-left: 20px;">
                     ...
                     <li class="@if(session('status.tab') == 'list_agent') active @endif">
                        <a style="font-size:13px;" href="#list_agent" data-toggle="tab">
                            <i class="fa fa-user"></i>
                            <strong>@lang('superadmin::lang.list_agents')</strong>
                        </a>
                    </li>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane @if(session('status.tab') == 'list_agent') active @endif"
            id="list_agent">
            @include('superadmin::agents.index_tab')
        </div>
