<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\Superadmin\Http\Controllers\SuperadminSettingsController@storeProductCategory'), 'method' => 'post', 'id' => 'category_add_form' ]) !!}
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        {!! Form::text('short_code', $expcode, ['class' => 'form-control', 'placeholder' => __( 'category.code' )]); !!}
