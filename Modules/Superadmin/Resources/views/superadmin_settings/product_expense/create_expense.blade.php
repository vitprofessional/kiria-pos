<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\Superadmin\Http\Controllers\SuperadminSettingsController@storeExpenseCategory'), 'method' => 'post', 'id' =>
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        {!! Form::text('code', $expcode, ['class' => 'form-control', 'placeholder' => __( 'expense.category_code' )]); !!}
      </div>
      @if($account_access)
      <div class="form-group">
