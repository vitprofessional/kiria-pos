<div class="modal-dialog" role="document" style="width: 55%">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('\Modules\Superadmin\Http\Controllers\MapBusinessTankController@update',[$data->id]), 'method'
        => 'put', 'id' => 'map_business_tank_edit_form' ]) !!}
        ...
        <div class="modal-body">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    {!! Form::select('business_id', $businesses,$data->business_id, ['class' => 'form-control select2', 'required', 'placeholder'
                    => __(
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" id="add_sheet_name" name="sheet_id" required>
                        ...
                        @foreach($sheet_names as $sheet_name)
                            <option value="{{$sheet_name->id}}" @if($data->sheet_id == $sheet_name->id) selected @endif data-capacity="{{$sheet_name->tank_capacity}}"  data-manufacturer="{{$sheet_name->tank_manufacturer}}">{{$sheet_name->sheet_name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
