    ...
    <div class="row">
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    'form-control select2','placeholder' => __('business.currency_placeholder')]); !!}
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-4">
         ...
         <div class="col-xs-4">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('enable_landing_page', 1, !empty($settings["enable_landing_page"]) ?
                        (int)$settings["enable_landing_page"] : 0 ,
                        [ 'class' => 'input-icheck']); !!} {{ __( 'superadmin::lang.enable_landing_page' ) }}
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-4">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('enable_repair_btn_login_page', 1,
                        !empty($settings["enable_repair_btn_login_page"]) ? (int)$settings["enable_repair_btn_login_page"] :
                        0 ,
                        [ 'class' => 'input-icheck']); !!} {{ __( 'superadmin::lang.enable_repair_btn_login_page' ) }}
                    </label>
                </div>
            </div>
        </div>
