            ...
            <div class="col-sm-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="@if(session('status.account_numbers')) active @endif">
                            <a href="#account_numbers" data-toggle="tab">
                                <i class="fa fa-list"></i> <strong>
                                @lang('account.account_numbers') </strong>
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content">
                                    ...
                                    <table class="table table-striped table-bordered" id="account_groups_table"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>@lang('account.show_status')</th>
                                                <th>@lang( 'messages.action' )</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                        ...
                        <div class="tab-pane @if(session('status.account_numbers')) active @endif" id="account_numbers">
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-primary btn-modal pull-right" id="add_acount_group_btn"
                                        data-href="{{action('\Modules\Superadmin\Http\Controllers\AccountNumbersController@create')}}"
                                        data-container=".default_account_group_model">
                                        <i class="fa fa-plus"></i> @lang( 'messages.add' )</button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table table-striped table-bordered" id="account_numbers_table"
                                        style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>@lang( 'lang_v1.prefix' )</th>
                                                <th>@lang( 'lang_v1.account_type_name' )</th>
