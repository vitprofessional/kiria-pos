                ...
                <div class="row">
                    ...
                    @foreach($permissions as $module => $module_permissions)
                        @foreach($module_permissions as $permission)
                            ...
                            @endphp
                            @if($permission['name'] != "installment_module" && $permission['name'] != "repair_module")
                            <div class="col-sm-3">
                                <div class="checkbox">
                    ...
                    <!-- Added Checkbox Auto Services Repair -->
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label class="search_label">
                                {!! Form::checkbox('auto_services_and_repair_module', 1, $packages->auto_services_and_repair_module, ['class' =>
                                'input-icheck']); !!}
                                {{__('lang_v1.auto_services_and_repair_module')}}
                            </label>
                        </div>
                    </div>
                    
                    <!-- Added Patients Module -->
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label class="search_label">
                                {!! Form::checkbox('patient_module', 1, $packages->patient_module, ['class' =>
                                'input-icheck']); !!}
                                {{__('lang_v1.patient_module')}}
                            </label>
                        </div>
                    </div>
                    
                    <!-- Added Patient Test Records Module -->
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label class="search_label">
                                {!! Form::checkbox('patient_test_module', 1, $packages->patient_test_module, ['class' =>
                                'input-icheck']); !!}
                                {{__('lang_v1.patient_test_module')}}
                            </label>
                        </div>
                    </div>
                    
                     <!-- Added Installment Module -->
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label class="search_label">
                                {!! Form::checkbox('installment_module', 1, $packages->installment_module, ['class' =>
                                'input-icheck']); !!}
                                Installment Module
                            </label>
                        </div>
                    ...
                    <!-- Added Checkbox Stock taking -->
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label class="search_label">
                                {!! Form::checkbox('stock_taking_module', 1, $packages->stock_taking_module, ['class' =>
                                'input-icheck']); !!}
                                {{__('lang_v1.stock_taking_module')}}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label class="search_label">
                                {!! Form::checkbox('restore_module', 1, $packages->restore_module, ['class' =>
                                'input-icheck']); !!}
                                Restore Backups
                            </label>
                        </div>
                    ...
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label class="search_label">
                                ...
                                $packages->service_staff, ['class' => 'input-icheck']); !!}
                                {{__('superadmin::lang.service_staff')}}
                            </label>
                        </div>
                    </div>
                    {{--
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('all_petro_module', 1, false, ['class' => 'check_all input-icheck', 'id'=>'all_petro_module']); !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('delete_settlement', 1, $packages->delete_settlement, ['class' => 'input-icheck','id'=>'delete_settlement']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('fuel_tanks_edit', 1, $packages->fuel_tanks_edit, ['class' => 'input-icheck', 'id'=>'fuel_tanks_edit']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('fuel_tanks_delete', 1, $packages->fuel_tanks_delete, ['class' => 'input-icheck', 'id'=>'fuel_tanks_delete']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('pumps_edit', 1, $packages->pumps_edit, ['class' => 'input-icheck', 'id'=>'pump_edit']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('pumps_delete', 1, $packages->pumps_delete, ['class' => 'input-icheck', 'id'=>'pump_delete']); !!}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('petro_quota_module', 1, $packages->petro_quota_module, ['class' => 'input-icheck', 'id'=>'petro_quota_module']); !!}
                                        {{__('vehicle.enable_petro_quota')}}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('all_report_module', 1, false, ['class' => 'check_all input-icheck','id'=>'all_report_module']); !!}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('all_contact_module', 1, false, ['class' => 'check_all input-icheck', 'id'=>'all_contact_module']); !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('stock_taking_page', 1, $packages->stock_taking_page, ['class' => 'input-icheck', 'id'=>'stock_taking_page']); !!}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('all_sale_module', 1, false, ['class' => 'check_all input-icheck','id'=>'all_sale_module']); !!}
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label" class="flex-label">
                                        {!! Form::checkbox('all_sales', 1, $packages->all_sales, ['class' => 'check_all input-icheck','id'=>'all_sales']); !!}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('leave_request', 1, $packages->leave_request, ['class' => 'input-icheck', 'id'=>'leave_request']); !!}
                                        {{__('superadmin::lang.leave_request')}}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('attendance', 1, $packages->attendance, ['class' => 'input-icheck','id'=>'attendance']); !!}
                                        {{__('superadmin::lang.attendance')}}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('hr_settings', 1, $packages->hr_settings, ['class' => 'input-icheck','id'=>'hr_settings']); !!}
                                        {{__('superadmin::lang.hr_settings')}}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('holidays', 1, $packages->holidays, ['class' => 'input-icheck','id'=>'holidays']); !!}
                                        {{__('superadmin::lang.holidays')}}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('leave_type', 1, $packages->leave_type, ['class' => 'input-icheck','id'=>'leave_type']); !!}
                                        {{__('superadmin::lang.leave_type')}}
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('payroll', 1, $packages->payroll, ['class' =>
                                        'input-icheck', 'id' => 'payroll']); !!}
                                        {{__('superadmin::lang.payroll')}}
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('allowance_deduction', 1, $packages->allowance_deduction, ['class' =>
                                        'input-icheck', 'id' => 'allowance_deduction']); !!}
                    ...
                    <div class="col-md-12">
                        <div class="row">
                           <div class="col-sm-3 ">
                                <div class="checkbox">
                                    <label class="search_label">
                                        {!! Form::checkbox('essentials_module', 1, $packages->essentials_module, ['class' => 'input-icheck', 'id' =>
                                        'essentials_module']); !!}
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('essentials_todo', 1, $packages->essentials_todo, ['class' => 'input-icheck', 'id'=>'essentials_todo']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('essentials_document', 1, $packages->essentials_document, ['class' => 'input-icheck','id'=>'essentials_document']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('essentials_memos', 1, $packages->essentials_memos, ['class' => 'input-icheck','id'=>'essentials_memos']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('essentials_reminders', 1, $packages->essentials_reminders, ['class' => 'input-icheck','id'=>'essentials_reminders']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('essentials_messages', 1, $packages->essentials_messages, ['class' => 'input-icheck','id'=>'essentials_messages']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('essentials_settings', 1, $packages->essentials_settings, ['class' =>
                                        'input-icheck', 'id' => 'essentials_settings']); !!}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            {!! Form::label('disk_size', __('Disk Size (MB)')) !!}
                            {!! Form::number('max_disk_size', $packages->max_disk_size, ['class' => 'form-control',
                            'required', 'placeholder' => 'Please insert in MB']);
                            !!}
                        </div>
                    </div>
                </div>
...
@section('javascript')
    ...
    <script>
        ...
        $('#all_petro_module').on('ifChecked', function (event) {
            ...
            $('#delete_settlement').iCheck('check');

            $('#dip_management').iCheck('check');
            $('#pump_delete').iCheck('check');
            $('#pump_edit').iCheck('check');
            $('#fuel_tank_delete').iCheck('check');
            $('#fuel_tank_edit').iCheck('check');
        })
        $('#all_petro_module').on('ifUnchecked', function (event) {
            ...
            $('#delete_settlement').iCheck('uncheck');
        ...
        $('#all_contact_module').on('ifChecked', function (event) {
            ...
            $('#stock_taking_page').iCheck('check');
        })
