    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                ...
                {{-- Add Auto Repair & Services Chechbox --}}
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label class="search_label">
                                {!! Form::checkbox('auto_services_and_repair_module', 1, false, ['class' => 'input-icheck']); !!}
                    ...
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label class="search_label">
                                {!! Form::checkbox('patient_module', 1, false, ['class' =>
                                'input-icheck']); !!}
                    ...
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label class="search_label">
                                {!! Form::checkbox('patient_test_module', 1, false, ['class' =>
                                'input-icheck']); !!}
                    ...
                    {{-- Installment Module Chechbox --}}
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label class="search_label">
                                {!! Form::checkbox('installment_module', 1, false, ['class' => 'input-icheck']); !!}
                                Installment Module
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label class="search_label">
                                {!! Form::checkbox('stock_taking_module', 1, false, ['class' =>
                                'input-icheck']); !!}
                    ...
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label class="search_label">
                                {!! Form::checkbox('restore_module', 1, false, ['class' => 'input-icheck']); !!}
                                Restore Backups
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('delete_settlement', 1, false, ['class' => 'input-icheck', 'id'=>'delete_settlement']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('fuel_tank_edit', 1, false, ['class' => 'input-icheck', 'id'=>'fuel_tank_edit']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('fuel_tank_delete', 1, false, ['class' => 'input-icheck', 'id'=>'fuel_tank_delete']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('pump_edit', 1, false, ['class' => 'input-icheck', 'id'=>'pump_edit']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('pump_delete', 1, false, ['class' => 'input-icheck', 'id'=>'pump_delete']); !!}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label search_label">
                                        {!! Form::checkbox('petro_quota_module', 1,  ['class' => 'input-icheck', 'id'=>'petro_quota_module']); !!}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label" class="flex-label">
                                        {!! Form::checkbox('all_sale', 1, false, ['class' => 'check_all input-icheck', 'id'=>'all_sale']); !!}
                    ...
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label class="search_label">
                                {!! Form::checkbox('service_staff', 1, false, ['class' => 'input-icheck']); !!}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {!! Form::number('max_disk_size', null, ['class' => 'form-control',
...
@section('javascript')
    ...
    <script>
        ...
        $('#all_petro_module').on('ifUnchecked', function (event) {
            ...
            $('#pump_delete').iCheck('uncheck');
            $('#pump_edit').iCheck('uncheck');
            $('#fuel_tank_delete').iCheck('uncheck');
            $('#fuel_tank_edit').iCheck('uncheck');
        })
