...
<li
	...
	<ul class="treeview-menu">
		...
		<li class="{{ $request->segment(1) == 'petro-quota-setting' ? 'active' : '' }}">
			<a href="{{action('\Modules\Petro\Http\Controllers\VehicleController@petro_qouta_setting')}}">
				<i class="fa fa-download"></i><span>@lang('vehicle.petro_qouta_setting')</span></a>
		</li>
</ul>
</li>
@endcan