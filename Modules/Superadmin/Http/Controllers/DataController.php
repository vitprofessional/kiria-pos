...
class DataController extends Controller
{
    ...
    private function removeTags($string, $business)
    {
        ...
        if ($user) {
            ...
            $string = str_replace('{first_name}, {last_name}', '', $string);
        }

        $string = str_replace('{system_url}', $url, $string);
        $string = str_replace('{system_email}', System::getPropertie('email'), $string);
