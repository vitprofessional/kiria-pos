    ...
    public function index()
    {
        ...
        if(!empty(request()->patient_code)){
            ...
            if(empty($patinet)){
                $output = [
                    'success' => 0,
                    'msg' => __("myhealth::patient.no_patient_found")
                ];
            ...
            return view('myhealth::hospital.index')->with(compact('date_filters', 'patient_code', 'patient_business_id', 'patient_details', 'blood_group', 'age', 'marital_status', 'gender'));
        }
        return view('myhealth::hospital.index');
    }
