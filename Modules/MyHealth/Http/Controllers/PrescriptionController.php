...
use App\Business;
use App\User;
use Modules\MyHealth\Entities\PatientAllergie;
        ...
        try {
            ...
            if ($request->hasfile('prescription_file')) {
                ...
                $validate = Validator::make(
                    $request->all(),
                    [
                        'prescription_file' => "mimes:jpeg,png,bmp|max:{$maxFileLimit}",
                    ],
                    [
                        'prescription_file.mimes' => 'Only jpeg, png, bmp are allowed.',
                        'prescription_file.max' => 'You have reached your maximum file upload limit.'
                    ]
                );
