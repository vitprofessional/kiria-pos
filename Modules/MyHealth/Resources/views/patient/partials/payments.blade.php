...
<section class="content">
    @component('components.widget', ['class' => 'box-primary', 'title' => __( 'myhealth::patient.all_your_payments' )])
    <div class="row">
			...
			<div class="btn-group pull-right" data-toggle="buttons">
				<label class="btn btn-info active">
  				...
  				<label class="btn btn-info">
    				...
    				> {{ __('myhealth::patient.this_year') }}
  				</label>
  				<label class="btn btn-info">
    				<input type="radio" name="date-filter" 
    				data-start="" 
    				data-end="" 
    				> {{ __('myhealth::patient.total') }}
  				</label>
            </div>
		</div>
    </div>
                ...
                <table class="table table-bordered table-striped" id="payments_table" style="width:100%;">
                    <thead>
                        <tr>
                            ...
                            <th>@lang( 'myhealth::patient.institution_name' )</th>
