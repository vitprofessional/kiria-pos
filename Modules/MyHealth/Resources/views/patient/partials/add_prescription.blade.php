...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      @include('myhealth::patient.partials.add_prescription_form')
      @endcomponent
    ...
    <div class="modal-dialog" role="document" style="width: 70%;">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <h3 class="form-header">@lang('myhealth::patient.hospital_register')</h3>
    ...
    <div class="modal-dialog" role="document" style="width: 70%;">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <h3 class="form-header">@lang('myhealth::patient.doctor_register')</h3>
          {!! Form::open(['url' => action('\Modules\MyHealth\Http\Controllers\DoctorController@store'), 'method' => 'post', 'id' =>
          'doctor_register_form','files' => true ]) !!}
          @include('myhealth::patient.partials.register_form_doctor')
    ...
    <div class="modal-dialog" role="document" style="width: 70%;">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <h3 class="form-header">@lang('myhealth::patient.allergy_register')</h3>
          {!! Form::open(['url' => action('\Modules\MyHealth\Http\Controllers\AllergiesController@store'), 'method' => 'post', 'id' =>
          'allergies_register_form','files' => true ]) !!}
          @include('myhealth::patient.partials.register_form_allergies')
    ...
    <div class="modal-dialog" role="document" style="width: 70%;">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <h3 class="form-header">@lang('myhealth::patient.allergy_register')</h3>
          {!! Form::open(['url' => action('\Modules\MyHealth\Http\Controllers\MedicineController@store'), 'method' => 'post', 'id' =>
          'medicine_register_form','files' => true ]) !!}
          @include('myhealth::patient.partials.register_form_medicine')
    ...
    <div class="modal-dialog" role="document" style="width: 70%;">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <h3 class="form-header">@lang('myhealth::patient.allergy_register')</h3>
          {!! Form::open(['url' => action('\Modules\MyHealth\Http\Controllers\TestController@store'), 'method' => 'post', 'id' =>
          'test_register_form','files' => true ]) !!}
          @include('myhealth::patient.partials.register_form_test')
...
$('#hospital_name').change(function () {
  $.ajax({
        url: "{{action('\Modules\MyHealth\Http\Controllers\DoctorController@getDocorts')}}",
        type: 'POST',
