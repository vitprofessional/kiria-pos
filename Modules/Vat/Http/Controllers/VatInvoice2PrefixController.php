...

{
                ...
                $fuel_tanks = Datatables::of($query)
                    ->addColumn(
                        ...
                        function ($row) {
                            ...
                            $html .= '<li><a href="#" data-href="'.action([\Modules\Vat\Http\Controllers\VatInvoice2PrefixController::class, 'edit'], [$row->id]).'" class="btn-modal" data-container=".fuel_tank_modal"><i class="glyphicon glyphicon-edit"></i> '.__('messages.edit').'</a></li>';
                            $html .= '<li><a href="#" data-href="'.action([\Modules\Vat\Http\Controllers\VatInvoice2PrefixController::class, 'destroy'], [$row->id]).'" class="delete_task" ><i class="fa fa-trash"></i> '.__('messages.delete').'</a></li>';
...

    {
        ...
        return view('vat::vat_invoice2_prefixes.create')->with(compact('business_id'));
     ...
     public function edit($id)
    {
        ...
        return view('vat::vat_invoice2_prefixes.edit')->with(compact('data'));
    }
