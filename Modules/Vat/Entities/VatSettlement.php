...
class VatSettlement extends Model
{
    ...
    {
        return $this->hasMany('\Modules\Vat\Entities\VatMeterSale', 'settlement_no', 'id');
    }
    /**
     * Get the meter_sales that belongs to the settlement.
     */
    ...
    {
        return $this->hasMany('\Modules\Vat\Entities\VatOtherSale', 'settlement_no', 'id');
    }
    ...
    {
        return $this->hasMany('\Modules\Vat\Entities\VatSettlementCardPayment', 'settlement_no', 'id');
    }
    /**
    ...
    {
        return $this->hasMany('\Modules\Vat\Entities\VatSettlementCashPayment', 'settlement_no', 'id');
    }
    
    
    public function credit_sale_payments()
    {
        return $this->hasMany('\Modules\Vat\Entities\VatSettlementCreditSalePayment', 'settlement_no', 'id');
    }
    /**
