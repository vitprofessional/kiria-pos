...
class VatMeterSale extends Model
{
    protected $fillable = [];
    ...
    */
    ...
    {
        return $this->belongsTo('\Modules\Vat\Entities\VatSettlement', 'settlement_no', 'id');
    }
    ...
    */
    ...
    {
        return $this->belongsTo('\Modules\Vat\Entities\VatProduct');
    }
