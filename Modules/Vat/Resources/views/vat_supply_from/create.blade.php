<div class="modal-dialog" role="document" style="width: 50%;">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('\Modules\Vat\Http\Controllers\VatSupplyFromController@store'), 'method' => 'post', 'id' =>
        'transfer_add_form' ]) !!}
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('supply_from', null , ['class' => 'form-control', 'required', 'placeholder' => __(
