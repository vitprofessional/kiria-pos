@extends('layouts.app')
@section('title', __('vat::lang.list_vat_sales'))
        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <ul class="breadcrumbs pull-left" style="margin-top: 15px">
                    ...
                    <li><span>@lang( 'vat::lang.list_vat_sales')</span></li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content main-content-inner">
    ...
    <div class="box-tools pull-right ">
            <a class="btn  btn-primary" href="{{action('\Modules\Vat\Http\Controllers\VatSettlementController@create')}}">
...
<script type="text/javascript">
    ...
    list_settlement = $('#list_settlement').DataTable({
        ...
        aaSorting: [[0, 'desc']],
        ajax: {
            url: '{{action('\Modules\Vat\Http\Controllers\VatSettlementController@index')}}',
            data: function(d) {
        ...
        fnDrawCallback: function(oSettings) {
            ...
            $("#list_settlement").append('<tr class="bg-gray font-17 footer-total text-center"><td>Total</td><td></td><td></td><td></td><td></td><td></td><td>'+total_amount+'</td></tr>');
        },
    });
