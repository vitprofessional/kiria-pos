<div class="modal-dialog" role="document" style="width: 50%;">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('\Modules\Vat\Http\Controllers\VatBankDetailController@update',[$data->id]), 'method' => 'put', 'id' =>
        'transfer_add_form' ]) !!}
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('bank_name', $data->bank_name , ['class' => 'form-control', 'required', 'placeholder' => __(
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('bank_branch', $data->bank_branch, ['class' => 'form-control', 'required', 'placeholder' => __(
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('account_number', $data->account_number, ['class' => 'form-control', 'required', 'placeholder' => __(
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('account_name', $data->account_name, ['class' => 'form-control', 'required', 'placeholder' => __(
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('special_instructions', $data->special_instructions, ['class' => 'form-control', 'required', 'placeholder' => __(
