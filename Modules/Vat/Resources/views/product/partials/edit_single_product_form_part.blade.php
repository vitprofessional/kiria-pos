            ...
            @if($loop->first)
                <tr>
                    ...
                    <td>
                      ...
                      <div class="col-sm-6">
                          <label><span class="dsp_inc_label">@lang('product.inc_of_tax')</span></label>
                        {!! Form::text('single_dsp_inc_tax', @num_format($variation->sell_price_inc_tax), ['class' => 'form-control input-sm input_number', 'placeholder' => __('product.inc_of_tax'), 'id' => 'single_dsp_inc_tax', 'required']); !!}
                      </div>
