        ...
        @component('components.widget')
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-12 add_room">
                    ...
                    <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm add-room btn btn-primary pull-right all-p-btn" style="margin-top: 1px;"> @lang('messages.add') @lang('hms::lang.a_room')</button>
                </div>
            </div>
            <div class="col-md-6">
                <div class="col-md-12">
                ...
                @foreach ($amenities as $amenity)
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('amenities[]', $amenity->id, null, ['class' => 'input-icheck']) !!} {{ $amenity->name }}
                            </label>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="col-md-12 text-center" style="margin-top: 10px;">
                ...
                <button type="submit" name="submit_action" value="save_and_pricing"
                        class="tw-dw-btn tw-text-white btn submit_form"
                        style="background-color: #ff7400;  color: white; border-radius: 4px; cursor: pointer; margin-right: 10px;">
                    @lang('hms::lang.save_and_add_price')
                </button>
                <button type="submit" name="submit_action" value="save"
                    class="btn btn-primary tw-text-white submit_form" style="background-color: #008000; color: white;">@lang('messages.save')</button>
            </div>
