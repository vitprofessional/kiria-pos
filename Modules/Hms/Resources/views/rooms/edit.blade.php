            ...
            <div class="box-body">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-12 add_room">
                        ...
                        <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm add-room"> @lang('messages.add') @lang('hms::lang.rooms')</button>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <button type="submit" name="submit_action" value="save_and_pricing" class="tw-dw-btn tw-dw-btn-info tw-text-white tw-dw-btn-lg submit_form">@lang('hms::lang.update_and_add_price')</button>
                        <button type="submit" name="submit_action" value="save" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-lg submit_form">@lang('messages.update')</button>                    </div>
