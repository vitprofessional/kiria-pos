...
@section('content')
    ...
    <!-- Main content -->
    <!--Style style btn btn-primary pull-right all-p-btn //tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right btn-modal-unavailable-->
    <section class="content">
        @component('components.widget')
            <div class="box-tools tw-flex tw-justify-end tw-gap-2.5 tw-mb-4">
                <a class="Style style btn btn-primary pull-right all-p-bt"
