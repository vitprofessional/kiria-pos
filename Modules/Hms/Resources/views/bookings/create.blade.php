    ...
    <section class="content">
        ...
        <div class="col-md-12 text-center">
            <button type="submit" name="submit_action" value="save" id="submit_action"
                class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-lg " style="padding: 8px; background-color: #0000FF; color: white; border-radius: 4px; border: none; cursor: pointer; font-weight: bold;">@lang('messages.save')</button>
        </div>
        {!! Form::close() !!}
        {{-- model  --}}
