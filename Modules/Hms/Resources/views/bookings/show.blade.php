       ...
       <div class="col-md-8">
        <div class="box box-solid">
            <div class="box-header">
                ...
                <a class="tw-dw-btn tw-dw-btn-warning tw-text-white tw-dw-btn-sm pull-right" href="{{ action([\Modules\Hms\Http\Controllers\HmsBookingController::class, 'print'], [$transaction->id]) }}" target="_blank">
