        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($extra)
                ...
                ->addColumn('action', function ($row) {
                    $html = '<a type="button" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-primary btn-modal-extra " href="' . action([\Modules\Hms\Http\Controllers\HmsCouponController::class, 'edit'], ['coupon' => $row->id]) . '">'
