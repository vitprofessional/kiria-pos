        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($types)
                ...
                ->addColumn('action', function ($row) {
                    $html = '<a type="button" class="btn btn-primary btn-modal btn-xs" href="' . action([\Modules\Hms\Http\Controllers\RoomController::class, 'edit'], ['room' => $row->id]) . '">
                ...
                if(auth()->user()->can( 'hms.manage_price')){
                    $html .= ' <a type="button" class="btn btn-info btn-xs" href="' . action([\Modules\Hms\Http\Controllers\RoomController::class, 'pricing']) . '?room_id='. $row->id .'">
