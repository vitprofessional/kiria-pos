...
Route::middleware(['web',  'SetSessionData', 'auth', 'language', 'timezone','tenant.context'])->prefix('installment')->group(function() {
    ...
    Route::get('/installments_for_home','InstallmentController@installments_for_home');
