...
class BakeryUserDocumentAndNoteController extends Controller
{
     /**
     * All Utils instance.
     *
                ...
                return Datatables::of($document_note)
                    ->addColumn('action', function ($row) use ($notable_type, $permissions) {
                        ...
                        if (in_array('view', $permissions)) {
                            $html .='<li>
                                        <a data-href="' . action('\Modules\Bakery\Http\Controllers\BakeryDocumentAndNoteController@show', ['id' => $row->id, 'notable_id' => $row->notable_id, 'notable_type' => $notable_type]) . '" class="cursor-pointer view_a_docs_note">
                                            <i class="fa fa-eye"></i>
                                            '.__("messages.view").'
                                        </a>
                                    </li>';
                        ...
                        if (in_array('create', $permissions)) {
                            $html .= '<li>
                                    <a data-href="' . action('\Modules\Bakery\Http\Controllers\BakeryDocumentAndNoteController@edit', ['id' => $row->id, 'notable_id' => $row->notable_id, 'notable_type' => $notable_type]) . '"  class="cursor-pointer docs_and_notes_btn">
                        ...
                        if (in_array('delete', $permissions)) {
                            $html .= '<li>
                                    <a data-href="' . action('\Modules\Bakery\Http\Controllers\BakeryDocumentAndNoteController@destroy', ['id' => $row->id, 'notable_id' => $row->notable_id, 'notable_type' => $notable_type]) . '"  id="delete_docus_note" class="cursor-pointer">
                    ...
                    ->editColumn(
                        ...
                        function ($row) use ($notable_type) {
                            ...
                            $html = '<a data-href="' . action('\Modules\Bakery\Http\Controllers\BakeryDocumentAndNoteController@show', ['id' => $row->id, 'notable_id' => $row->notable_id, 'notable_type' => $notable_type]) . '" class="cursor-pointer view_a_docs_note text-black">
                                '.
                                    $row->heading .
                                    '&nbsp;'.
                                    $is_private.
    ...
    public function create()
    {
        ...
        //model name like App\User
        $notable_type = request()->get('notable_type');
        return view('bakery::documents_and_notes.create')
    ...
    public function show($id)
    {
        ...
        return view('bakery::documents_and_notes.show')
    ...
    public function edit($id)
    {
        ...
        return view('bakery::documents_and_notes.edit')
    ...
    public function getDocAndNoteIndexPage(Request $request)
    {
        if (request()->ajax()) {
            ...
            return view('bakery::documents_and_notes.index')
