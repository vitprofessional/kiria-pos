<div class="modal-dialog" role="document" style="width: 50%;">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('\Modules\Bakery\Http\Controllers\BakeryUserController@store'), 'method' =>
        'post',
        'id' =>
        'add_pumps_form' ]) !!}
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang( 'petro::lang.add_user' )</h4>
        </div>
