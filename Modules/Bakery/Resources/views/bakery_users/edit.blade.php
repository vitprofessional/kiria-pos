<div class="modal-dialog" role="document" style="width: 50%;">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('\Modules\Bakery\Http\Controllers\BakeryUserController@update', $pump_operator->id), 'method' =>
        'put',
        'id' =>
        'add_pumps_form' ]) !!}
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang( 'petro::lang.edit_user' )</h4>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::date('transaction_date', !empty($transaction) ? date('Y-m-d',strtotime($transaction->transaction_date)) : null, ['class' => 'form-control transaction_date', 'required',
                            'placeholder' => __(
