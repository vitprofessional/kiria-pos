...
<script>
  ...
  $('#payments_form').submit(function(event) {
    ...
    $("#payment_total_price").text(__number_f(total));
    calculate_balance_due()
    
    $("#payment_methods_data").val(JSON.stringify(formDataArray));
    
    $('#payment_table').append(row);
    $('div.invoice_payment_modal').modal('hide');
