@extends('layouts.app')
@section('title', __('airline::lang.arilines_agents_sidebar'))
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
        ...
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('mobile', __( 'airline::lang.mobile' )) !!}
                {!! Form::select('mobile', $mobile, null, ['class' => 'form-control select2',
                'required',
                'placeholder' => __(
                'airline::lang.please_select' ), 'id' => 'mobile']);
                !!}
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('name', __( 'airline::lang.name' )) !!}
                {!! Form::select('name', $name, null, ['class' => 'form-control select2',
                'required',
                'placeholder' => __(
                'airline::lang.please_select' ), 'id' => 'name']);
                !!}
            </div>
        </div>
  ...
  @component('components.widget', ['class' => 'box-primary', 'title' => __('airline::lang.agents')])
  @slot('tool')
  <div class="box-tools ">
    <button type="button" class="btn  btn-primary btn-modal pull-right"
      data-href="{{action('\Modules\Airline\Http\Controllers\AirlineAgentController@create')}}"
    ...
    <table class="table table-bordered table-striped" id="agent_table" style="width: 100%;">
      <thead>
        <tr>
          ...
          {{-- <th>@lang('airline::lang.added_date')</th> --}}
          <th>@lang('airline::lang.name')</th>
          <th>@lang('airline::lang.current_due')</th>
          <th>@lang('airline::lang.address')</th>
          <th>@lang('airline::lang.mobile_1')</th>
          <th>@lang('airline::lang.mobile_2')</th>
          <th>@lang('airline::lang.land_no')</th>
          <th>@lang('airline::lang.created_by')</th>
        </tr>
      </thead>
    </table>
  </div>
    ...
    //driver tab script
        ...
        $(document).ready(function() {
            ...
            agent_table = $('#agent_table').DataTable({
                ...
                ajax: {
                    url: '{{ action('\Modules\Airline\Http\Controllers\AirlineAgentController@index') }}',
                    data: function(d) {
                        d.name = $('#name').val();
