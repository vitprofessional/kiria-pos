        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('current_meter_location_id', __('petro::lang.location') . ':') !!}
                    {!! Form::select('current_meter_location_id', $business_locations, null, ['class' => 'form-control
                    select2', 'placeholder'
                    => __('petro::lang.all'), 'id' => 'current_meter_location_id', 'style' => 'width:100%']); !!}
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('current_meter_pump_no', __('petro::lang.pumps') . ':') !!}
