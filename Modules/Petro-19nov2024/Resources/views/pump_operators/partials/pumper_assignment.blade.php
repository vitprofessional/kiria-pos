                    ...
                    <div class="col-md-8">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('starting_meter', !empty($pump->pod_last_meter) ? ($pump->pod_last_meter >= $pump->last_meter_reading ?  number_format($pump->pod_last_meter,3,".","") : number_format($pump->last_meter_reading,3,".","")) :  number_format($pump->last_meter_reading,3,".",""), ['class' =>
