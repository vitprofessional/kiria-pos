...
<div class="row">
    <div class="col-md-12" style="margin-top: 20px;">
        ...
        <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-8" style="font-weight: bold; text-align: left;">
                    @lang('petro::lang.shift_number') :
                </div>
                <div class="col-md-4" style="font-weight: bold; text-align: right;">
                    <span class="shift_number">000000</span>
                </div>
            </div>
            <br>
        </div>
...
<div class="row">
    ...
    <br>
    <div class="col-md-12">
    <button type="button" id="add_payment" data-container="add_payment" data-href="{{action('\Modules\Petro\Http\Controllers\AddPaymentController@create', [ 'settlement_no' => $add_payment_settlement_no])}}" class="btn btn-primary btn-modal pull-right">@lang('petro::lang.payment_to_finalize')</button>
    </div>
</div>