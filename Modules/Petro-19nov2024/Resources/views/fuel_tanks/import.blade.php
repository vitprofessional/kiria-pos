@extends('layouts.app')
@section('title', __('petro::lang.import_tanks'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>@lang('petro::lang.import_tanks')
    </h1>
</section>
...
<section class="content">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            {!! Form::open(['url' => action('\Modules\Petro\Http\Controllers\FuelTankController@saveImport'), 'method' =>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <a href="{{ asset('files/import_fuel_tanks.xls') }}" class="btn btn-success"
