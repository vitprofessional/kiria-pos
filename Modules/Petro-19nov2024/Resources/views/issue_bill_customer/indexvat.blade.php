...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            'petro::lang.all_issue_bill_customer_VAT')])
            @can('issue_customer_bill.add')
            @slot('tool')
            <div class="box-tools">
                <button type="button" class="btn btn-primary btn-modal pull-right" id="add_issue_bill_customer_btn"
                    data-href="{{action('\Modules\Petro\Http\Controllers\IssueCustomerBillWithVATController@create')}}"
                    ...
                    <table class="table table-striped table-bordered" id="issue_bill_customer_table" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th>@lang( 'petro::lang.new_outstanding' )</th>
                                <th>@lang( 'petro::lang.limit_balance' )</th>
...
<script>
    // issue_bill_customer_table
        issue_bill_customer_table = $('#issue_bill_customer_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{action('\Modules\Petro\Http\Controllers\IssueCustomerBillWithVATController@index')}}",
            },
            ...
            columns: [
                ...
                {data: 'new_outstanding_amount', name: 'new_outstanding_amount'},
