...
class IssueCustomerBillController extends Controller
{
    ...
    public function getProductPrice($id)
    {
        ...
        if (!empty($price)) {
            ...
            $cat = Category::findOrFail($price->category_id);
            
            $sub_cat_vat = null;
            if(!empty($price->sub_category_id)){
                $sub_cat = Category::findOrFail($price->sub_category_id);
            ...
            //         $multiplier= $price->dpp_inc_tax;
            //     }else{
            //         $multiplier= $price->default_sell_price;
            //     }
                
            // }else{
                // if($cat->vat_based_on == 'profit'){
                //     $multiplier= $price->dpp_inc_tax;
                // }else{
                    $multiplier= $price->default_sell_price;
                // }
            ...
            return array('unit_price' => $this->productUtil->num_f($price->sell_price_inc_tax),'unit_price_excl' => $this->productUtil->num_f($multiplier));
        } else {
            return  array( 'unit_price' => '0','unit_price_excl' => 0);
        }
    }
