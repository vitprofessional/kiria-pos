    ...
    public function getIngredientDetails($recipe, $business_id, $location_id = null)
    {
        ...
        foreach ($ingredient_variations as $ingredient_variation) {
            ...
            $ingredients[] = [
                ...
                'lot_no' => !$variation->product->getLotNumbers ? 0 : (int)$variation->product->getLotNumbers->lot_no,
                'lot_prefix' => !$variation->product->getLotNumbers ? '-' : $variation->product->getLotNumbers->lot_prefix,
