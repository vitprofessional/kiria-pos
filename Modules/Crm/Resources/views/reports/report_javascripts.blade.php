<script type="text/javascript">
 ...
 $('#follow_up_user_date_range1').daterangepicker(
                dateRangeSettings,
                function (start, end) {
                    $('#follow_up_user_date_range1').val(start.format(moment_date_format) + ' - ' + end.format(moment_date_format));
                    //pass parameter in ajax call
                    follow_ups_by_contact_table.ajax.reload();
                }
            );
            $('#follow_up_user_date_rang1e').on('cancel.daterangepicker', function(ev, picker) {
                $('#follow_up_user_date_range1').val('');
                //pass parameter in ajax call
                follow_ups_by_contact_table.ajax.reload();
            });
