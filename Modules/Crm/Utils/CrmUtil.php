...
class CrmUtil extends Util
{
    ...
    public function getLeadsListQuery($business_id)
    {
        $leads = CrmContact::with(['Source', 'lifeStage', 'leadUsers'])
                ...
                'mobile', 'tax_number', 'contacts.created_at',  'alternate_number', 'landline', 'contact_status',
                'type',
                'contacts.id', 'contacts.business_id', 'crm_source', 'crm_life_stage', 'address', 'city', 'state', 'country',
