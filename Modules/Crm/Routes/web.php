...
Route::middleware('web', 'authh', 'SetSessionData', 'auth', 'language', 'timezone', 'ContactSidebarMenu', 'CheckContactLogin', 'tenant.context')->prefix('contact')->group(function () {
...
Route::middleware('web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone', 'tenant.context')->prefix('crm-module')->group(function () {
    ...
    Route::get('dashboard', [Modules\Crm\Http\Controllers\CrmDashboardController::class, 'index'])->name('crm.crm_dashboard.index');
