               ...
               <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                                ...
                                {!! Form::date('transaction_date', \Carbon\Carbon::parse($list->transaction_date)->format('Y-m-d'), ['class' => 'form-control transaction_date', 'required', 'placeholder' => __('salesdiscounts::lang.transaction_date')]) !!}
                            </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                           ...
                           {!! Form::select('customer', $customers, $list->contact_id, ['class' => 'form-control select2','readonly',  'style' => 'width:100%']) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('location', $business_locations, $list->business_id, ['class' => 'form-control select2',
                            'style' => 'width:100%']); !!}
                      ...
                      <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('invoice_no', $list->invoice_no, ['class' => 'form-control',
                            'required'])
                            !!}
                        </div>
                    </div>   
                   ...
                   <div class="col-md-4">
                    ...
                    'style' => 'width:100%', 'id' => 'discount_type','readonly', 'placeholder' => __('salesdiscounts::lang.all')]); !!}
