    ...
    @component('components.widget', ['class' => 'box-solid', 'title' => __('repair::lang.repair_module_settings')])
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('module_info[repair][repair_status_label]', $default['repair_status_label'], [
                    'class' => 'form-control',
                    'placeholder' => __('repair::lang.repair_status_label'),
                ]) !!}
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('module_info[repair][repair_warranty_label]', $default['repair_warranty_label'], [
                    'class' => 'form-control',
                    'placeholder' => __('repair::lang.repair_warranty_label'),
                ]) !!}
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('module_info[repair][brand_label]', $default['brand_label'], [
                    'class' => 'form-control',
                    'placeholder' => __('repair::lang.brand_label'),
                ]) !!}
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('module_info[repair][device_label]', $default['device_label'], [
                    'class' => 'form-control',
                    'placeholder' => __('repair::lang.device_label'),
                ]) !!}
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('module_info[repair][model_no_label]', $default['model_no_label'], [
                    'class' => 'form-control',
                    'placeholder' => __('repair::lang.model_no_label'),
                ]) !!}
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('module_info[repair][serial_no_label]', $default['serial_no_label'], [
                    'class' => 'form-control',
                    'placeholder' => __('repair::lang.serial_no_label'),
                ]) !!}
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('module_info[repair][defects_label]', $default['defects_label'], [
                    'class' => 'form-control',
                    'placeholder' => __('repair::lang.defects_label'),
                ]) !!}
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('module_info[repair][repair_checklist_label]', $default['repair_checklist_label'], [
                    'class' => 'form-control',
                    'placeholder' => __('repair::lang.repair_checklist_label'),
                ]) !!}
            </div>
        </div>
    @endcomponent
