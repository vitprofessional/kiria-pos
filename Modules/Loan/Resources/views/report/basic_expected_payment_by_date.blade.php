@extends('layouts.app')
@section('title')
    {{ trans_choice('loan::general.basic_expected_payment_by_date', 1) }} {{ trans_choice('core.report', 1) }}
@endsection
                            ...
                            <table class="table table-striped table-condensed table-hover datatable">
                                <thead>
                                    <tr class="bg-cyan">
                                        ...
                                        <th>
                                            <span>{{ trans_choice('loan::general.due', 1) }}
                                ...
                                <tbody>
                                    @if (!empty($data))
                                        @foreach ($data as $key)
                                            @foreach ($key->unpaid_repayment_schedules as $schedule)
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('user/' . $key->loan_officer_id . '/show') }}">
                                                            <span>{{ $key->loan_officer->user_full_name }}</span> <i
                                                    ...
                                                    <td>
                                                        <span>{{ $key->contact->contact_id }}</span>
                                                    </td>
                                                    ...
                                                    <td style="text-align: right">
                                                        {{ number_format($schedule->total_principal, 2) }}
                                                    </td>
                                                    ...
                                                    {{-- Fees --}}
                                                    <td style="text-align: right">
                                                        {{ number_format($schedule->total_penalties, 2) }}
                                                    </td>

                                                    {{-- Penalties --}}
                                                    <td style="text-align: right">
                                                        {{ number_format($schedule->total_fees, 2) }}
                                                    </td>
                                                    ...
                                                    {{-- Total Overdue --}}
                                                    <td style="text-align: right">
                                                        {{ number_format($schedule->total_overdue, 2) }}
                                                    </td>
