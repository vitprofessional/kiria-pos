@extends('layouts.app')
@section('title')
    {{ trans_choice('loan::general.aging_summary_in_months', 1) }} {{ trans_choice('core.report', 1) }}
@endsection
                ...
                @slot('slot')
                    ...
                    <div class="table-responsive">
                        <table id="data-table" class="table table-striped table-condensed table-hover">
                            ...
                            <tbody>
                                @if (!empty($monthly_bands))
                                    @foreach ($monthly_bands as $monthly_band)
                                        @php
                                            $loans_for_branch = $data->where('arrears_days_band', $monthly_band);
                                            ...
                                            $monthly_band_label = trans('core.' . $monthly_band);
                                        @endphp
                                        {{-- Location --}}
                                        <tr>
                                            <td>
