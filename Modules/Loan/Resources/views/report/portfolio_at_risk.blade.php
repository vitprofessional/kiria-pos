@extends('layouts.app')
@section('title')
    {{ trans_choice('loan::general.portfolio_at_risk', 1) }} {{ trans_choice('core.report', 1) }}
@endsection
                        ...
                        <thead>
                            <tr class="bg-cyan">
                                ...
                                <th style="text-align: right">
                                    ...
                                    @show_tooltip(__('loan::lang.tooltip_portfolio_at_risk_calculation').' '.__('core.as_a_percentage'))
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            @if (!empty($data))
                                @foreach ($data as $key)
                                    <tr>
                                        ...
                                        {{-- Portfolio at Risk % --}}
                                        <td style="text-align: right">
                                            {{ number_format($key->portfolio_at_risk_percentage, 2) }}%
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
