...
@section('title')
    ...
    {{ trans_choice('loan::general.aging', 1) }}
    {{ trans_choice('core.detail', 1) }}
                                ...
                                <thead>
                                    <tr class="bg-cyan">
                                        ...
                                        <th style="text-align: right">
                                            ...
                                            {{ trans_choice('core.in', 2) }}
                                            {{ trans_choice('core.arrears', 1) }}
                                        </th>

                                        <th style="text-align: right">
                                            {{ trans_choice('core.week', 2) }}
                                            {{ trans_choice('core.in', 2) }}
                                            {{ trans_choice('core.arrears', 1) }}
                                        </th>
