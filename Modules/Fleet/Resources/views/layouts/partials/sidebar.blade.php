<li class="treeview {{ in_array($request->segment(1), ['fleet-management']) ? 'active active-sub' : '' }}" id="tour_step5">
    ...
    <ul class="treeview-menu">
        ...
        <li class="{{ $request->segment(2) == 'fleet-profit-loss' ? 'active' : '' }}"><a
                href="{{action('\Modules\Fleet\Http\Controllers\RouteOperationController@fleet_profit_loss')}}"><i class="fa fa-taxi"></i>
                @lang('fleet::lang.fleet_profit_loss')</a>
        </li>
    </ul>
</li>