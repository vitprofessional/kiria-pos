    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="form-group col-sm-6">
          ...
          {!! Form::select('trip_category', $trip_categories, $route->trip_category, ['class' => 'form-control select2', 'placeholder' =>
          __('messages.please_select')]); !!}
        </div>
        
        <div class="form-group col-sm-6">
          {!! Form::label('delivered_to_acc', __( 'fleet::lang.delivered_to_acc_no' ) . ':*') !!}
          {!! Form::select('delivered_to_acc', $delivered_to, $route->delivered_to_acc, ['class' => 'form-control select2', 'placeholder' =>
          __('messages.please_select')]); !!}
        </div>
        ...
        <div class="form-group col-sm-6">
         ...
         <div class="form-group col-sm-6">
          ...
          {!! Form::text('actual_distance', @num_format($route->actual_distance), ['class' => 'form-control', 'placeholder' => __( 'fleet::lang.actual_distance'), 'id'
          => 'actual_distance']); !!}
        </div>
          ...
          <div class="d-flex justify-content-between py-2">
            ...
            <div class="row bg-success" style="padding: 10px">
              <div class="form-group col-sm-4">
                ...
                <div id="incentive_type_percentage" >
                  <div class="form-group col-sm-4">
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-striped" id="add_incentive_table" style="width: 100%;">
            ...
            <tbody>
              ...
              <td>{{@num_format($incentive->amount)}}<input type="hidden" value="{{$incentive->amount}}" name="fixed_amount[]"></td>
              
              <td>{{($incentive->percentage)?@num_format($incentive->percentage):'--'}}%<input type="hidden" value="{{$incentive->percentage}}" name="percentage[]"></td>
              ...
              <td>{{@num_format($incentive->percentage_amount)}}<input type="hidden" name="applicable_to[]" value="{{$incentive->applicable_to}}"><input type="hidden" value="{{$incentive->percentage_amount}}" name="company_decision[]"></td>
