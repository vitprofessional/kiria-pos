  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
        ...
        <div class="form-group col-sm-12">
          ...
          {!! Form::text('incentive_name', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'fleet::lang.incentive_name'), 'id'
          => 'incentive_name']); !!}
        </div>
        ...
        <div id="incentive_type_percentage" style="display:none">
          ...
          {!! Form::number('percentage', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'fleet::lang.percentage'), 'id'
        ...
        <div id="incentive_type_fixed" style="display:none">
          ...
          {!! Form::text('amount', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'fleet::lang.amount'), 'id'
            => 'amount']); !!}
          </div>
        </div>
