        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                @php
                     ...
                     $route_names = $route_names->prepend(__('fleet::lang.all'), '');
            ...
            <div class="form-group">
                {!! Form::label('orignal_locations', __( 'fleet::lang.orignal_location' )) !!}
                  ...
                  @php
                     ...
                     $route_names = $orignal_locations->prepend(__('fleet::lang.all'), '');
            ...
            <div class="form-group">
                {!! Form::label('destinations', __( 'fleet::lang.destination' )) !!}
                 @php
                     ...
                     $route_names = $destinations->prepend(__('fleet::lang.all'), '');
            ...
            <div class="form-group">
                {!! Form::label('users', __( 'fleet::lang.user_added' )) !!}
                 @php
                     ...
                     $route_names = $users->prepend(__('fleet::lang.all'), '');
