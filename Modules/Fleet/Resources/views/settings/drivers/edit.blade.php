    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-md-12">
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('hrm_enabled', '1', $driver->hrm_enabled == 1, [ 'class' => 'input-icheck', 'id' => 'hrm_enabled']) !!}
        ...
        <div class="form-group col-sm-12 employee_select" hidden>
          ...
          {!! Form::select('department', $departments, $driver->department, ['class' => 'form-control select2', 'placeholder' =>
        ...
        <div class="form-group col-sm-12">
           ...
           {!! Form::text('pass_no', $driver->pass_no, ['class' => 'form-control', 'placeholder' => __('fleet::lang.pass_no')]); !!}
      
        </div>
        
        <div class="form-group col-sm-12">
            {!! Form::label('pass_expiry_date', __( 'fleet::lang.pass_expiry_date' ) . ':') !!}
           {!! Form::date('pass_expiry_date', $driver->pass_expiry_date, ['class' => 'form-control', 'placeholder' => __('fleet::lang.pass_expiry_date')]); !!}
      
        </div>
        <div class="col-md-12">
            <div class="form-group">
              {!! Form::label('salary_expense_category', __( 'fleet::lang.salary_expense_category'
              )) !!} {!! Form::select('salary_expense_category', $expense_categories, $driver->salary_expense_category,
         ...
         <div class="col-md-12">
            <div class="form-group">
              ...
              )) !!} {!! Form::select('advance_expense_category', $expense_categories, $driver->advance_expense_category,
              ['class' => 'form-control select2', 'required','placeholder' => __(
         ...
         <div class="col-md-12">
            <div class="form-group">
              ...
              )) !!} {!! Form::select('bata_expense_category', $expense_categories, $driver->bata_expense_category,
              ['class' => 'form-control select2', 'required','placeholder' => __(
...
<script>
 ...
 $(document).ready(function() {
  ...
  var employee_no = @json($driver->employee_no);
  if ($('#hrm_enabled').is(':checked')) {
    debugger;
      ...
      $('#update_employee_no').val(employee_no);
  } else {
      ...
      if(is_hrm_enabled != 1){
        ...
        $('#update_employee_no').val("{{$new_employee_no}}");
      }
      $('#add_driver_name').val("");
  ...
  // department
  var department_id = @json($driver->department);
  var designation = @json($driver->designation);
  if(department_id){
      $.ajax({
      method: 'POST',
  ...
  //designation
  var helperData = [
    {!! (int) $driver->employee_no !!},
    @json($driver->nic_number),
