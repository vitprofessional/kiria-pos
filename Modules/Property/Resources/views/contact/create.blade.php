<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    @endphp
    {!! Form::open(['url' => action('\Modules\Property\Http\Controllers\ContactController@store'), 'method' => 'post', 'id' => $form_id,'enctype'=>"multipart/form-data",'files' => true ]) !!}
        ...
        <div class="col-md-4 ">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              __('lang_v1.contact_id'), 'id'=> 'contactId', 'readonly']); !!}
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 ">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text('nic_number', '', ['class' => 'form-control ', 'id' =>
              'nic_number']); !!}
            </div>
