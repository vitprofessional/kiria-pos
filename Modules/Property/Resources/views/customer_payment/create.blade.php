...
{!! Form::open(['url' => action('\Modules\Property\Http\Controllers\CustomerPaymentController@store'), 'method' =>
'post', 'id' => 'customer-payment-form',
'files' => true ]) !!}
    ...
    <div class="container">
          ...
          <div class="row">
            <div class="col-sm-3">
              <div class="form-group">
                ...
                {!! Form::text('contact_id', null, ['class' => 'form-control hide', 'placeholder' => __('property::lang.customer'), 'id' => 'contact_id']); !!}
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                {!! Form::select('property_id', $land_and_blocks, null, ['class' => 'form-control
                select2 property_id', 'placeholder' => __('messages.please_select'), 'required', 'id' =>
                'property_id']); !!}
                
                
                {!! Form::text('project_property_id', null, ['class' => 'form-control hide', 'placeholder' => __('property::lang.customer'), 'id' => 'project_property_id']); !!}
              </div>
            ...
            <div class="col-sm-2">
              <div class="form-group">
                {!! Form::label('installment_start_on', __('property::lang.installment_start_on')) !!}
                {!! Form::text('installment_start_on', null, ['class' => 'form-control
                installment_start_on', 'readonly', 'placeholder' => __('property::lang.installment_start_on'), 'id' =>
                'installment_start_on',]); !!}
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
                {!! Form::label('installment_ends_on', __('property::lang.installment_ends_on')) !!}
                {!! Form::text('installment_ends_on', null, ['class' => 'form-control
                installment_ends_on', 'readonly', 'placeholder' => __('property::lang.installment_ends_on'), 'id' =>
                'installment_ends_on']); !!}
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
                ...
                {!! Form::text('installment_amount', null, ['class' => 'form-control
                installment_amount', 'readonly', 'placeholder' => __('property::lang.installment_amount'), 'id' =>
                'installment_amount']); !!}
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-12 col-lg-12">
            ...
            <div class="col-md-10 payment_row">
     ...
     <!--       <p>This is left side</p>
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                {!! Form::label('final_total', __('property::lang.pay_amount').':*') !!}
              </div>
              <div class="col-md-3">
                {!! Form::text('final_total', null, ['class' => 'form-control', 'placeholder' => __('property::lang.pay_amount'), 'required', 'id' => 'final_total']); !!}
                
              </div>
              <br><br><br><br>
            </div>
            
            <!--down below code is the default code-->
            <!--<div class="row">
              <div class="col-md-2">
            ...
            <!--@lang('property::lang.payment_options') = On Account Of-->
          ...
          <div class="col-md-6">
                <div class="text-red text-left " style="margin-top: 25px; font-size: 23px; font-weight: bold">
            ...
            @include('property::customer_payment.partials.payment_type_details', ['payment_line' => $payment,
                'row_index' => 0 ])
            ...
            <br/>
             ...
             <div class="row">
              ...
              <br /><br />
              <button type="submit" class="btn btn-flat btn-lg btn-block" style="color: #fff; background-color:#2874A6;">@lang('property::lang.save')</button>
              <!--
       ...
       <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="text-red text-right pull-right" style="font-size: 23px; font-weight: bold">
                ...
                <div class="col-md-3 text-right" style="float: right; font-size: 23px; font-weight: bold">
                    ...
                    <!--<button name="submit" type="submit" class="btn btn-primary">@lang('property::lang.pay_now')</button>-->
     ...
     <!--this below section is used for "pop up in "Pay Amound"-->
   <!--  
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  cash', 'placeholder' => __('property::lang.amount'), 'id' =>
                  'cash']); !!}
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  cheuqe', 'placeholder' => __('property::lang.amount'), 'id' =>
                  'cheuqe']); !!}
                </div>
              </div>
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  card_no', 'placeholder' => __('property::lang.card_no'), 'id' =>
                  'card_no']); !!}
                </div>
              </div>
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  expiry_date', 'placeholder' => __('property::lang.expiry_date'), 'id' =>
                  'expiry_date']); !!}
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  cheque_no', 'placeholder' => __('property::lang.cheque_no'), 'id' =>
                  'cheque_no']); !!}
                </div>
              </div>
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  bank', 'placeholder' => __('property::lang.bank'), 'id' =>
                  'bank']); !!}
                </div>
              </div>
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  branch', 'placeholder' => __('property::lang.branch'), 'id' =>
                  'branch']); !!}
                </div>
              </div>
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  cheque_date', 'placeholder' => __('property::lang.cheque_date'), 'id' =>
                  'cheque_date']); !!}
                </div>
              </div>
            </div>
...
<script>
  function enterVal(val) {
   ...
   /*-----------------Code by Zeeshan Farooq (Start)-----------------------------*/

     $('#property_id').change(function(){
            let property_id = $(this).val();
            $.ajax({
                method: 'get',
                url: '/property/customer-payment/get-installment-details-by-property-id/'+property_id,
                data: {  },
                success: function(result) {
                    //console.log(result.data[0]);

                     $('#project_property_id').val(result.data[0].property_id);


                    if(result.success === 1){
                        if(result.data[0].first_installment_date != 'undefined')
                        {
                            $('#installment_start_on').val(result.data[0].first_installment_date);
                        }
                        else
                        {
                            $('#installment_start_on').text("Value Not Found")
                        }

                        $('#installment_amount').val(result.data[0].installment_amount);
                        var noOfInstallments = '0';
                        var installmentStartDate = '0';
                        var installmentType = '0';
                        var endDate = '';
                        var installmentStartDate = result.data[0].first_installment_date;
                        var noOfInstallments = result.data[0].no_of_installment;
                        var installmentType = result.data[0].name;
                        var inTermOfDays = '';



                        if(installmentType == 'Daily' || installmentType == 'daily' || installmentType == 'DAILY')
                        {
                               inTermOfDays = noOfInstallments*1;

                                // result should be '2019-04-23 20:20:00'
                                endDate = moment(installmentStartDate).add(inTermOfDays, 'days').format('YYYY-MM-DD');
                               $('#installment_ends_on').val(endDate);
                        }
                        if(installmentType == 'Weekly' || installmentType == 'weekly' || installmentType == 'WEEKLY')
                        {
                               inTermOfDays = noOfInstallments*7;
                        ...
                        if(installmentType == 'Monthly' || installmentType == 'monthly' || installmentType == 'MONTHLY')
                        {
                               inTermOfDays = noOfInstallments*30;
