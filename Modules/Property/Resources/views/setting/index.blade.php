            ...
            <div class="col-xs-12 pos-tab-container">
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                    <div class="list-group">
                        ...
                        @can('property.settings.sales_officer')
                        <a href="#"
                            class="list-group-item text-center @if(session('status.tab') == 'purchase-of-land-account') active @endif">@lang('Purchase of Land Account')</a>
                        @endcan
                        
                        <a href="#"
                            class="list-group-item text-center @if(session('status.tab') == 'starting_no') active @endif">Starting File</a>
                ...
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                    ...
                    @endcan
                    @can('property.settings.sales_officer')
                    @include('property::setting.purchase_land_account.index')
                    @endcan
                    @include('property::setting.starting_no.index')
    ...
    $(document).ready(function(){
        ...
        payment_option_table = $('#payment_option_table').DataTable({
            ...
            columns: [
                ...
                { data: 'payment_only', name: 'payment_only' },
        ...
        payment_option_table = $('#purchase_land_account_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{action('\Modules\Property\Http\Controllers\PurchaseLandAccountController@index')}}",
            },
            columns: [
                { data: 'date', name: 'date' },
                { data: 'location_name', name: 'business_locations.name' },
        ...
        starting_no_table = $('#starting_no_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{action('\Modules\Property\Http\Controllers\PropertyStartingNoController@index')}}",
            },
            columns: [
            ...
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        payment_option_table.ajax.reload();
                        purchase_land_account_table.ajax.reload();
                        installment_cycle_table.ajax.reload();
                        block_close_reason_table.ajax.reload();
                        sales_officer_table.ajax.reload();
                        starting_no_table.ajax.reload();
                    },
                });
            }
        });
