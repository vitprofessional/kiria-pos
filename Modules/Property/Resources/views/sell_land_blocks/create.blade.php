...
<section class="content no-print">
    ...
    <div class="border-top">
        <div class="col-md-12 payment_row">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3 text-right" style="float: right; font-size: 23px; font-weight: bold; display:none" id="pay_now_btn">
    ...
    <div class="modal fade contact_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
        @include('property::contact.create', ['quick_add' => true])
    </div>
...
<script>
    ...
    $('#date').datepicker('setDate', new Date());
        ...
        `
            ...
            var tel_amnt = $('#total_amount').val();
            //alert(tel_amnt);
            if(tel_amnt == total_amount)
                $('#pay_now_btn').css('display', 'block');
            else
                $('#pay_now_btn').css('display', 'none');
