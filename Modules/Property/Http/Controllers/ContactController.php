...
class ContactController extends Controller
{
    ...
    private function indexCustomer()
    {
        ...
        $contacts = Datatables::of($query)
            ...
            ->addColumn('nic_number', function ($row) {
                return  !empty($row->nic_number)?$row->nic_number:'';
            })
        ...
        //     ->make(true);
        return $contacts->rawColumns(['mass_delete', 'action', 'contact_id', 'name', 'nic_number', 'mobile', 'customer_group', 'due', 'created_at', 'image', 'signature'])
            ->make(true);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $input = $request->only([
                ...
                'name', 'nic_number', 'tax_number', 'pay_term_number', 'pay_term_type', 'mobile', 'landline', 'alternate_number', 'city', 'state', 'country', 'landmark', 'customer_group_id', 'supplier_group_id', 'contact_id', 'custom_field1', 'custom_field2', 'custom_field3', 'custom_field4', 'email'
            ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if (request()->ajax()) {
            try {
                $input = $request->only(['contact_id','nic_number', 'type', 'supplier_business_name', 'name', 'tax_number', 'pay_term_number', 'pay_term_type', 'mobile', 'landline', 'alternate_number', 'city', 'state', 'country', 'landmark', 'customer_group_id', 'supplier_group_id', 'custom_field1', 'custom_field2', 'custom_field3', 'custom_field4', 'email','image','signature']);
    ...
    public function getLedger()
    {
        ...
        /*dd(compact('ledger_details', 'contact', 'opening_balance', 'ledger_transactions', 'business_details', 'location_details'));*/
