...
class SaleAndCustomerPaymentController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $properties = Property::join('property_blocks', 'property_blocks.property_id', 'properties.id')->join('property_account_settings', 'properties.id', '=', 'property_account_settings.property_id')->where('status', 'open')->where('properties.business_id', $business_id)->notSold()->select('properties.*')->groupBy('properties.id')->get();
