<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\Distribution\Http\Controllers\DistributionAreasController@store'), 'method' =>
    'post', 'id' => !empty($quick_add) ? 'quick_add_route' : 'areas_add_form' ]) !!}
