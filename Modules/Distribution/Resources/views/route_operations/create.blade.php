...
<section class="content">
    {!! Form::open(['url' => action('\Modules\Distribution\Http\Controllers\RouteOperationController@store'), 'method' =>
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    'distribution::lang.order_number' ),
                    'id' => 'order_number']);
                    !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    'distribution::lang.order_date' ), 'readonly',
                    'id' => 'order_date']);
                    !!}
                </div>
            </div>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            ...
                            bg-white btn-flat btn-modal"
                                data-href="{{action('\Modules\Distribution\Http\Controllers\RouteController@create', ['quick_add' => true])}}"
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    'placeholder' => __('distribution::lang.please_select' ), 'id' => 'product_id']);
                    !!}
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    'distribution::lang.driver_incentive' ),
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    'distribution::lang.helper_incentive' ),
...
<script>
 ...
 $(document).on('submit', 'form#quick_add_route', function (e) {
    ...
    $.ajax({
      method: 'post',
      url: '{{action('\Modules\Distribution\Http\Controllers\RouteController@store')}}',
      dataType: 'json',
      data: data,
      success: function(result) {
        if(result.success){
            ...
            $.ajax({
                method: 'get',
                url: '{{action('\Modules\Distribution\Http\Controllers\RouteController@getRouteDropdown')}}',
                data: {  },
                contactType: 'html',
