...
@section('title', __('distribution::lang.fleet'))
...
<section class="content">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    'required',
                    'placeholder' => __(
                    'distribution::lang.please_select' ), 'id' => 'vehicle_number']);
                    !!}
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    'required',
                    'placeholder' => __(
                    'distribution::lang.please_select' ), 'id' => 'vehicle_type']);
                    !!}
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    'required',
                    'placeholder' => __(
                    'distribution::lang.please_select' ), 'id' => 'vehicle_brand']);
                    !!}
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    'required',
                    'placeholder' => __(
                    'distribution::lang.please_select' ), 'id' => 'vehicle_model']);
                    !!}
                </div>
            </div>
          </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            'distribution::lang.all_your_fleets')])
            @slot('tool')
            <div class="box-tools">
                <button type="button" class="btn btn-primary btn-modal pull-right" id="add_fleet_btn"
                    data-href="{{action('\Modules\Distribution\Http\Controllers\DistributionController@create')}}"
                    data-container=".fleet_model">
                    <i class="fa fa-plus"></i> @lang( 'distribution::lang.add' )</button>
            </div>
            @endslot
                        ...
                        <table class="table table-striped table-bordered" id="fleet_table" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang( 'distribution::lang.code_vehicle' )</th>
                                    <th>@lang( 'distribution::lang.vehicle_number' )</th>
                                    <th>@lang( 'distribution::lang.starting_meter' )</th>
                                    <th>@lang( 'distribution::lang.vehicle_type' )</th>
                                    <th>@lang( 'distribution::lang.income' )</th>
                                    <th>@lang( 'distribution::lang.payment_received' )</th>
                                    <th>@lang( 'distribution::lang.payment_due' )</th>
                                    <th>@lang( 'distribution::lang.opening_amount' )</th>
                                </tr>
                            </thead>
                            <tbody>
...
<script>
    ...
    $(document).ready(function(){
        ...
        fleet_table = $('#fleet_table').DataTable({
                ...
                serverSide: false,
                ajax: {
                    url : "{{action('\Modules\Distribution\Http\Controllers\DistributionController@index')}}",
                    data: function(d){
