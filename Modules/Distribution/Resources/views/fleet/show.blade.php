@extends('layouts.app')
@section('title', __('distribution::lang.view_fleet'))
...
<section class="content-header no-print">
    <h1>{{ __('distribution::lang.view_fleet') }}</h1>
</section>
                ...
                <ul class="nav nav-tabs nav-justified">
                    <li class="
                        ...
                        <a href="#info" data-toggle="tab" aria-expanded="true"><i class="fa fa-info-circle"
                                aria-hidden="true"></i> @lang( 'distribution::lang.info')</a>
                    </li>
                    <li class="
                    ...
                    <li class="
                        ...
                        <a href="#income_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-anchor"
                                aria-hidden="true"></i> @lang('distribution::lang.income')</a>
                    </li>
                    <li class="
                        ...
                        <a href="#expenses_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-anchor"
                                aria-hidden="true"></i> @lang('distribution::lang.expenses')</a>
                    </li>
                </ul>
                ...
                <div class="tab-content" style="background: #fbfcfc;">
                    <div class="tab-pane
                            ...
                            @else
                                ''
                            @endif" id="info">
                        @include('distribution::fleet.partials.info')
                    </div>
                    <div class="tab-pane
                                @if(!empty($view_type) &&  $view_type == 'ledger')
                                    active
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                @include('distribution::fleet.partials.ledger_tab')
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                @include('distribution::fleet.partials.income_tab')
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                @include('distribution::fleet.partials.expenses_tab')
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ledger_table = $('#ledger_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{action('\Modules\Distribution\Http\Controllers\DistributionController@getLedger', $fleet->id)}}",
                data: function (d) {
        ...
        income_table = $('#income_table').DataTable({
            ...
            aaSorting: [[0, 'desc']],
            ajax: {
                url: "{{action('\Modules\Distribution\Http\Controllers\IncomeController@index')}}",
                data: function (d) {
