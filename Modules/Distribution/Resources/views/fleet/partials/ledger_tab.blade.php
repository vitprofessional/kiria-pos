    ...
    <table class="table table-bordered table-striped" id="ledger_table" style="width: 100%;">
        <thead>
            <tr>
                ...
                <th>@lang('distribution::lang.description')</th>
                <th>@lang('distribution::lang.destination')</th>
                <th>@lang('distribution::lang.milage')</th>
                <th>@lang('distribution::lang.invoice_no')</th>
                <th>@lang('distribution::lang.invoice_amount')</th>
