 <a class="btn btn-sm btn-primary pull-right" data-href="{{action('\Modules\AutoRepairServices\Http\Controllers\DeviceModelController@create')}}" id="add_device_model">
