<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\AutoRepairServices\Http\Controllers\AutorepairBrandController@store'), 'method' => 'post', 'id' => $quick_add ? 'quick_add_brand_form' : 'autorepair_brand_add_form' ]) !!}
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        {!! Form::label('description', __( 'brand.short_description' ) . ':') !!}
         ...
         <div class="form-group">
             <label>
                {!!Form::checkbox('is_auto_repair', 1, true, ['class' => 'input-icheck','disabled' => true]) !!}
                Use for Auto Repair?
            </label>
