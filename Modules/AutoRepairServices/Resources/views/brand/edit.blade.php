<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\AutoRepairServices\Http\Controllers\AutorepairBrandController@update', [$brand->id]), 'method' => 'PUT', 'id' => 'autorepair_brand_edit_form' ]) !!}
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        {!! Form::label('description', __( 'brand.short_description' ) . ':') !!}
         ...
         <div class="form-group">
             <label>
                {!!Form::checkbox('is_auto_repair', 1, $brand->is_auto_repair, ['class' => 'input-icheck','disabled' => true]) !!}
                Use for Auto Repair?
            </label>
