	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			@component('components.widget')
			    ...
			    @endphp
				@include('autorepairservices::repair.partials.security_modal')
				@include('autorepairservices::repair.partials.checklist_modal')
			@endcomponent
...
@section('javascript')
	...
	@include('autorepairservices::layouts.partials.javascripts')
	<script type="text/javascript">
		$(document).ready( function() {
			// lock.setPattern('{{$transaction->repair_security_pattern}}');

			@include('autorepairservices::repair.partials.repair_status')
