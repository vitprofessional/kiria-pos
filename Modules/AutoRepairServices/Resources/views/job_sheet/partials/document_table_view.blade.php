		...
		@foreach($medias as $media)
			<tr class="media_row">
				...
				<td>
					...
					<a data-href="{{action('\Modules\AutoRepairServices\Http\Controllers\JobSheetController@deleteJobSheetImage', ['id' => $media->id])}}" class="btn btn-danger btn-sm delete_media">
