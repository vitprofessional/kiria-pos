...
<section class="content">
    ...
    @else
        ...
        @endphp
    @endif
    {!! Form::open(['url' => action('\Modules\AutoRepairServices\Http\Controllers\JobSheetController@update', ['job_sheet' => $job_sheet->id]), 'method' => 'put', 'id' => 'edit_job_sheet_form', 'files' => true]) !!}
                    ...
                    @endif
                     ...
                     <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('warranty_number', $job_sheet->warranty_number, ['class' => 'form-control', 'placeholder' => __('repair::lang.warranty_no')]); !!}
                        </div>
                    </div>
                    <!---------------- end 6029--------------------------->
                    <div class="col-md-12">
