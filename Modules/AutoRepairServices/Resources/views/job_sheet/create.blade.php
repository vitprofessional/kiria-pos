                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('contact_id',
                                    [], null, ['class' => 'form-control mousetrap', 'id' => 'customer_id', 'placeholder' => 'Select Customer', 'required', 'style' => 'width: 100%;']); !!}
        ...
        $(document).ready( function() {
            ...
            $("#vehicle_id").on('change', function() {
                    $.ajax({
                        ...
                        success: function(result) {
                            if (result.length > 0) {
                                // $("#customer_id").html(''); // Clear previous options
                                // $("#customer_id").append('<option value="">Select Customer</option>');
                                ...
                                // // Enable the dropdown since we have data
                                // $("#customer_id").prop('disabled', false).show();
                            } 
                        },
                        error: function() {
                            // If AJAX request fails, do nothing to customer_id
