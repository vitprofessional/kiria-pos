...
@section('title', __('autorepairservices::lang.view_job_sheet'))
...
<section class="content-header no-print">
    <h1>
    	@lang('autorepairservices::lang.job_sheet')
				...
				<div class="box-header no-print">
					<div class="box-tools">
						...
						@if(auth()->user()->can("job_sheet.edit"))
							<a href="{{route('job-sheet.edit', ['job_sheet' => $job_sheet->id])}}" class="btn btn-info cursor-pointer">
						...
						<button type="button" class="btn btn-primary" aria-label="Print" id="print_jobsheet">
				      	...
				      	<a class="btn btn-success" href="{{action('\Modules\AutoRepairServices\Http\Controllers\JobSheetController@print', ['id' => $job_sheet->id])}}" target="_blank">
					...
					<table class="table table-bordered" style="margin-top: 15px;">
						...
						<tr>
							<td colspan="3">
								...
								@if(!empty($job_sheet->product_configuration))	
						...
						<tr>
							<td colspan="3">
								...
								@if(!empty($job_sheet->product_condition))
	...
	<div class="row">
		@if($job_sheet->media->count() > 0)
			<div class="col-md-6">
				<div class="box box-solid no-print">
					...
					<div class="box-body">
						@includeIf('autorepairservices::job_sheet.partials.document_table_view', ['medias' => $job_sheet->media])
					</div>
				</div>
			</div>
		@endif
		<div class="col-md-6">
			<div class="box box-solid box-solid no-print">
		        ...
		        <!-- /.box-header -->
		        @include('autorepairservices::repair.partials.activities')
		    </div>
		</div>
	</div>
</section>
