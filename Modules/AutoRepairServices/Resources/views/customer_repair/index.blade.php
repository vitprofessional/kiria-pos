...
<div class="login-form col-md-12 col-xs-12 right-col-content">
    ...
    <form method="POST" action="{{action('\Modules\AutoRepairServices\Http\Controllers\CustomerRepairStatusController@postRepairStatus')}}" id="check_repair_status">
		...
		$(document).on('submit', 'form#check_repair_status', function(e) {
		    ...
		    $.ajax({
		        ...
		        success: function(result) {
		            if (result.success) {
						console.log(result.repair_html)
