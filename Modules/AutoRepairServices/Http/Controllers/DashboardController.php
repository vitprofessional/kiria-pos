...
class DashboardController extends Controller
{
    ...
    {   
        ...
        $job_sheets_by_status = $this->repairUtil->getAutoRepairByStatus($business_id);
        ...
        return view('autorepairservices::dashboard.index')
    ...
    public function create()
    {
        ...
        return view('autorepairservices::create');
    }
    ...
    {
        return view('autorepairservices::edit');
    }
