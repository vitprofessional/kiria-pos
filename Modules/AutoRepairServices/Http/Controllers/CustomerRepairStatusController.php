...
class CustomerRepairStatusController extends Controller
{
    ...
    {
        return view('autorepairservices::customer_repair.index');
    }
            ...
            try {
                ...
                if (count($sells) < 1) {
                    return ['success' => false,
                        'msg' => __("autorepairservices::lang.invalid_repair_details")
                    ];
                }
                ...
                $repair_html = View::make('autorepairservices::customer_repair.repair_details')
                                ->with(compact('sells'))
                                ->render();
