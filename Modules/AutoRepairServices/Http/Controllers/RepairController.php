...
class RepairController extends Controller
{
    ...
    public function index()
    {
            ...
            $datatable = Datatables::of($sells)
                ->addColumn(
                    ...
                    function ($row) {
                        ...
                        if (auth()->user()->can("repair.view") || auth()->user()->can("direct_sell.access")) {
                            $html .= '<li><a href="#" data-href="' . action("\Modules\AutoRepairServices\Http\Controllers\RepairController@show", [$row->id]) . '" class="btn-modal" data-container=".view_modal"><i class="fas fa-eye" aria-hidden="true"></i> ' . __("messages.view") . '</a></li>';
                        }
                            ...
                            $html .= '<li>
                                    ...
                                    <li>
                                        <a href="#" class="print-invoice" data-href="' . route('repair.customerCopy', [$row->id]) . '">
                                            <i class="fa fa-print" aria-hidden="true"></i> '
                                            . __("autorepairservices::lang.print_customer_copy")
                                        . '</a>
                                    </li>';
                        }
                        ...
                        if (auth()->user()->can("repair_status.update")) {
                            $html .= '<li><a data-href="' . action("\Modules\AutoRepairServices\Http\Controllers\RepairController@editRepairStatus", [$row->id]) . '" class="edit_repair_status"><i class="fa fa-edit"></i> ' . __("autorepairservices::lang.change_status") . '</a></li>';
                        }
                ...
                ->addColumn('total_remaining', function ($row) {
                 ...
                 ->editColumn(
                     'repair_status',
                     function ($row) {
                         $html = '<a data-href="' . action("\Modules\AutoRepairServices\Http\Controllers\RepairController@editRepairStatus", [$row->id]) . '" class="edit_repair_status" data-orig-value="'.$row->repair_status.'" data-status-name="'.$row->repair_status.'">
                        ...
                        ';
                         ...
                         if ($row->repair_updates_notif) {
                             $tooltip = __("autorepairservices::lang.sms_sent");
                 ...
                 ->editColumn('warranty_name', function ($row) {
                     ...
                     if (!empty($warranty_expires_in)) {
                         $warranty = __('autorepairservices::lang.warranty') . ': ' . $row->warranty_name . '<br>';

                         $warranty .= '<small class="help-block">' . __('autorepairservices::lang.expires_in') . ': ' . $warranty_expires_in . '</small>';
                     }
                     return $warranty;
                 })
                 ->editColumn('job_sheet_no', function($row) {
                    ...
                    if (auth()->user()->can("job_sheet.view_assigned") || auth()->user()->can("job_sheet.view_all") || auth()->user()->can("job_sheet.create")) {
                            $html = '<a href="' . action('\Modules\AutoRepairServices\Http\Controllers\JobSheetController@show', ['id' => $row->job_sheet_id]) . '" class="cursor-pointer" target="_blank">
                                    '.$row->job_sheet_no.'
                                </a>';
                    }
                ...
                ->setRowAttr([
                    'data-href' => function ($row) {
                        if (auth()->user()->can("sell.view")) {
                            return  action('\Modules\AutoRepairServices\Http\Controllers\RepairController@show', [$row->id]) ;
                        } else {
                            return '';
                        }
                    }]);
        ...
        return view('autorepairservices::repair.index')->with(compact('business_locations', 'customers', 'service_staffs', 'repair_status_dropdown', 'sales_representative', 'is_service_staff'));
    }
    ...
    public function create()
    {
        ...
        $brands = Brands::forDropdownAutoRepair($business_id);
        ...
        return view('autorepairservices::repair.create')
                ->with(compact(
                    'business_details',
                    'taxes',
                    'walk_in_customer',
    ...
    public function show($id)
    {
        ...
        return view('autorepairservices::repair.show')
    ...
    public function edit($id)
    {
        ...
        return view('autorepairservices::repair.edit')
            ->with(compact(
                'business_details',
                'taxes',
                'sell_details',
    ...
    public function editRepairStatus($repair_id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('autorepairservices::repair.partials.edit_repair_status_modal')
    ...
    public function printLabel($transaction_id)
    {
        try {
            ...
            return view('autorepairservices::repair.partials.preview_label')
    ...
    protected function _receiptContent($business_id, $location_id, $transaction_id)
    {
        ...
        $output['html_content'] = view('autorepairservices::repair.receipts.classic', compact('receipt_details'))->render();
