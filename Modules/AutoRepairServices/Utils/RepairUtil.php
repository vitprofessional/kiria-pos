...
namespace Modules\AutoRepairServices\Utils;
...
use Modules\AutoRepairServices\Notifications\RepairStatusUpdated;
...
class RepairUtil extends Util
{
    ...
    public function getAutoRepairByStatus($business_id)
    {
        $job_sheets_by_status = JobSheet::join(
                    'repair_statuses as rs',
                    'repair_job_sheets.status_id',
