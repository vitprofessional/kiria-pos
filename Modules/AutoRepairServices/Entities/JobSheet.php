...
class JobSheet extends Model
{
    ...
    {
        return $this->belongsTo('Modules\AutoRepairServices\Entities\RepairStatus', 'status_id');
    }
    ...
    {
        return $this->belongsTo('Modules\AutoRepairServices\Entities\DeviceModel', 'device_model_id');
    }
