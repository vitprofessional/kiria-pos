<div class="modal-dialog" role="document" style="width: 65%">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="col-md-4">
        <div class="form-group">
          {!! Form::label('date', __( 'leads::lang.lead_no' )) !!}
          {!! Form::text('date', $leads->lead_no, ['class' => 'form-control', 'required','disabled',
          'placeholder' => __(
          'leads::lang.lead_no')
          !!}
        </div>
      ...
      <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::select('label_id', $labels, $label->label_id, ['class' => 'form-control select2',
                'placeholder' => __(
            ...
            <div class="form-group">
                ...
                {!! Form::textarea('note', $leads->note, ['class' => 'form-control', 'placeholder' => __( 'brand.note' ), 'rows' => 4]);
                !!}
            </div>
