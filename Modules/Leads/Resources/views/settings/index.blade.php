        ...
        <div class="col-md-12">
            <div class="settlement_tabs">
                <ul class="nav nav-tabs">
                    ...
                    <li class="@if(session('status.tab') =='general') active @endif">
                        <a href="#general" class="general" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i>
                            <strong>@lang('leads::lang.general')</strong>
                        </a>
                    </li>
                    
                     <li class="@if(session('status.tab') =='labels') active @endif">
                        <a href="#labels" class="labels" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i>
                            <strong>@lang('leads::lang.labels')</strong>
                        </a>
                    </li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane @if(session('status.tab') =='general') active @endif" id="general">
                        @include('leads::settings.partials.general')
                    </div>
                    
                    <div class="tab-pane @if(session('status.tab') =='labels') active @endif" id="labels">
                        @include('leads::settings.partials.labels')
                    </div>
...
<script>
    // districts_table
        ...
        leads_labels_table = $('#leads_labels_table').DataTable({
            processing: true,
            serverSide: false,
            ajax: "{{action('\Modules\Leads\Http\Controllers\LabelController@index')}}",
            columnDefs:[{
                    "targets": 1,
                    "orderable": false,
                    "searchable": false
            ...
            columns: [
                ...
                {data: 'label_2', name: 'label_2'},
                {data: 'label_3', name: 'label_3'},
                ...
                if(willDelete){
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            leads_labels_table.ajax.reload();
                        },
                    });
                }
            });
