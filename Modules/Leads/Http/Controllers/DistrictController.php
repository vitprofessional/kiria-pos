...
class DistrictController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            $districts = District::leftjoin('countries','countries.id','=','districts.country_id')
    ...
    public function create()
    {
        ...
        return view('leads::settings.district.create',compact('countries'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('leads::settings.district.edit')->with(compact('district','countries'));
    }
