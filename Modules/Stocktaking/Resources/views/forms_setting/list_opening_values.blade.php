...
<section class="content-header">
    <h1> @lang('Stocktaking::lang.list_opening_values')
    </h1>
</section>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('lov_form_name', __('Stocktaking::lang.form_name') . ':') !!}
                    ...
                    <table id="lov_table" class="table table-striped table-bordered" cellspacing="0"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>@lang('Stocktaking::lang.date')</th>
                                <th>@lang('Stocktaking::lang.form_name')</th>
                                <th>@lang('Stocktaking::lang.edited_by')</th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
