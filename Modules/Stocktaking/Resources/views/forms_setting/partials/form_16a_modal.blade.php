...
<style>
    .9c_table tbody> tr>td{
        ...
        {!! Form::open(['url' => action('\Modules\Stocktaking\Http\Controllers\FormsSettingController@postForm16ASetting'),
        'method' => 'post' ]) !!}

        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">@lang( 'Stocktaking::lang.16a_settings' )</h4>
        </div>
