<div class="modal-dialog" role="document" style="width: 65%;">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('\Modules\Stocktaking\Http\Controllers\FormsSettingController@postForm9CSetting'),
        'method' => 'post', 'id' => 'F9C_settings_form' ]) !!}

        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">@lang( 'Stocktaking::lang.9c_settings' )</h4>
        </div>
                ...
                <table class="table table-bordered 9c_table" style="width: 100%;">
                    ...
                    <tbody>
                        <tr style="background: gainsboro;">
                            ...
                            @foreach ($sub_categories as $sub_cat)
                            @php
                            $form_9c_sub_cat = \Modules\Stocktaking\Entities\Form9cSubCategory::where('business_id',
