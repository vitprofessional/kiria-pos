<div class="modal-dialog" role="document" style="width: 75%;">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('\Modules\Stocktaking\Http\Controllers\FormsSettingController@postForm21CSetting'),
        'method' => 'post', 'id' => 'F21C_setting_form' ]) !!}

        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">@lang( 'Stocktaking::lang.21c_settings' )</h4>
        </div>
                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="checkbox">
                            ...
                            {!! Form::select('F21C_first_day_of_next_month_selected', $months, !empty($settings)? $settings->F21C_first_day_of_next_month_selected : null, ['class' => 'form-control', 'style' => 'width: 100px; float: left; margin-left: 10px; margin-right: 10px;', 'placeholder' => __('lang_v1.please_select')]) !!} @lang('Stocktaking::lang.month_end')
                        </div>
                        <div class="clearfix"></div>
