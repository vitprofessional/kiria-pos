<div class="modal-dialog" role="document" style="width: 65%;">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang('Stocktaking::lang.form_name'): {{$form_values->form_name}} &emsp;
                @lang('Stocktaking::lang.date'): {{$form_values->date}} &emsp; @lang('Stocktaking::lang.edited_by'):
        ...
        <div class="modal-body">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    {!! Form::label('F9C_setting_sn', __( 'Stocktaking::lang.form_starting_number' ) . ':*') !!}
                    {!! Form::text('F9C_setting_sn',$form_data['F9C_sn'], ['class' =>
                    'form-control', 'id' => 'F9C_setting_sn',
                    'readonly', 'required', 'placeholder' => __( 'Stocktaking::lang.form_starting_number' ) ]); !!}
                </div>
            </div>
                ...
                <table class="table table-bordered 9c_table" style="width: 100%;">
                    <thead>
                        ...
                        <tr>
                            <th></th>
                            @foreach ($cat_data as $sub_cat)
                            <th class="text-center" style="padding: 30px;">@lang('Stocktaking::lang.qty')</th>
                            <th class="text-center" style="padding: 30px;">@lang('Stocktaking::lang.amount')</th>
                            @endforeach
                        </tr>
                    </thead>
                    <tbody>
                        <tr style="background: gainsboro;">
                            <td class="text-red"><b>@lang('Stocktaking::lang.total_pervious_page')</b></td>
                            @foreach ($cat_data as $sub_cat)
                            <td>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    {!! Form::label('F16A_form_sn', __( 'Stocktaking::lang.form_starting_number' ) . ':*') !!}
            ...
            <table class="table table-responsive table-bordered 9c_table" style="width: 100%;">
                <thead>
                    <tr>
                        <th></th>
                        <th class="text-center">@lang('Stocktaking::lang.total_purchase_price')</th>
                        <th class="text-center">@lang('Stocktaking::lang.total_sell_price')</th>
                    </tr>
                </thead>
                <tbody>
                    <tr style="background: gainsboro;">
                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="checkbox">
                            ...
                            'placeholder' => __('lang_v1.please_select')]) !!} @lang('Stocktaking::lang.month_end')
                        </div>
                        <div class="clearfix"></div>
                        @lang('Stocktaking::lang.balance_zero_example')
                    </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    {!! Form::label('F21C_form_sn', __( 'Stocktaking::lang.form_starting_number' ) . ':*') !!}
            ...
            <table class="table table-responsive table-bordered 21c_table" style="width: 100%;">
                <thead>
                    <tr>
                        ...
                        @endforeach
                        <th class="text-center" colspan="2">@lang('Stocktaking::lang.bulk_item')</th>
                        <th class="text-center" colspan="2">@lang('Stocktaking::lang.total')</th>
                    </tr>
                    <tr>
                        @foreach ($merged_sub_categories as $merged)
                ...
                <tbody>
                    ...
                    <tr>
                        <td><b>@lang('Stocktaking::lang.price_reduction_pre_date')</b></td>
                        @foreach ($merged_sub_categories as $merged)
                        <td>
                            <input type="text" name="" class="form-control" style="width: 80%%;">
                        </td>
                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="checkbox">
                            ...
                            {!! Form::select('F21C_first_day_of_next_month_selected', $months, !empty($form_data)? $form_data['F21C_first_day_of_next_month_selected'] : null, ['class' => 'form-control', 'style' => 'width: 100px; float: left; margin-left: 10px; margin-right: 10px;', 'placeholder' => __('lang_v1.please_select')]) !!} @lang('Stocktaking::lang.month_end')
                        </div>
                        <div class="clearfix"></div>
                        @lang('Stocktaking::lang.balance_zero_example')
                    </div>
