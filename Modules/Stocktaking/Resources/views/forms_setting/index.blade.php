@extends('layouts.app')
@section('title', __('Stocktaking::lang.Stocktaking_forms_setting'))
        ...
        <div class="col-md-12">
            <div class="settlement_tabs">
                <ul class="nav nav-tabs">
                    ...
                    @can('Stocktaking_form_settings')
                    <li class="active">
                        <a href="#Stocktaking_forms_setting" class="Stocktaking_forms_setting" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong>@lang('Stocktaking::lang.Stocktaking_forms_setting')</strong>
                        </a>
                    </li>
                    @endcan
                    ...
                    <li class="">
                        <a href="#list_opening_values" class="list_opening_values" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong>@lang('Stocktaking::lang.list_opening_values')</strong>
                        </a>
                    </li>
                    @endcan
                    @endif
                ...
                <div class="tab-content">
                    ...
                    @can('Stocktaking_form_settings')
                    <div class="tab-pane active" id="Stocktaking_forms_setting">
                        @include('Stocktaking::forms_setting.settings')
                    </div>
                    @endcan
                    ...
                    <div class="tab-pane " id="list_opening_values">
                        @include('Stocktaking::forms_setting.list_opening_values')
                    </div>
                    @endcan
                    @endif
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        lov_table = $('#lov_table').DataTable({
            ...
            processing: true,
            ajax: {
                url: "{{action('\Modules\Stocktaking\Http\Controllers\FormOpeningValueController@index')}}",
                data: function(d){
