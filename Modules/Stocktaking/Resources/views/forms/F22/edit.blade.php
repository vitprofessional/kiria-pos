            ...
            <div class="row">
                ...
                <div class="col-md-3 pull-right">
                    <button type="submit" name="submit_type" id="f22_save_and_print" value="save_and_print"
                        ...
                        style="margin-left: 20px">@lang('Stocktaking::lang.update_and_print')</button>
                </div>
            </div>
            <div class="col-md-12">
                {{-- <div class="row">
                ...
                <div class="row" style="margin-top: 20px;">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="form_22_table">
                            ...
                            <tfoot>
                                <tr class="bg-gray">
                                    <td class="text-red text-bold" colspan="6">@lang('Stocktaking::lang.total_this_page')</td>
                                ...
                                <tr class="bg-gray">
                                    <td class="text-red text-bold" colspan="6">@lang('Stocktaking::lang.total_previous_page')
                                    </td>
                                ...
                                <tr class="bg-gray">
                                    <td class="text-red text-bold" colspan="6">@lang('Stocktaking::lang.grand_total')</td>
                                ...
                                <tr>
                                    <td colspan="11"> @lang('Stocktaking::lang.confirm_f22')</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="11"> <h5 style="font-weight: bold; margin-top: 10px; ">@lang('Stocktaking::lang.user'):
...
$(document).ready(function(){
    ...
    var pre_gspage_totals = [];
     ...
     form_22_table = $('#form_22_table').DataTable({
        ...
        ajax: {
            url: '/Stocktaking/edit-form-f22/{{$id}}',
            data: function(d) {
    ...
    $('#f22_save_and_print').click(function(e){
        ...
        $.ajax({
            method: 'put',
            url: '/Stocktaking/update-form-f22/{{$id}}',
