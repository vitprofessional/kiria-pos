@extends('layouts.app')
@section('title', __('Stocktaking::lang.StockTaking_form'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1> @lang('Stocktaking::lang.StockTaking_form')
        <small>@lang( 'Stocktaking::lang.StockTaking_form', ['contacts' => __('Stocktaking::lang.mange_F22StockTaking_form')
            ])</small>
    </h1>
</section>
            ...
            <div class="settlement_tabs">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#f22_form_tab" class="f22_form_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong>@lang('Stocktaking::lang.stock_taking_form')</strong>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#f22_last_verified_stock_tab" class="f22_last_verified_stock_tab" style=""
                            ...
                            <i class="fa fa-check"></i> <strong>
                                @lang('Stocktaking::lang.last_verified_stock') </strong>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#list_f22_stock_taking_tab" class="list_f22_stock_taking_tab" style=""
                            ...
                            <i class="fa fa-sign-in"></i> <strong>
                                @lang('Stocktaking::lang.list_stock_taking') </strong>
                        </a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="f22_form_tab">
                        @include('Stocktaking::forms.F22.partials.form')
                    </div>
