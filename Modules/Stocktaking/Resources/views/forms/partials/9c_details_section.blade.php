            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="text-right">
                        <h5 style="font-weight: bold;" class="text-red">@lang('Stocktaking::lang.9c_form') @lang('Stocktaking::lang.form_no') : {{$F9C_sn}}</h5>
                    </div>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="form_9c_table" style="width: 100%;">
                            <thead>
                                ...
                                <tr>
                                    <th>@lang('Stocktaking::lang.bill_no')</th>
                                    <th>@lang('Stocktaking::lang.order_voucher_no')</th>
                                    <th>@lang('Stocktaking::lang.customer')</th>
                                    <th>@lang('Stocktaking::lang.page')</th>
                                    @foreach ($sub_categories as $item)
                                    <th>@lang('Stocktaking::lang.qty')</th>
                                    <th>@lang('Stocktaking::lang.amount')</th>
                                    @endforeach
                                    <th>@lang('Stocktaking::lang.total_amount')</th>
                            ...
                            <tfoot class="bg-gray">
                                <tr>
                                    <td class="text-red text-bold" colspan="4">@lang('Stocktaking::lang.total_this_page')</td>
                                    @foreach ($sub_categories as $item)
                                ...
                                <tr>
                                    <td class="text-red text-bold" colspan="4">@lang('Stocktaking::lang.total_previous_page')</td>
                                    @foreach ($sub_categories as $item)
                                ...
                                <tr>
                                    <td class="text-red text-bold" colspan="4">@lang('Stocktaking::lang.grand_total')</td>
                                    @foreach ($sub_categories as $item)
