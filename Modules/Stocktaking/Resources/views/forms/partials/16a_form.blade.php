...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('type', __('Stocktaking::lang.F16a_from_no') . ':') !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="text-center pull-left">
                            <h5 style="font-weight: bold;" class="text-red">@lang('Stocktaking::lang.16A_form')
                                @lang('Stocktaking::lang.form_no') : {{$F16a_from_no}}</h5>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-striped" id="form_16a_table">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('Stocktaking::lang.location')</th>
                                    <th>@lang('Stocktaking::lang.received_qty')</th>
                                    ...
                                    <th>@lang('Stocktaking::lang.reference_no')</th>
                                    <th>@lang('Stocktaking::lang.stock_book_no')</th>

                                </tr>
                            </thead>
                            <tfoot class="bg-gray">
                                <tr>
                                    <td class="text-red text-bold" colspan="5">@lang('Stocktaking::lang.total_this_page')</td>
                                ...
                                <tr>
                                    <td class="text-red text-bold" colspan="5">@lang('Stocktaking::lang.total_previous_page')
                                    </td>
                                ...
                                <tr>
                                    <td class="text-red text-bold" colspan="5">@lang('Stocktaking::lang.grand_total')</td>
