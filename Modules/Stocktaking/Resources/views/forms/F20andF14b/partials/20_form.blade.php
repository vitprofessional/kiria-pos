...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('type', __('Stocktaking::lang.F20_from_no') . ':') !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="text-center pull-left">
                            <h5 style="font-weight: bold;" class="text-red">@lang('Stocktaking::lang.f20_form') @lang('Stocktaking::lang.form_no') : {{$F20_form_sn}}</h5>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-striped" id="form_20_table" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('Stocktaking::lang.sold_qty')</th>
                            ...
                            <tfoot class="bg-gray">
                                <tr>
                                    <td class="text-red text-bold" colspan="5">@lang('Stocktaking::lang.cash_sale')</td>
                                    <td class="text-red text-bold" id="cash_sale"></td>
                                </tr>
                                <tr>
                                    <td class="text-red text-bold" colspan="5">@lang('Stocktaking::lang.credit_sale')</td>
