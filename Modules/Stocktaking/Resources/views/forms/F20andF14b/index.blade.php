@extends('layouts.app')
@section('title', __('Stocktaking::lang.F20andF14b_form'))
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="active">
                        <a href="#14b_form" class="14b_form" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong>@lang('Stocktaking::lang.f14b_form')</strong>
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="">
                        <a href="#20_form" class="20_form" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong>@lang('Stocktaking::lang.f20_form')</strong>
                        </a>
                    </li>
                    @endif
                </ul>
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="14b_form">
                        ...
                        <section class="content">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    {!! Form::label('type', __('Stocktaking::lang.F14b_from_no') . ':') !!}
                        ...
                        <!-- /.content -->
                        {{-- @include('Stocktaking::forms.F20andF14b.partials.14b_form') --}}
                    </div>
                    @endif
                    @if(auth()->user()->can('f20_form'))
                    <div class="tab-pane" id="20_form">
                        @include('Stocktaking::forms.F20andF14b.partials.20_form')
                    </div>
                    @endif
