            ...
            <div class="settlement_tabs">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#f17_from_tab" class="f17_from_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong>@lang('Stocktaking::lang.f17_from')</strong>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#list_f17_from_tab" class="list_f17_from_tab" style="" data-toggle="tab">
                            <i class="fa fa-list"></i> <strong>
                                @lang('Stocktaking::lang.list_f17_from') </strong>
                        </a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="f17_from_tab">
                        @include('Stocktaking::forms.F17.partials.f17_from')
                    </div>

                    <div class="tab-pane" id="list_f17_from_tab">
                        @include('Stocktaking::forms.F17.partials.list_f17_from')
                    </div>
                </div>
            </div>
        </div>
