@extends('layouts.app')
@section('title', __('Stocktaking::lang.F17_form'))

@section('content')
<!-- Main content -->
<section class="content">
    @component('components.widget', ['class' => 'box-primary', 'title' => __(
    'Stocktaking::lang.f17_from')])
    @slot('tool')
    <div class="col-md-3 pull-right">
        <button type="submit" name="submit_type" id="f17_save" value="save" class="btn btn-primary pull-right"
            style="margin-left: 20px">@lang('Stocktaking::lang.save')</button>
    </div>
    @endslot
    <div class="table-responsive">
        <table class="table table-bordered table-striped" id="form_17_table" style="width:100%;">
            <thead>
                <tr>
                    <th>@lang('Stocktaking::lang.index')</th>
                    <th>@lang('Stocktaking::lang.product_code')</th>
                    <th>@lang('Stocktaking::lang.product')</th>
                    <th>@lang('Stocktaking::lang.current_stock')</th>
                    <th>@lang('Stocktaking::lang.unit_price')</th>
                    <th>@lang('Stocktaking::lang.select_mode')</th>
                    <th>@lang('Stocktaking::lang.new_price')</th>
                    <th>@lang('Stocktaking::lang.unit_price_difference')</th>
                    <th>@lang('Stocktaking::lang.price_changed_loss')</th>
                    <th>@lang('Stocktaking::lang.price_changed_gain')</th>
                    <th>@lang('Stocktaking::lang.signature')</th>
                    <th>@lang('Stocktaking::lang.page_no')</th>
...
<script>
    ...
    $('#f17_save').click(function(e){
        ...
        $.ajax({
            method: 'put',
            url: "{{action('\Modules\Stocktaking\Http\Controllers\F17FormController@update', [$id])}}",
            data: { 
            ...
            success: function(result) {
                ...
                if(result.success == 0){
                    ...
                    window.location.href = '{{URL::to('/')}}/Stocktaking/F17';
                }
