...
<section class="content">
    @component('components.widget', ['class' => 'box-primary', 'title' => __(
        'Stocktaking::lang.list_f17_from')])
    
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('type', __('Stocktaking::lang.date') . ':') !!}
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped" id="list_form_f17_table" style="width:100%;">
            <thead>
                <tr>
                    <th>@lang('Stocktaking::lang.action')</th>
                    <th>@lang('Stocktaking::lang.date_and_time')</th>
                    <th>@lang('Stocktaking::lang.form_no')</th>
                    <th>@lang('Stocktaking::lang.location')</th>
                    <th>@lang('Stocktaking::lang.category')</th>
                    <th>@lang('Stocktaking::lang.sub_category')</th>
                    <th>@lang('Stocktaking::lang.store')</th>
                    <th>@lang('Stocktaking::lang.select_mode')</th>
                    <th>@lang('Stocktaking::lang.total_price_change_loss')</th>
                    <th>@lang('Stocktaking::lang.total_price_change_gain')</th>
                    <th>@lang('Stocktaking::lang.user')</th>
