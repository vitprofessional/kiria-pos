@extends('layouts.app')
@section('title', __('Stocktaking::lang.F14_form'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1> @lang('Stocktaking::lang.F14_form')
        <small>@lang( 'Stocktaking::lang.F14_form', ['contacts' => __('Stocktaking::lang.mange_F14_form') ])</small>
    </h1>
</section>
