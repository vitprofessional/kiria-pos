...
use Modules\Stocktaking\Entities\FormF17Header;
use Modules\Stocktaking\Entities\FormF17HeaderController;
...
class F17FormController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Stocktaking::forms.F17.index')->with(compact(
            'stores',
            'products',
            'categories',
            'brands',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $output = [
                'success' => 1,
                'msg' => __('Stocktaking::lang.success')
            ];
        } catch (\Exception $e) {
            ...
            return DataTables::of($products)
                ->addColumn('action', function ($row) use ($business_details) {
                    ...
                    if (auth()->user()->can("edit_f17_form")) {
                        $html .= '<li><a target="_blank" href="' . action('\Modules\Stocktaking\Http\Controllers\F17FormController@edit', [$row->id]) . '"><i class="glyphicon glyphicon-edit"></i> ' . __("messages.edit") . '</a></li>';
                    }
    ...
    public function edit($id)
    {
        ...
        return view('Stocktaking::forms.F17.edit')->with(compact('id'));
    }
