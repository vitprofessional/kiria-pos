...
class FormOpeningValueController extends Controller
{
            ...
            return DataTables::of($form_opening_values)
                ->addColumn(
                    ...
                    function ($row) {
                        ...
                        $html .= '<li><a href="#" data-href="' . action('\Modules\Stocktaking\Http\Controllers\FormOpeningValueController@show', [$row->id]) . '" data-container=".form_opening_value_model" class="btn-modal holiday_eidt"><i class="fa fa-eye"></i> ' . __("messages.view") . '</a></li>';
                        $html .= '<li><a href="#" data-href="' . action('\Modules\Stocktaking\Http\Controllers\FormOpeningValueController@print', [$row->id]) . '" class="print_settings"><i class="fa fa-print"></i> ' . __("messages.print") . '</a></li>';
                        $html .= '</ul></div>';
    ...
    public function show($id)
    {
        ...
        return view('Stocktaking::forms_setting.show')->with(compact(
            'form_values',
    ...
    public function print($id)
    {
        ...
        return view('Stocktaking::forms_setting.print')->with(compact(
            'form_values',
            'merged_sub_categories',
            'months'
        ));
