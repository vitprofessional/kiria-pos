<div class="modal-dialog" role="document" style="width: 55%;">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\TasksManagement\Http\Controllers\ReminderController@update'), 'method' =>
    'post', 'id' => 'edit_note_form' ])
    !!}
    ...
    <div class="modal-body">
      <div class="col-md-6">
        <div class="form-group">
          ...
          {!! Form::text('name',$reminder->name, ['class' => 'form-control', 'required', 'placeholder' =>
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          'options','required', 'placeholder' => __( 'tasksmanagement::lang.please_select' )]);
          !!}
        </div>
      </div>
      ...
      <div class="col-md-4 other_pages_dropdown hide">
        <div class="form-group">
          ...
          'other_pages', 'style' => 'width: 100%;', 'multiple','required']);
          !!}
        </div>
      </div>
