...

{
...

    {
        ...
        return view('petro::fuel_tanks.create')->with(compact('max_tanks','tanks_added','locations', 'products', 'help_explanations', 'tank_dip_chart_permission', 'sheet_names', 'ajax', 'multiple'));
