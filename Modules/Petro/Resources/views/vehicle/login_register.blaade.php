        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                    {!! Form::label('category_id','Vehicle Category:') !!}
                    <div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div>
                            {!! Form::text('name', $vehicle_data->name ?? null, ['class' => 'form-control','placeholder' => 'Vehicle Name','required']); !!}
                        </div>
                    </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-3">
                    ...
                    <div>
                        {!! Form::select('district_id', $districts ?? [], $vehicle_data->district_id ?? '', ['class' => 'form-control','placeholder' => 'Please Select','required']); !!}
                    </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div>
                            {!! Form::text('town', $vehicle_data->town ?? null, ['class' => 'form-control','placeholder' => 'Town','required']); !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div>
                            {!! Form::text('mobile', $vehicle_data->mobile ?? null, ['class' => 'form-control','placeholder' => 'Mobile No','required']); !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('landline','Land Line No:') !!}
                        <div>
                            {!! Form::text('landline', $vehicle_data->landline ?? null, ['class' => 'form-control','placeholder' => 'Land Line No']); !!}
                        </div>
                    </div>
                </div>
              </div>
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-success float-end">{{isset($vehicle_data) && $vehicle_data->passcode ?'Update':'Register'}}</button>
            </div>
        </div>
          <!-- /.box -->
    </div>
