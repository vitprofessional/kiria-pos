                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('starting_meter', number_format($pump_assignment->starting_meter,3,".",""), ['class' => 'form-control
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('closing_meter', number_format($pump_assignment->closing_meter,3,".",""), ['class' => 'form-control
                            closing_meter',
                            'placeholder' => __(
