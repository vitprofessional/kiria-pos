          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                {!! Form::text("amount", $current_balance < 0 ? abs($current_balance) : $total_excess, ['class' => 'form-control input_number', 'required', 'placeholder' => 'Amount']); !!}
              </div>
            </div>
          </div>
          <div class="col-md-4">
          ...
          <div class="col-md-6 account_module ">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                {!! Form::select("account_id", $accounts, null , ['class' => 'form-control select2 account_id', 'id' => "account_id", 'style' => 'width:100%;']); !!}
              </div>
            </div>
          </div>
