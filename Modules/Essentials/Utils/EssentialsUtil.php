...

{
...

    {
        ...
        $payrolls = Transaction::where('transactions.business_id', $business_id)
                    ...
                    ->join('essentials_employees', 'essentials_employees.id', '=', 'transactions.expense_for')

                    

                    // ->leftJoin('categories as dsgn', 'essentials_employees.essentials_designation_id', '=', 'dsgn.id')
                    ...
                    ->leftJoin('categories as dept', 'epg.business_id', '=', 'dept.business_id')

                    ->select([

                        'transactions.id',

                        DB::raw("essentials_employees.name as user"),
                        ...
                        'transactions.payment_status',
                         ...
                         DB::raw("0 AS department"),

                         DB::raw("0 AS designation"),
