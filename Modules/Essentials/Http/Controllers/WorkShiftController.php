...
class WorkShiftController extends Controller
{
    ...
    public function index()
    {
            ...
            return DataTables::of($job_categories)
                ->addColumn(
                    ...
                    '<div class="btn-group">
                        ...
                        data-href="{{action(\'\Modules\Essentials\Http\Controllers\WorkShiftController@edit\', [$id])}}" 
                        data-container=".workshift_edit_modal">
                        <i class="glyphicon glyphicon-edit"></i> @lang("messages.edit") </a>
                        &nbsp;
                        <a data-href="{{action(\'\Modules\Essentials\Http\Controllers\WorkShiftController@destroy\', [$id])}}" class="delete_workshift  btn-xs btn-danger"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</a>
                    </div>'
                )
                ->removeColumn('id')
        ...
        return view('essentials::work_shift.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('essentials::work_shift.edit')->with(compact('workshift'));
    }
