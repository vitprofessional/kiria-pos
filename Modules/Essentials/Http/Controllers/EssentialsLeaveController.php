...

{
...

    {
        ...
        try {
            ...
            $input = $request->only(['essentials_leave_type_id','which_half', 'start_date', 'end_date', 'reason']);
...

    {
        ...
        // if (! ($this->moduleUtil->hasThePermissionInSubscription($business_id, 'essentials_module')) || ! auth()->user()->can('essentials.approve_leave')) {
