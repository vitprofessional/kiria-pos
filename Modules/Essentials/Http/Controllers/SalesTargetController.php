...
class SalesTargetController extends Controller
{
    ...
    public function index()
    {
        ...
        // if (! ($this->moduleUtil->hasThePermissionInSubscription($business_id, 'essentials_module')) && ! auth()->user()->can('essentials.access_sales_target')) {
        ...
        if (request()->ajax()) {
            ...
            $users =  EssentialsEmployee::where('business_id', $business_id)
                        ->where('sales_target_applicable', 1)
