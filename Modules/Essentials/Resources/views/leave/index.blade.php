            ...
            @component('components.widget', ['class' => 'box-solid', 'title' => __( 'essentials::lang.all_leaves' )])
                ...
                @slot('tool')
                    ...
                    <div class="box-tools">
                        ...
                        <button type="button" class="btn pull-right btn-primary btn-modal" data-href="{{action([\Modules\Essentials\Http\Controllers\EssentialsLeaveController::class, 'create'])}}" data-container="#add_leave_modal">
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result.success == true) {
                        ...
                        hardRefresh();
                        // leaves_table.ajax.reload();
                        // setTimeout(function(){$('#leave_table').DataTable().ajax.reload(null, false);}, 1000);
