    ...
    <div class="modal-body">
    	<div class="row">
    		...
    		<div class="form-group col-md-12">
	      	...
	      	<div class="form-group col-md-12">
	        	{!! Form::label('which_half', __( 'essentials::lang.which_half' ) . ':*') !!}
	          	{!! Form::select('which_half', array('first_half' => 'First Half','second_half' => 'Second Half'), null, ['class' => 'form-control select2', 'required', 'placeholder' => __( 'messages.please_select' ) ]); !!}
	      	</div>
