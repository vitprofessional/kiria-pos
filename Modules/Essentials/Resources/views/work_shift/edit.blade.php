...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang('essentials::lang.edit_workshift')</h4>
        </div>
        {!! Form::open(['url' => action('\Modules\Essentials\Http\Controllers\WorkShiftController@update', $workshift->id), 'method' => 'put']) !!}
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="shift_form">@lang('essentials::lang.shift_form'):</label>
