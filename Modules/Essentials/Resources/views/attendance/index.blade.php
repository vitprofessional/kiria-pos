                ...
                <div class="tab-content">
                    @can('essentials.crud_all_attendance')
                        <div class="tab-pane active" id="shifts_tab">
                            <button type="button" class="btn btn-primary pull-right" data-toggle="modal" id="add_shift_modal"> <i class="fa fa-plus"></i> @lang( 'messages.add' )</button>
                            <br>
                            <br>
                            <br>
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#add_shift_modal').on('click', function() {
        ...
        if (user_id && count == 0) {
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $('#select_employee option:selected').remove();
