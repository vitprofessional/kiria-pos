<tr data-user_id="{{$user->id}}">
	...
	<td>
		@if(empty($attendance->clock_in_time))
			<div class="input-group date">
				{!! Form::input('datetime-local', 'attendance[' . $user->id . '][clock_in_time]', null, ['class' => 'form-control', 'placeholder' => __('Clock In Time'), 'required']) !!}
	...
	<td>
		<div class="input-group date">
			{!! Form::input('datetime-local', 'attendance[' . $user->id . '][clock_out_time]', null, ['class' => 'form-control', 'placeholder' => __('Clock Out Time')]) !!}
{{--			{!! Form::text('attendance[' . $user->id . '][clock_out_time]', null , ['class' => 'form-control date_time_picker', 'placeholder' => __( 'essentials::lang.clock_out_time' ) ]); !!}--}}
			<!--<span class="input-group-addon"><i class="fas fa-clock"></i></span>-->
		</div>
	</td>
	<td>
