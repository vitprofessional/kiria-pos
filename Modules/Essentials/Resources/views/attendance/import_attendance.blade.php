        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table" width="100%">
                    ...
                    <tr>
                        <td>1</td>
                        <td>@lang('business.name') <small class="text-muted">(@lang('lang_v1.required'))</small></td>
                        <td>{!! __('essentials::lang.name_ins') !!}</td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>@lang('business.code') <small class="text-muted">(@lang('lang_v1.required'))</small></td>
                        <td>{!! __('essentials::lang.code_ins') !!}</td>
                    </tr>
                    <tr>
                        <td>3</td>
