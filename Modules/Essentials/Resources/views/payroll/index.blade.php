                    ...
                    <div class="tab-pane active" id="payroll_tab">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" type="month" name="month_year_filter" id="month_year_filter" value="{{ date('Y-m') }}" required>
                        ...
                        <div class="row">
                            @can('essentials.create_payroll')
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-primary pull-right" id="add_payroll_modal">
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready( function(){
            ...
            $(document).on('click', '#add_payroll_modal', function(e) {
