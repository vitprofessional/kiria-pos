...
Route::middleware('web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone','tenant.context')->group(function () {
    ...
    Route::prefix('hrm')->group(function () {
        ...
        Route::post('/advances/save-payment-settings', [Modules\Essentials\Http\Controllers\AdvancesController::class, 'savePaymentSettings']);
        Route::post('/advances/remove-payment-settings', [Modules\Essentials\Http\Controllers\AdvancesController::class, 'removePaymentSettings']);
