...
class PrinterController extends Controller
{
        ...
        if (request()->ajax()) {
            ...
            $printer = Printer::where('business_id', $business_id)
                        ->select(['name', 'connection_type',
                            'capability_profile', 'char_per_line', 'ip_address', 'port', 'path', 'id', 'vendor_id', 'product_id']);
    ...
    public function store(Request $request)
    {
        try {
            $business_id = $request->session()->get('user.business_id');
            $input = $request->only(['name', 'connection_type', 'capability_profile', 'ip_address', 'port', 'path', 'char_per_line', 'vendor_id', 'product_id']);
