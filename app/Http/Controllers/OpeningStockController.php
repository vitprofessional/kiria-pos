                    ...
                    if (array_key_exists($location_id, $locations)) {
                            ...
                            foreach ($purchase_lines_data as $k => $pl) {
                                ...
                                if (isset($pl['purchase_line_id'])) {
                                    ...
                                    if ($qty_remaining != 0) {
                                        ...
                                        $this->productUtil->updateProductQuantityStore($location_id, $product->id, $vid, $qty_remaining,null, $old_qty);
                                    ...
                                    if ($qty_remaining != 0) {
                                        ...
                                        $this->productUtil->updateProductQuantityStore($location_id, $product->id, $vid, $qty_remaining);
                                    }
                                }
                        ...
                        if (count($delete_transactions) > 0) {
                            foreach ($delete_transactions as $delete_transaction) {
                                ...
                                foreach ($delete_purchase_lines as $delete_purchase_line) {
                                    $this->productUtil->decreaseProductQuantity($product->id, $delete_purchase_line->variation_id, $location_id, $delete_purchase_line->quantity,0,'decrease');
                                    
                                    $this->productUtil->decreaseProductQuantityStore(
                                        $product->id, $delete_purchase_line->variation_id, $location_id, $delete_purchase_line->quantity,
                                        $store_id,
                                        "decrease",
                                        0
                                    );
