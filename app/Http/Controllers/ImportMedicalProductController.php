...
class ImportMedicalProductController extends Controller
{
    ...
    private function addOpeningStock($opening_stock, $product, $business_id)
    {
        ...
        $this->productUtil->updateProductQuantityStore($opening_stock['location_id'], $product->id, $variation->id, $opening_stock['quantity'],null, 0, null, false);
    }
        ...
        if (isset($variations['variations'][0]['opening_stock'])) {
            ...
            foreach ($variations['variations'] as $variation_os) {
                if (!empty($variation_os['opening_stock'])) {
                    ...
                    $this->productUtil->updateProductQuantityStore($location_id, $product->id, $variation->id, $opening_stock['quantity'],null, 0, null, false);
                }
            }
