...
class NotificationTemplate extends Model
{
    ...
    public static function customerNotifications()
    {
        ...
        return [
            'new_sale' => [
                ...
                'extra_tags' => ['{transaction_date},{business_name}', '{business_logo}', '{contact_name}', '{invoice_number}', '{invoice_url}', '{total_amount}', '{paid_amount}', '{due_amount}', '{cumulative_due_amount}', '{due_date}', '{location_name}', '{location_address}', '{location_email}', '{location_phone}', '{location_custom_field_1}', '{location_custom_field_2}', '{location_custom_field_3}', '{location_custom_field_4}', '{vehicle_no}']
            ],
            'credit_sale' => [
                'name' => __('Credit Sale'),
                'extra_tags' => ['{transaction_date},{business_name}', '{contact_name}', '{total_amount}',  '{due_amount}','{paid_amount}','{due_amount}','{invoice_number}','{cumulative_due_amount}', '{vehicle_no}', '{customer_reference}']
            ],
            'payment_received' => [
                'name' => __('lang_v1.payment_received'),
                'extra_tags' => ['{transaction_date},{business_name}', '{business_logo}', '{contact_name}', '{invoice_number}', '{payment_ref_number}', '{received_amount}', '{vehicle_no}']
            ],
            'customer_payment_deleted' => [
                'name' => __('lang_v1.payment_deleted'),
                'extra_tags' => ['{transaction_date},{business_name}', '{business_logo}', '{contact_name}', '{payment_ref_number}', '{received_amount}', '{vehicle_no}']
            ],
            ...
            'customer_sale_deleted' => [
                ...
                'extra_tags' => ['{transaction_date},{business_name}', '{business_logo}', '{contact_name}', '{invoice_number}', '{amount}', '{vehicle_no}']
            ],
            'payment_reminder' => [
                'name' =>  __('lang_v1.payment_reminder'),
                'extra_tags' => ['{transaction_date},{business_name}', '{business_logo}', '{contact_name}', '{invoice_number}', '{due_amount}', '{cumulative_due_amount}', '{due_date}', '{vehicle_no}']
            ],
            'new_booking' => [
            ...
            'new_quotation' => [
                ...
                'extra_tags' => ['{transaction_date},{business_name}', '{business_logo}', '{contact_name}', '{invoice_number}', '{total_amount}', '{quote_url}', '{location_name}', '{location_address}', '{location_email}', '{location_phone}', '{location_custom_field_1}', '{location_custom_field_2}', '{location_custom_field_3}', '{location_custom_field_4}', '{vehicle_no}']
            ],
            'customer_loan_given' => [
                'name' => __('lang_v1.customer_loan_given'),
                'extra_tags' => ['{loan_date}, {business_name}', '{business_logo}', '{contact_name}', '{loan_amount}','{outstanding_amount}', '{vehicle_no}']
            ],
            'cheque_return' => [
                'name' => __('lang_v1.cheque_return'),
                'extra_tags' => ['{customer_name}, {total_amount}', '{bank_name}', '{transaction_date}', '{vehicle_no}']
            ],
        ];
    }
    ...
    public static function generalNotifications()
    {
        return [
            ...
            'expense_created' => [
                'name' => "Expense Added",
                'category' => 'expense',
                'extra_tags' => ['{transaction_date},{ref}', '{amount}', '{account}','{staff}','{expense_category}']
            ],
            'general_purchase_created' => [
                'name' => 'Purchase Added',
                'category' => 'purchase',
                'extra_tags' => ['{transaction_date}', '{contact_name}', '{purchase_ref_number}', '{amount}']
            ],
            'expense_deleted' => [
    ...
    public static function bookingNotificationTags()
    {
        ...
        '{end_time}', '{location}', '{service_staff}', '{correspondent}', '{business_name}', '{business_logo}', '{location_name}', '{location_address}', '{location_email}', '{location_phone}', '{location_custom_field_1}', '{location_custom_field_2}', '{location_custom_field_3}', '{location_custom_field_4}', '{vehicle_no}'];
    }
